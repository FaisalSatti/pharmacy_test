          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_issue_req_local_breadcrumb">Add Issue Requisition</button></li>
              </ol>
            </div>   
          </div>
        </div>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="doc_no" id="doc_no" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Document No" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6  col-lg-3  form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="order_key" id="order_key" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Order Key" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-lg-2  form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="voucher_year" id="year" tabindex="-1" class="form-control form-control-sm" style="background-color: #ccd4e1;font-weight:bold;" value="<?php echo date("Y"); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2  col-lg-1 form-group">
                                            <label>Company:</label> 
                                        ...
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="company_name" id="company_name"  style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-lg-2  form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select style="width:73% !important;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" title="purchase mode" name="po_cat"  class="form-control form-control-sm" id="po_cat" >
                                        ...
                                        <div class="col-md-4 col-lg-2   form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control js-example-basic-single  form-control-sm"  id="dept_code" name="dept_code">
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6  col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1" name="dept_name" id="dept_name" tabindex="-1" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Department Name" readonly></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-1  form-group">
                                        ...
                                        <div class="col-md-4 col-lg-2  form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control js-example-basic-single  form-control-sm" id="div_code" name="div_code" >
                                                </select>
                                        ...
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" type="text" name="division_name" id="division_name" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Division Name" readonly>
                                            </div>
                                        </div>
                                  ...
                                  <table id="example1" class="table table-bordered table-striped table-responsive" style="border:1px solid gray;padding:20px;; border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr" class="tr">
                                            ...
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:100px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text"  name="" id = "rate" class="rate"></td>
  ...
  $.ajax({
    ...
    $.ajax({
          ...
          success: function(response){
              ...
              // console.log(response);
              $('#dept_code').html('');
              $('#dept_code').append('<option value="" selected disabled>Select Department</option>');
              $.each(response, function(key, value){
  ...
  $('.add').click(function(){
    ...
    var company_code=$('#company_code').val();
      ...
      if(acc_desc == null){
          ...
          $("#um_i").val('');
          $("#rate").val('');
          $('#d_items tr:last').before('<tr id="tr'+i+'" class="tr"><td><select name="acc_desc[]" id = "acc_desc'+i+'" class="form-control js-example-basic-single acc_desc" ></td><td><input name="detail[]" id = "detail'+i+'" style="background-color:#ccd4e1;" class="form-control form-control-sm detail" readonly><td><input type="number" name="quantity[]" id = "quantity'+i+'" class="form-control form-control-sm quantity"></td><td><input type="text" name="rate[]" id = "rate'+i+'"  class="form-control form-control-sm rate"></td><td><input type="text" name="amount[]" id = "amount'+i+'" style="background-color:#ccd4e1;" onchange="total()" class="form-control form-control-sm total" readonly tabindex="-1"></td><td><input value='+division_i+' type="text" name="division_i[]" id = "division_i'+i+'" style="background-color:#ccd4e1;" class="form-control form-control-sm division_i" readonly tabindex="-1"></td><td><input value='+gen_i+' type="text" name="gen_i[]" id = "gen_i'+i+'" style="background-color:#ccd4e1;" class="form-control form-control-sm gen_i" readonly tabindex="-1"></td><td><input value='+um_i+' type="text" name="um_i[]" id = "um_i'+i+'" style="background-color:#ccd4e1;" class="form-control form-control-sm um_i" readonly tabindex="-1"></td><td><button type = "button" id="'+i+'" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');          
...
//                 var id = button_id[1];
//                var account_code = $('#acc_desc'+i'').val();
//                 $.ajax({
//                 url: 'api/setup/issue_req_api.php',
//                   type: 'POST',
//                   data: {action: 'item_detail',item_code:account_code},
