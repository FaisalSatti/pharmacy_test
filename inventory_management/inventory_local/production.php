      ...
      <div class="row mb-1">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb">Add Production</button></li>
          </ol>
        </div>
      </div>
    </div>
                      ...
                      <div class="row" style="border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select style="width:60% !important;  box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" title="purchase mode" name="purchase_mode" class="form-control form-control-sm" id="purchase_mode">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control js-example-basic-single  form-control-sm" id="from_loc" name="from_loc" style="" placeholder="DEPARTMENT CODE"></select>
                          </div>
                        </div>
                        <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input tabindex="-1"  type="text" style="background-color:#ccd4e1;font-weight:bold;" name="from_loc_name" id="from_loc_name" class="form-control form-control-sm" placeholder="DEPARTMENT NAME " readonly>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control js-example-basic-single  form-control-sm" id="to_loc" name="to_loc" placeholder="TO LOCATION" style=""></select>
                          </div>
                        </div>
                        <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input tabindex="-1"  type="text" name="to_loc_name" style="background-color:#ccd4e1;font-weight:bold;" id="to_loc_name" class="form-control form-control-sm" placeholder="LOCATION NAME" readonly>
                    ...
                    <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%;">
                      ...
                      <tbody id="d_items">
                        <tr id="main_tr" class="tr">
                          ...
                          <td><input style="text-align:right; padding:0 2px 0 0;height:35px;width:150px;" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" id="amount" class="amount" readonly></td>
                      ...
                      <table>
                        <tr>
                          <td>
                            ...
                            <div class="row">
                              <div class="col-lg-1 col-md-1 col-sm-12 form-group">
                                <label>DIV:</label>
                              </div>
                              <div class="col-lg-5 col-md-5 col-sm-12 form-group"><input style="background-color: #ccd4e1;" type="text" name="item_div" tabindex="-1" id="item_div" class="form-control" placeholder="DIVISION" readonly></div>

                              <div class="col-lg-1 col-md-1 col-sm-12 form-group">
                                <label>GEN:</label>
                              </div>
                              <div class="col-lg-5 col-md-5 col-sm-12 form-group"><input style="background-color: #ccd4e1;" type="text" name="gen" tabindex="-1" id="gen" class="form-control" placeholder="GEN" readonly></div>

                              <div class="col-lg-1 col-md-1 col-sm-12 form-group">
                                <label>UM:</label>
                              </div>
                              <div class="col-lg-5 col-md-5 col-sm-12 form-group"><input style="background-color: #ccd4e1;" type="text" name="um" tabindex="-1" id="um" class="form-control" placeholder="UM" readonly></div>
    ...
    $('#company_table').on('click', '.even', function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          console.log(response);
          $('#from_loc').html('');
          $('#from_loc').append('<option value="" selected disabled>Select Depart</option>');
          $.each(response, function(key, value) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          console.log(response);
          $('#to_loc').html('');
          $('#to_loc').append('<option value="" selected disabled>Select Loc</option>');
          $.each(response, function(key, value) {
  ...
  $('#example1').ready(function() {
    ...
    $('.add').click(function() {
      ...
      if (order == null) {
        ...
        $("#batch_no").val('');
        $("#expiry").val('');
        $('#d_items tr:last').before('<tr id="tr' + i + '" class="tr"> <td ><select name="order[]" id = "order' + i + '" class="js-example-basic-single order" style="width:75px;"></select></td> <td ><textarea style="height:35px;background-color:#ccd4e1;width:240px;" rows="1"   name="item_name[]" id = "item_name' + i + '" class="item_name" readonly></textarea></td><td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;width:135px;" type="number"  name="quantity[]" id="quantity' + i + '" class="quantity"></td>   <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;width:135px;" type="text"  name="rate[]" id="rate' + i + '" class="rate"> <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;width:150px;"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="amount[]" id = "amount' + i + '" class="amount"></td></td>  <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;background-color:#ccd4e1;width:130px;"    type="text" tabindex="-1"  name="batch_no[]" id = "batch_no' + i + '" class="batch_no" readonly></td><td ><textarea  style="height:35px;background-color:#ccd4e1;font-size:12px;width:140px;"   type="text"  name="expiry[]" id = "expiry' + i + '" class="expiry" readonly></textarea></td><td><button type = "button" id="' + i + '" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');
        $.ajax({
          url: 'api/setup/production_api.php',
          type: 'POST',
          data: {
            ...
            $.ajax({
              ...
              success: function(response) {
                if (status == 0) {
                  ...
                  $.get('inventory_management/inventory_local/production.php', function(data, status) {
