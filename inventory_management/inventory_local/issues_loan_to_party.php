      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><button class="btn btn-sm" id="po_locl_list_breadcrumb">Issues [Loan To Party]</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
...
<script>
  ...
  $("#example1").on('click', '.btn-select', function() {
    ...
    $.get('inventory_management/inventory_local/edit_issues_loan_to_party.php?doc_no=' + doc_no + '&doc_type=' + doc_type + '&doc_year=' + doc_year + '&co_code=' + co_code + '&do_key=' + do_key, function(data, status) {
      $("#content").html(data);
    });
  });
