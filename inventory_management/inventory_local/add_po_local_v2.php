            ...
            <div class="row mb-2">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="po_list_breadcrumb"> PO List</button></li>
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb">Add PO Local</button></li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <form method="post" id="order_form">
                                    ...
                                    <div class="row" style="border:1px solid gray;padding:20px;; border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="doc_date" id="voucher_date" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" value="<?php echo date('Y-m-d'); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="doc_year" id="year" tabindex="-1" style="background-color:#ccd4e1;font-weight:bold;" class="form-control form-control-sm" value="<?php echo date("Y"); ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2  col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="company_code" id="company_code" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  maxlength="30" type="text" style="background-color:#ccd4e1;font-weight:bold;" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="dlvry_date" id="dlvry_date" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" value="<?php echo date('Y-m-d'); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[Y,y,N,n]" maxlength="1" type="text" name="po_close" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" id="Y_N" class="form-control form-control-sm" value="N" placeholder="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped table-responsive">
                                            ...
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr">
                                                    <td style="width:8%">
                                                        <input style="width:83px;height:35px;background-color:#b7edea;" name="" id="acc_desc" placeholder="Item Code" class="acc_desc" type="text" readonly>
                                                    </td>
                                                    <td style="width: 13%;">
                                                        <textarea style="height:35px;background-color:#ccd4e1" rows="1" name="" id="detail" class="detail" readonly placeholder="Item Name" tabindex="-1"></textarea>
                                                    </td>
                                                    <td>
                                                        <select name="" id="acc_descr" class="js-example-basic-single acc_descr"></select>
                                                    </td>
                                                    <td>
                                                        <textarea style="width:100%;height:35px;font-size:12px"  placeholder="Item Detail" type="text" name="" id="item_detail" class=""></textarea>
                                                    </td>
                                                    <td style="width: 8%;">
                                                        <input style="text-align:right; padding:0 2px 0 0;width:83px;height:35px" type="text" name="" id="quantity" placeholder="0" class="quantity" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                                    </td>
                                                    <td style="width: 10%;">
                                                        <input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" id="rate" placeholder="0.00" class="rate" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null">
                                                    </td>
                                                    <td style="width: 10%;">
                                                        <input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" placeholder="0.00" tabindex="-1" name="" id="amount" class="amount" readonly>
                                                    </td>
                                                    <td style="display:none;">
                                                        <textarea style="width:100%;height:35px;background-color:#ccd4e1;font-size:14px"  type="text" name="product_name" id="hidden_product_name" class="" readonly></textarea>
                                                    </td>
                                                    <td style="display: none;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <textarea style="width:100%;height:35px;background-color:#ccd4e1;font-size:14px"  type="text" name="" id="division_i" placeholder="Division Name" class="division_i" readonly tabindex="-1"></textarea>
                                            </div>

                                            <div class="col-md-6">
                                                <textarea style="width:100%;height:35px;background-color:#ccd4e1;font-size:14px"  type="text" name="product_name" placeholder="Product Name" id="product_name" class="" readonly tabindex="-1"></textarea>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-2">
                                                <textarea style="width:100%;height:35px;background-color:#ccd4e1;font-size:14px"  tabindex="-1" type="text" name="" placeholder="Generic Name" id="gen_i" class="gen_i" readonly></textarea>
                                            </div>
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-2">
                                                <td><input style="width:100%;height:35px;background-color:#ccd4e1;" type="text" name="" id="saletax_name" class="saletax_name" placeholder="Account Name" readonly tabindex="-1"></td>
                                            </div>
                                            <div class="col-md-2">
                                                <input style="width:100%;height:35px;text-align:right;" type="text" name="saletax_value" id="saletax_value" placeholder="Add Salex Tax %" class="saletax_value" min="0" max="100" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"></td>
                                            </div>
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                <textarea style="width:100%;height:35px;background-color:#ccd4e1;font-size:14px"  tabindex="-1" type="text" name="" id="um_i" class="" placeholder="UM Name" readonly></textarea>
                                            </div>
                                            <div class="col-md-1">
                                                <label>Add Tax</lable>
                                            </div>
                                            <div class="col-md-2">
                                                <td>
                                                    <select name="addtax_code" id="addtax_code" class="js-example-basic-single addtax_code"></select>
                                                </td>
                                            </div>
                                            <div class="col-md-2">
                                                <input style="width:100%;height:35px;background-color:#ccd4e1;" type="text" name="" id="addtax_name" class="addtax_name" placeholder="Account Name" readonly tabindex="-1"> </td>
                                            </div>
                                            <div class="col-md-2">
                                                <input style="width:100%;height:35px;text-align:right;" name="addtax_value" id="addtax_value" class="addtax_value" placeholder="Add Tax %" min="0" max="100" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"></td>
                                            </div>
                                            <div class="col-md-2">
                                                <input style="width:100%;height:35px;background-color:#ccd4e1;text-align:right;" type="text" name="addtax_amount" id="addtax_amount" placeholder="Sales Tax Amount" class="addtax_amount" readonly tabindex="-1"> </td>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <input style="width:100%;height:35px;text-align:right;background-color:#ccd4e1;" type="text" name="net_amount" id="net_amount" class="net_amount" placeholder="Net Amount" tabindex="-1"> </td>
                                            </div>
                                        </div>
                                        <!-- </form> -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                <button id="submit" type="submit" value="Submit" class="btn btn-primary btn-print-invoice"><i style="font-size:20px" class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
...
<style>
    ...
    #saletax_code .select2 .select2-container .select2-container--default element.style {
        width: 100% !important;
    }
...
<script>
    $(document).ready(function() {
        ...
        $("#order_form").on('change', '.quantity', function() {
            ...
            // console.log(quantityconsole.log(minuss_q););
            // console.log(minuss_q);
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#acc_descr').append(
                        '<option value="" selected disabled>Select Account</option>');
                    $.each(response, function(key, value) {
                        $('#acc_descr').append('<option data-name="' + value["product_name"] + '"  data-code=' + value["product_code"] + ' value=' + value["product_code"] + '>' + value["product_code"] + ' - ' + value["product_name"] + '</option>');
                    });
                },
                error: function(error) {
                    console.log(error);
        ...
        $('#order_form').on('change', '.acc_descr', function() {
            var product_code = $('#acc_descr').find(':selected').val();
            var product_name = $('#acc_descr').find(':selected').attr("data-name");
            $('#select2-acc_descr-container').html(product_code);
        ...
        $('.add').click(function() {
            ...
            if (acc_desc == "") {
                ...
                $('#d_items tr:last').before('<tr id="tr' + i + '"class="tr"><td style="width:8%"><input style="width:83px;height:35px;background-color:#b7edea;" name="acc_desc[]" id="acc_desc' +
                    ...
                    i + '"class="form-control detail" readonly></textarea></td><td><select name="acc_descr[]" id = "acc_descr' +
                    ...
                    i + '" class=""></textarea></td><td style="width: 8%;"><input style="text-align:right; padding:0 2px 0 0;width:83px;height:35px" type="number"  name="quantity[]" id="quantity' +
    ...
    $("#order_form").on("submit", function(e) {
        if ($("#order_form").valid()) {
            ...
            if (rowCount > 3) {
                ...
                var saletax_value = $('#saletax_value').val();
                var addtax_code = $('#addtax_code').val();
                var addtax_value = $('#addtax_value').val();
                formData.append('company_code', company_code);
                formData.append('saletax_code', saletax_code);
                formData.append('saletax_value', saletax_value);
                formData.append('addtax_code', addtax_code);
                formData.append('addtax_value', addtax_value);
