          ...
          <div class="row mb-1">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb" disabled> Transfer Edit</button></li>
              </ol>
            </div>   
          </div>
        </div>
                                    ...
                                    <div  class="col-lg-12">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="do_key" id="do_key" style="background-color:#ccd4e1;font-weight:bold;"  class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                            <label>Year:</label> 
                                        ...
                                        <div class="col-lg-6 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" tabindex="-1"  maxlength="30" type="text" style="background-color:#ccd4e1;font-weight:bold;"  name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                            <label>PO Cat:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1"  pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" style="background-color:#ccd4e1;font-weight:bold;"   name="purchase_mode" id="purchase_mode" class="form-control form-control-sm" placeholder="Voucher No" readonly>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1"   pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="division" style="background-color:#ccd4e1;font-weight:bold;"  id="div" class="form-control form-control-sm" placeholder="Voucher No" readonly>
                                        ...
                                        <div class="col-lg-5 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                 ...
                                                 <input tabindex="-1"  pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="div_name" style="background-color:#ccd4e1;font-weight:bold;"  id="division_name" class="form-control form-control-sm" placeholder="Voucher No" readonly>
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control js-example-basic-single  form-control-sm" id="from_loc" name="from_loc" style=""></select>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" maxlength="30" type="text" name="from_loc_name" style="background-color:#ccd4e1;font-weight:bold;" id="from_loc_name" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" maxlength="30" type="text" name="to_loc_name" style="background-color:#ccd4e1;font-weight:bold;"  id="to_loc_name" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                  ...
                                  <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%;">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr" class="tr">
                                            ...
                                            <td ><textarea style="height:35px;background-color:#ccd4e1;width:240px;" rows="1" tabindex="-1"  name="" id = "item_name" class="item_name" readonly></textarea></td>
                                            ...
                                            <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;width:150px;background-color:#ccd4e1;" tabindex="-1"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="" id = "amount" class="amount"></td>
                                            <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;background-color:#ccd4e1;width:130px;"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text" tabindex="-1"  name="" id = "batch_no" class="batch_no" readonly></td>
                                            <td ><textarea  style="height:35px;background-color:#ccd4e1;font-size:12px;width:140px;"  tabindex="-1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "expiry" class="expiry" readonly></textarea></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-5 col-md-4 col-sm-12 form-group"><input style="background-color: #ccd4e1;" tabindex="-1" type="text"  name="um" id="um" class="form-control" readonly></div>
  ...
  $('.js-example-basic-single').select2();
    ...
    $.ajax({
        ...
        //   $('#v_no').val(data.DEPT_CODE);
          ...
          var div_name = data.division_name;
          var div_code = data.DIV_CODE;
          var from_loc = data.WH_CODE;
          var from_loc_name = data.from_loc;
          var to_loc = data.WH_CODE2;
          var to_loc_name = data.to_loc;
                            ...
                            $.ajax({
                              ...
                              success: function(response){
                                  ...
                                  $('#order'+j).val(data[k].ITEM_CODE);
                                    ...
                                    var finalformattotalfinal = new Intl.NumberFormat(
                                    'en-US', {
                                    style: 'currency',
                                    currency: 'USD',
                                    currencyDisplay: 'narrowSymbol'
                                    ...
                                    totalfinal = finalformattotalfinal.replace(/[$]/g, '');
        ...
        alert("Contact IT Department");
                        ...
                        setTimeout(function (){
                                //   var div_name=$('#div').find(':selected').attr("data-name");
                                //   var div_code=$('#div').find(':selected').attr("data-code");
                                //   // console.log($('#select2-charge_code-container'));
                                //   $('#select2-div-container').html(div_code);
                                //   $('#division_name').val(div_name);
...
$("#order_form").on('click','#report',function(){
    ...
    var co_name = $("#company_name").val();
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/transfer_report.php?action=print&co_code="+co_code+"&doc_no="+doc_no+"&doc_year="+doc_year+"&do_key="+do_key+"&co_name="+co_name;
...
$("#add_po_local_breadcrumb").on("click", function () {
    $.get('inventory_management/inventory_local/transfer_edit.php', function(data,status){
        $("#content").html(data);
    });
});
</script>
