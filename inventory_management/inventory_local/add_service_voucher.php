                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="service_voucher_breadcrumb"> Service
                                Voucher</button></li>
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="add_service_voucher_breadcrumb"> Add Service
                                Voucher</button></li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <div class="row" style="border:1px solid gray;padding:20px;order-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" style="background-color:ccd4e1;font-weight:bold;" name="voucher_no" id="voucher_no" class="form-control form-control-sm" placeholder="Voucher Type" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2  col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" style="background-color:ccd4e1;font-weight:bold;" name="voucher_no" id="voucher_no" class="form-control form-control-sm" placeholder="Voucher No" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-3 col-md-4 form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend w-100" style="border: none;">
                                                    <span class="input-group-text"><i class="fas fa-arrow-down"></i></span>
                                                    <select class="form-control js-example-basic-single  form-control-sm" style="width: 100% !important;" id="company_code" name="company_code">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <form id="d" name="geek">
                                            <table id="example1" class="table table-bordered table-striped table-responsive" style="border:1px solid gray;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 150px !important; ">Account Code</th>
                                                        <th style="width: 170px !important; ">Account Description</th>
                                                        <th style="width: 150px !important; ">Depart Code</th>
                                                        <th style="width: 150px !important; ">Depart Name</th>
                                                        <th style="width: 150px !important; ">Vehicle#</th>
                                                        <th style="width: 150px !important; ">Memo</th>
                                                        <th style="width: 150px !important; ">Debit</th>
                                                        <th style="width: 150px !important; ">Credit</th>
                                                ...
                                                <tbody id="d_items">
                                                    <tr id="main_tr" class="tr" style="width:100%;">
                                                        <td><select style="width: 150px !important;font-size:12px" name="" id="acc_desc" class="form-control form-control-sm js-example-basic-single acc_desc"></select>
                                                        </td>
                                                        <td><textarea style="width: 150px !important;font-size:12px" rows="1" name="" placeholder="Item Name" id="detail" class="form-control form-control-sm detail" readonly tabindex="-1"></textarea></td>
                                                        <td><select style="width: 150px !important;font-size:12px;" name="" id="depart_desc" class="form-control form-control-sm js-example-basic-single depart_desc"></select>
                                                        </td>
                                                        <td><textarea style="width: 150px !important;font-size:12px" rows="1" name="" id="depart_detail" placeholder="Department Name" class="form-control form-control-sm depart_detail" readonly tabindex="-1"></textarea></td>
                                                        <td><select style="width: 150px !important;font-size:12px" name="" id="vehicle_code" class="form-control form-control-sm js-example-basic-single vehicle_code"></select>
                                                        </td>
                                                        <td><textarea style="width: 150px !important;font-size:12px" rows="1" name="" id="memo" placeholder="Memo" class="form-control form-control-sm memo"></textarea>
                                                        </td>
                                                        <td><input style="width: 150px !important;text-align:right; padding:0 13px 0 0" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text" name="" id="debit" class="form-control form-control-sm debit">
                                                        </td>
                                                        <td><input style="width: 150px !important;text-align:right; padding:0 13px 0 0" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" placeholder="0.00" id="credit" class="form-control form-control-sm credit">
                                                        </td>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-7 m-1">
                                                                        <input style="background-color: #ccd4e1;height:30px;" type="text" name="vehicle_user" id="vehicle_user" placeholder="Vehicle User" class="form-control  vehicle_user" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-4"></div>
                                                                    <div class="col-md-7 m-1">
                                                                        <input style="background-color: #ccd4e1;height:30px;" type="text" name="vehicle_name" id="vehicle_name" placeholder="Vehicle Name" class="form-control vehicle_name" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-7 m-1"><input style="background-color: #ccd4e1;height:30px;text-align:right;" placeholder="Final Amount" type="text" name="net_amount" id="net_amount" class="form-control net_amount" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<script>
            ...
            if (debit == '0' && credit == '0') {
                ...
                if (debit != '0' && credit != '0') {
                    ...
                    $('#d_items tr:last').before('<tr id="tr' +
                        ...
                        i + '" style="background-color:ccd4e1;" class="form-control form-control-sm detail" readonly></textarea></td><td><select name="depart_desc[]" id = "depart_desc' +
                        i + '" class="form-control js-example-basic-single depart_desc" ></td><td><textarea rows="1" name="depart_detail[]" id = "depart_detail' +
                        i + '" style="background-color:ccd4e1;" class="form-control form-control-sm depart_detail" readonly></textarea></td><td><select name="vehicle_code[]" id="vehicle_code' +
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (status == 0) {
                                        ...
                                        $.get('inventory_management/inventory_local/service_voucher.php',
    ...
    $("#add_service_voucher_breadcrumb").on("click", function() {
