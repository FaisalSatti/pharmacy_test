                                    ...
                                    <div class="row"  style="margin-top:-14px;border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                        ...
                                        <div class="container mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <button type="button" id="ledger" class="btn btn-primary w-100 mb-2">Submit</button>
                                                </div>
...
$("#ledger_form").on('click','#ledger',function(){
    ...
    var from_date=$('#from_date').val();
    var to_date=$('#to_date').val();
    $.get('inventory_management/inventory_local/untotal.php?company_code='+company_code+'&from_date='+from_date+'&to_date='+to_date+'&type='+type, function(data,status){
        $("#content").html(data);
    });
...
$("#stock_ledger_loc_breadcrumb").on("click", function () {
    $.get('inventory_management/inventory_local/untype_dt.php', function(data,status){
        $("#content").html(data);
    });
});
</script>