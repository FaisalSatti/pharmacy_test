    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="stock_ledger_loc_breadcrumb">Date-Wise Posting</button></li>
                </ol>
            </div>   
            </div>
        </div><!-- /.container-fluid -->
...
$("#ledger_form").on('click','#ledger',function(){
    ...
    var from_date=$('#from_date').val();
    var to_date=$('#to_date').val();
    $.get('inventory_management/inventory_local/untotal.php?company_code='+company_code+'&from_date='+from_date+'&to_date='+to_date, function(data,status){
        $("#content").html(data);
    });
...
$("#stock_ledger_loc_breadcrumb").on("click", function () {
    $.get('inventory_management/inventory_local/date_unpost.php', function(data,status){
        $("#content").html(data);
    });
});
</script>