          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="po_locl_list_breadcrumb">Issues Return</li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
...
$("#po_locl_list_breadcrumb").on("click", function () {
    $.get('inventory_management/inventory_local/issues_return.php', function(data,status){
        $("#content").html(data);
    });
});
