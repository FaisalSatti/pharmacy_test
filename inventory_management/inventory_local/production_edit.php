          ...
          <div class="row mb-1">
            ...
            <div class="col-sm-6">
              ...
              <li class="breadcrumb-item"><button class="btn btn-sm" id="dashboard_breadcrumb"><i class="fas fa-tachometer-alt"></i></button></li>
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="po_list_breadcrumb"> Production List</button></li>
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb" disabled>Production Edit</button></li>
              </ol>
            </div>   
          </div>
        </div>
                                ...
                                <div  class="col-lg-12">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="doc_no" id="doc_no" tabindex="-1" class="form-control form-control-sm" placeholder="DOCUMENT NO" readonly>
                                        </div>
                                    </div>
                                      <!-- date -->
                                    <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}"  maxlength="30" type="text" style="background-color:#ccd4e1;font-weight:bold;"  name="year" id="year" class="form-control form-control-sm" placeholder="year"  tabindex="-1" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                        <label>DO KEY:</label> 
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;"  name="v_no" id="v_no" class="form-control form-control-sm" placeholder="DEPARTMENT REFERENCE" >
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                        <label>Company:</label> 
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input tabindex="-1" type="text" style="background-color:#ccd4e1;font-weight:bold;"  name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                        <label>PO Cat:</label> 
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input tabindex="-1"  style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="purchase_mode" id="purchase_mode" class="form-control form-control-sm" placeholder="PURCHASE MODE" readonly >
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input tabindex="-1"  style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="from_loc" id="from_loc" class="form-control form-control-sm" placeholder="DEPARTMENT CODE" readonly >
                                              
                                            <!-- <select class="form-control js-example-basic-single  form-control-sm" id="from_loc" name="from_loc" style="" readonly></select> -->
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input tabindex="-1"   type="text" name="from_loc_name" style="background-color:#ccd4e1;font-weight:bold;"  id="from_loc_name" class="form-control form-control-sm" placeholder="DEPARTMENT NAME" readonly>
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input tabindex="-1"  type="text" style="background-color:#ccd4e1;font-weight:bold;"  name="to_loc" id="to_loc" class="form-control form-control-sm" placeholder="TO LOCATION" readonly >
                                            
                                            <!-- <select class="form-control js-example-basic-single  form-control-sm" id="to_loc" name="to_loc" style=""></select> -->
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input  tabindex="-1" type="text" name="to_loc_name" id="to_loc_name" style="background-color:#ccd4e1;font-weight:bold;"  class="form-control form-control-sm" placeholder="TO LOCATION NAME" readonly>
                              ...
                              <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%;">
                                  ...
                                  <tbody id="d_items">
                                    <tr id="main_tr" class="tr">
                                        ...
                                        <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;width:150px;background-color:#ccd4e1;"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="" id = "amount" class="amount" readonly tabindex="-1"></td>
                                        <td ><input tabindex="-1"  style="text-align:right; padding:0 2px 0 0;height:35px;background-color:#ccd4e1;width:130px;"   type="text" tabindex="-1"  name="" id = "batch_no" class="batch_no" readonly></td>
                                        <td ><textarea  tabindex="-1" style="height:35px;background-color:#ccd4e1;font-size:12px;width:140px;"  type="text"  name="" id = "expiry" class="expiry" readonly></textarea></td>
                                      ...
                                      <tr>
                                          <td>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-lg-5 col-md-4 col-sm-12 form-group"><input style="background-color: #ccd4e1;" type="text" tabindex="-1" name="item_div" id="item_div" class="form-control" placeholder="DIVISION"readonly></div>

                                                  <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                                      <label>GEN:</label> 
                                                  </div>
                                                  <div class="col-lg-5 col-md-4 col-sm-12 form-group"><input style="background-color: #ccd4e1;" type="text" tabindex="-1" name="gen" id="gen" class="form-control"  placeholder="GEN" readonly></div>

                                                  <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                                      <label>UM:</label> 
                                                  </div>
                                                  <div class="col-lg-5 col-md-4 col-sm-12 form-group"><input style="background-color: #ccd4e1;" type="text" tabindex="-1" name="um" id="um" class="form-control" placeholder="UM" readonly></div>
    ...
    $('#company_table').on('click','.even',function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                console.log(response);
                $('#from_loc').html('');
                $('#from_loc').append('<option value="" selected disabled>Select Item</option>');
                $.each(response, function(key, value){
                  $('#from_loc').append('<option data-name="'+value["dept_name"]+'"  data-code='+value["dept_code"]+' value='+value["dept_code"]+'>'+value["dept_code"]+' - '+value["dept_name"]+'</option>');
                });
            },
            error: function(error){
                console.log(error);
        ...
        $.ajax({
          url: 'api/setup/production_api.php',
            ...
            success: function(response){
                ...
                console.log(response);
                $('#to_loc').html('');
                $('#to_loc').append('<option value="" selected disabled>Select Item</option>');
                $.each(response, function(key, value){
        ...
        $.ajax({
          url: 'api/setup/production_api.php',
            ...
            success: function(response){
                ...
                $.each(response, function(key, value){
                    $('#order').append('<option data-name="'+value["item_descr"]+'"  data-code='+value["item_div"]+' value='+value["item_div"]+'>'+value["item_div"]+' - '+value["item_descr"]+'</option>');
                });
            },
            error: function(error){
                console.log(error);
            ...
            $.ajax({
              url: 'api/setup/production_api.php',
                    ...
                    success: function(response){
                        ...
                        $.each(response, function(key, value){
                            $('#order'+i+'').append('<option data-name="'+value["item_descr"]+'"  data-code='+value["item_div"]+' value='+value["item_div"]+'>'+value["item_div"]+' - '+value["item_descr"]+'</option>');
                            if(value["item_div"]== order){
                              order= value["item_div"];
  ...
  $('.js-example-basic-single').select2();
    ...
    $.ajax({
        ...
        //   $('#v_no').val(data.DEPT_CODE);
          ...
          var to_loc = data.WH_CODE;
          var dept_name = data.dept_name;
          var loc_name = data.location_name;

          $('#to_loc_name').val(loc_name);
          $('#to_loc').val(to_loc);
          $('#from_loc_name').val(dept_name);
          $('#from_loc').val(dept_code);
                    ...
                    if(data.length >= 1){
                        for(var i=1;i<=data.length;i++){
                            ...
                            $.ajax({
                              url: 'api/setup/production_api.php',
                              type: 'POST',
                              data: {action: 'itemdetails',company_code:company_code},
                              dataType: "json",
                              success: function(response){
                                  $("#ajax-loader").hide();
                                  console.log(response);
                                  ...
                                  $.each(response, function(key, value){
                                       $('#order'+j).append('<option data-name="'+value["item_descr"]+'"  data-code='+value["item_div"]+' value='+value["item_div"]+'>'+value["item_div"]+' - '+value["item_descr"]+'</option>');
                                     });
                                  $('#order'+j).val(data[k].ITEM_CODE);
                                    ...
                                    // var amt=data[k].AMT;
                                    total_amount=total_amount+parseFloat(AMT2);
                                    var finalformattotal_amount = new Intl.NumberFormat(
                                        'en-US', {
                                        style: 'currency',
                                        currency: 'USD',
                                        currencyDisplay: 'narrowSymbol'
                                      ...
                                      var formattedtotal = finalformattotal_amount.replace(/[$]/g, '');
        ...
        alert("Contact IT Department");
                        ...
                        // setTimeout(function (){
                        //           var to_loc_name=$('#to_loc').find(':selected').attr("data-name");
                        //           var to_loc_code=$('#to_loc').find(':selected').attr("data-code");
                        //           // console.log($('#select2-charge_code-container'));
                        //           $('#select2-to_loc-container').html(to_loc_code);
                        //           $('#to_loc_name').val(to_loc_name);
                        //           var dept_name=$('#from_loc').find(':selected').attr("data-name");
                        //           var dept_code=$('#from_loc').find(':selected').attr("data-code");
                        //           // console.log($('#select2-charge_code-container'));
                        //           $('#select2-from_loc-container').html(dept_code);
...
$("#order_form").on('click','#report',function(){
  console.log("aaa");
    ...
    var co_name = $("#company_name").val();
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/pr_report.php?action=print&co_code="+co_code+"&doc_no="+doc_no+"&doc_year="+doc_year+"&do_key="+do_key+"&co_name="+co_name;
...
$("#add_po_local_breadcrumb").on("click", function () {
    $.get('inventory_management/inventory_local/production_edit.php', function(data,status){
        $("#content").html(data);
    });
});
</script>
