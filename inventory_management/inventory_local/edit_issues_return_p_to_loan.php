...
<div class="content-wrapper">
    ...
    <section class="content-header" style="margin-bottom: -10px;">
        <div class="container-fluid">
            <div class="row mb-1">
                <div class="col-sm-6">
                    <h3> Edit Issues Return[P To Loan] </h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><button class="btn btn-sm" id="il_breadcrumb"> Inventory
                                Local</button></li>
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="po_list_breadcrumb"> Issues Return[P
                                To Loan]</button></li>
                        <li class="breadcrumb-item"><button class="btn btn-sm" disabled id="add_po_local_breadcrumb">Edit Issues Return[P To Loan]</button></li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="container">
                                <form method="post" id="order_form">
                                    ...
                                    <div class="row" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29);">
                                        <div style="padding:8px 8px 0 8px" class="">
                                            <style>
                                                body {
                                                    zoom: 95%;
                                                }
                                    ...
                                    <div class="card-ody">
                                        <br>
                                        <center><span class="bal_msg"><i class="fas fa-exclamation-circle"></i>Quantity
                                                can't be greater than Balance</span></center>
                                        <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%; margin-bottom:5px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="height: 25px;background-color:#ccd4e1;" placeholder="Local Bal" tabindex="-1" readonly class="form-control form-control-sm"></td>
                                                </tr>
                                                <tr>
                                                    <th>ItemCode</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr">
                                                    ...
                                                    <td style="width: 8%;"><input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color: #b7edea" placeholder="Item Code" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" id="acc_desc" class="" readonly></td>
                                                    <td style=""><textarea style="height:35px;background-color:#ccd4e1; width: 150px; " tabindex="-1" rows="1" name="" id="detail" class="detail" placeholder="Item Name" readonly></textarea></td>
                                                    ...
                                                    <td style="width: 8%;"><textarea style="width:100px;height:35px;background-color:#b7edea;font-size:12px" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" placeholder="Location" id="loc_i" class="" readonly></textarea></td>
                                                    ...
                                                    <td style=""><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px" type="number" name="" id="quantity" placeholder="0" class="quantity"></td>
                                                    <td style=""><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" placeholder="0.00" id="rate" class="rate"></td>
                                                    <td style=""><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px;background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" placeholder="0.00" name="" id="amount" class="amount" readonly></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" placeholder="Batch No." name="" id="batch_i" class="batch_i" readonly></textarea>
                                                    </td>
                                                    ...
                                                    <td style="display: none; width: 10%;"><input style="display: none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="um_name_hidden" class="um_name_hidden" readonly>
                                                    </td>
                                            ...
                                            <tr id="last_tr">
                                                ...
                                                <td colspan="1"><input type="text" style="height: 25px;text-align: right;background-color:#ccd4e1;" id="previous_balance" placeholder="prevoius balance" tabindex="-1" class="form-control form-control-sm" readonly>
                                                </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 col-lg-5 mt-1"><input style="background-color: #ccd4e1; height: 25px;" type="text" tabindex="-1" placeholder="Division Name" name="" id="div_name_bottom" class="form-control form-control-sm" readonly></div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-1 text-center mt-1"><label>UM</label></div>
                                                                <div class="col-md-12 col-lg-5 mt-1"><input style="background-color: #ccd4e1; height: 25px;" type="text" tabindex="-1" placeholder="UM Name" name="" id="um_name_bottom" class="form-control form-control-sm" readonly></div>
                                                                <div class="col-md-1 text-center mt-1"><label>Gen</label></div>
                                                                <div class="col-md-12 col-lg-5 mt-1"><input style="background-color: #ccd4e1; height: 25px;" type="text" tabindex="-1" name="" placeholder="Generic Name" id="gen_name_bottom" class="form-control form-control-sm" readonly></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class=" table table-bordered table-hover table-sm">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h3 class="card-title" style="color:#2c85b8; font-weight:bold;">Division Name:
                                        </h3>
                                    </div>
                                    <div class="col-md-8">
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        sno++;
                        table.row.add([response[i].ITEM_CODE, response[i].item_name, response[i]
                            .ITEM_HSCODE, response[i].ITEM_TAXRATE, "-", response[i]
                            .G_D, response[i].GD_DATE, response[i].BATCH_NO, response[i]
                            .EXPIRY_DATE, response[i].LOC_CODE, response[i].loc_name,
                            response[i].CO_CODE, response[i].BAL_STOCK
                        ]);
                    }
                    table.draw();
                },
        ...
        $('#order_form').on('focus', '#acc_desc', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        sno++;
                        table.row.add([sno, response[i].item_name, response[i].pur_mode,
                            response[i].div_name, response[i].gen_name, response[i]
                            .item, response[i].co_code, response[i].div_code, response[
                                i].um_name
                        ]);
                    }
                    table.draw();
    ...
    $('#example1').ready(function() {
        ...
        $("#order_form").on('change', '.acc_desc', function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(data) {
                    $('#div_code_bottom').val(data.divdfdf_code);
    ...
    $('#example1').ready(function() {
        ...
        $('.add').click(function() {
            ...
            if (acc_desc == null) {
                ...
                $("#rate").val('');
                $('#d_items tr:last').before('<tr id="tr' + i +
                    '" class="tr"><td style="width: 8%;"><input  style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color: #b7edea"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="acc_desc[]" id = "acc_desc' +
                    i +
                    '" class="acc_desc" readonly></td><td style="width: 20%;"><textarea style="height:35px;background-color:#ccd4e1; width: 100%; " rows="1"   name="detail[]" id = "detail' +
                    i +
                    '" class="detail" readonly></textarea></td><td style="width: 8%;"><textarea  style="width:100px;height:35px;background-color:#b7edea;font-size:12px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="loc_i[]" id = "loc_i' +
                    i +
                    '" class="loc_i" readonly></textarea></td><td style="width: 12%;"><input  style="text-align:right; padding:0 2px 0 0;width:100%;height:35px" type="number"  name="quantity[]" id="quantity' +
                    i +
                    '" class="quantity"></td><td style="width: 12%;"><input  style="text-align:right; padding:0 2px 0 0;width:100%;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="rate[]" id = "rate' +
                    i +
                    '" class="rate"></td><td style="width: 12%;"><input  style="text-align:right; padding:0 2px 0 0;width:100%;height:35px;background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text" tabindex="-1"  name="amount[]" id = "amount' +
                    i +
                    '" class="amount" readonly></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="batch_i[]" id = "batch_i' +
                    i +
                    '" class="batch_i" readonly></textarea></td><td style="width: 10%;"><input style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="date" tabindex="-1" name="expirydt_i[]" id = "expirydt_i' +
                    i +
                    '" class="expirydt_i" readonly></td><td style="display:none; width: 10%;"><input style="display:none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="gen_name_hidden[]" id = "gen_name_hidden' +
                    i +
                    '" class="gen_name_hidden" readonly></td><td style="display:none; width: 10%;"><input style="display:none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="um_name_hidden[]" id = "um_name_hidden' +
                    i +
                    '" class="um_name_hidden" readonly></td><td style="display:none; width: 10%;"><input style="display:none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="div_name_hidden[]" id = "div_name_hidden' +
                    i +
                    '" class="div_name_hidden" readonly></td><td style="display:none; width: 10%;"><input style="display:none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="total_balance_hidden[]" id = "total_balance_hidden' +
                    i +
                    '" class="total_balance_hidden" readonly></td><td><button type = "button" id="' +
                ...
                $('#order_form').on('focus', '#acc_desc' + i, function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            for (var i = 0; i < response.length; i++) {
                                sno++;
                                table.row.add([sno, response[i].item_name, response[i]
                                    .pur_mode, response[i].div_name, response[i]
                                    .gen_name, response[i].item, response[i]
                                    .co_code, response[i].div_code, response[i]
                                    .um_name
                                ]);
                            }
                            table.draw();
                ...
                $('#ass_desc_table_add').on('click', '.even', function() {
                    ...
                    $('#loc_i' + i).val('');
                    $('#grnref_i' + i).val('');
                    var item_code = $(this).closest('tr').children('td:nth-child(2)').text();
                    var item_name = $(this).closest('tr').children('td:nth-child(3)').text();
                    ...
                    $('#div_code_bottom' + i).val(div_code);
                    $('#div_name_bottom' + i).val(div_name);
                    $('#um_name_bottom' + i).val(gen_name);
                    $('#gen_name_bottom' + i).val(um_name);
        ...
        $('#example1').on('click', '.tr', function() {
            ...
            if (button_id != "main_tr") {
                ...
                if (item_code == '') {
                    ...
                    var id = button_id[1];
                    var additional_balance = $('#quantity' + id + '').val();
                    $.ajax({
                        url: 'api/Inventory_management/inventory_locals/issues_return_p_to_loan_api.php',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            var pb = response.BAL_STOCK;
                            var ab = additional_balance;
                            var total_ab_pb = parseInt(pb) - parseInt(ab);
                            var total_ab_pb_formatted = new Intl.NumberFormat(
                                'en-US', {
                                    style: 'currency',
                                    currency: 'USD',
                                    currencyDisplay: 'narrowSymbol'
                                }).format(total_ab_pb);
                            var total_ab_pb_formatted = total_ab_pb_formatted.replace(/[$]/g,
                                '');
                            $('#previous_balance').val(total_ab_pb_formatted);
        ...
        $('#example1').on('click', '.remove', function() {
            ...
            $('#amount' + i).val(total_amount_formatted);
            ...
            $('#final_total_calc').val(parseFloat(total_amount) + parseFloat(add_amount_calc) + parseFloat(
                less_freight_calc) + parseFloat(less_disc_calc));
            ...
            $('#amount' + i).val(total_quantity_formatted);
                            ...
                            $.ajax({
                                ...
                                success: function(data1) {
                                    if (status == 0) {
                                        ...
                                        $.get('inventory_management/inventory_local/issues_return_p_to_loan_list.php',
                        ...
                        if (data.length >= 1) {
                            for (var i = 1; i <= data.length; i++) {
                                $('#d_items tr:last').before('<tr id="tr' + i +
                                    ...
                                    '" class="total_balance_hidden" readonly></td><td><button type = "button" id="' +
                                    i +
                                    '" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>'
                                );
                                $('#type').prop("selectedIndex", 0).val();
                                var item_code = data[k].ITEM_CODE;
                                $('#acc_desc' + i).val(item_code);
                                var item_name = data[k].ITEM_NAME;
                                $('#detail' + i).val(item_name);
                                var type = data[k].ITEM_TYPE;
                                $('#type' + i).val(type);
                                var product_code = data[k].PRODUCT_CODE;
                                $('#product' + i).val(product_code);
                                var item_descr = data[k].item_name_sale;
                                $('#detail' + i).val(item_descr);
                                ...
                                var total_quantity = parseFloat(data[k].QTY) + parseFloat(
                                    total_quantity);
                                var total_quantity_formatted = new Intl.NumberFormat(
                                    'en-US', {
                                        style: 'currency',
                                ...
                                var total_quantity_formatted = total_quantity_formatted
                                    .replace(/[$]/g, '');
                                $('#total_q').text(total_quantity_formatted);
                            ...
                            $('#order_form').on('focus', '.acc_desc', function() {
                                ...
                                $('#ass_desc_table_add thead tr:eq(1) th').each(
                                    function(i) {
                                        var title = $(this).text();
                                        $(this).html(
                                            '<input type="text" class="form-control" placeholder="Search ' +
                                ...
                                $('#ass_descFormModelAdd').modal('show');
                                $('#ass_desc_table_add').on('click', '.even',
                                    function() {
                                        var item_code = $(this).closest('tr')
                                            .children('td:nth-child(6)').text();
                                        var item_name = $(this).closest('tr')
                                            .children('td:nth-child(2)').text();
                                        var div_name = $(this).closest('tr')
                                            .children('td:nth-child(4)').text();
                                        var gen_name = $(this).closest('tr')
                                            .children('td:nth-child(5)').text();
                                        var um_name = $(this).closest('tr')
                                            .children('td:nth-child(9)').text();
                                        var div_code = $(this).closest('tr')
                                            .children('td:nth-child(8)').text();
                                        $('#acc_desc' + id).val(item_code);
                                        $('#detail' + id).val(item_name);
                                        $('#div_name' + id).val(div_name);
                                        $('#div_name_hidden' + id).val(
                                            div_name);
                                        $('#gen_name' + id).val(gen_name);
                                        $('#gen_name_hidden' + id).val(
                                            gen_name);
                                        $('#um_name' + id).val(um_name);
                                        $('#um_name_hidden' + id).val(um_name);
                                        $('#div_code_bottom' + id).val(
                                            div_code);
                                        $('#div_name_bottom' + id).val(
                                            div_name);
                                        $('#um_name_bottom' + id).val(um_name);
                                        $('#gen_name_bottom' + id).val(
                                            gen_name);
                                        $('#ass_descFormModelAdd').modal(
                                            'hide');
                                        $('#loc_i' + id).focus();
                                    });
                                $('#ass_desc_table_add').on('click', '.odd',
                                    function() {
                                        var item_code = $(this).closest('tr')
                                            .children('td:nth-child(6)').text();
                                        var item_name = $(this).closest('tr')
    ...
    $("#order_form").on('click', '#report', function() {
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/issue_returns_p_to_loan_report.php?action=print&co_code=" + co_code +
            "&doc_no=" + doc_no + "&doc_year=" + doc_year + "&order_key=" + order_key + "&company_name=" + co_name;
