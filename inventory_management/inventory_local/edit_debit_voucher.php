            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="debit_voucher_breadcrumb"> Debit Voucher</button></li>
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="edit_debit_voucher_breadcrumb" disabled> Edit Debit Voucher</button></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    <div class="row" style="border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="col-lg-3 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control form-control-sm" style="background-color:#ccd4e1;" id="company_code" name="company_code" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-6 form-group">
                                            <div class="input-group">
                                                ...
                                                <input  style="background-color:#ccd4e1;" maxlength="30" type="text" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-3 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" name="monthwise_ser_no" id="monthwise_ser_no" class="form-control form-control-sm" placeholder="MonthWise Ser#">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 form-group">
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="" id="" class="form-control form-control-sm" placeholder="MonthWise Ser#" readonly tabindex="-1">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped table-responsive" style="border:1px solid gray;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                                ...
                                                <tbody id="d_items">
                                                    <tr id="main_tr" class="tr" style="width:100%;">
                                                        <td><select style="font-size:12px" name="" id="acc_desc" class="form-control form-control-sm js-example-basic-single acc_desc"></select>
                                                        </td>
                                                        <td>
                                                            <textarea style="font-size:12px" rows="1" name="" id="detail" placeholder="Item Name" class="form-control form-control-sm detail" readonly tabindex="-1"></textarea>
                                                        </td>
                                                        <td>
                                                            <select style="font-size:12px;" name="" id="depart_desc" class="form-control form-control-sm js-example-basic-single depart_desc"></select>
                                                        </td>
                                                        <td><textarea style="font-size:12px" rows="1" name="" id="depart_detail" placeholder="Department Name" class="form-control form-control-sm depart_detail" readonly tabindex="-1"></textarea></td>
                                                        ...
                                                        <td><textarea style="font-size:12px" rows="1" placeholder="Memo" name="" id="memo" class="form-control form-control-sm memo"></textarea>
                                                        </td>
                                                        <td><input style="text-align:right; padding:0 13px 0 0" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" placeholder="0.00" id="debit" class="form-control form-control-sm debit">
                                                        </td>
                                                        <td><input style="text-align:right; padding:0 13px 0 0" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" placeholder="0.00" id="credit" class="form-control form-control-sm credit">
                                                        </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-7 m-1"><input style="background-color: #ccd4e1;height:30px;text-align:right;" type="text" name="net_amount" placeholder="Final Amount" id="net_amount" class="form-control net_amount" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<script>
    ...
    $('#example1').ready(function() {
        $('#service_voucher').on('change', '.vehicle_code', function() {
            ...
            $.ajax({
                url: 'api/Inventory_management/inventory_locals/debit_voucher_api.php',
                type: 'POST',
                data: {
                    action: 'vehicle_name',
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i = 1; i <= data.length; i++) {
                            ...
                            f++;
                            $('#d_items tr:last').before('<tr id="tr' + i + '" class="tr"><td><select style="width:150px;" name="acc_desc[]" id = "acc_desc' + i + '" class="form-control js-example-basic-single acc_desc" ></td><td><textarea rows="1" style="width:150px;" name="detail[]" id = "detail' + i + '" class="form-control form-control-sm detail" readonly tabindex="-1"></textarea></td><td><select style="width:150px;" name="depart_desc[]" id = "depart_desc' + i + '" class="form-control js-example-basic-single depart_desc" ></td><td><textarea rows="1" style="width:150px;" name="depart_detail[]" id = "depart_detail' + i + '" class="form-control form-control-sm depart_detail" readonly tabindex="-1"></textarea></td><td><select style="width:150px;" name="vehicle_code[]" id="vehicle_code' + i + '" class="form-control js-example-basic-single vehicle_code"></td><td><textarea style="width:150px;" rows="1" name = "memo[]" id = "memo' + i + '" class = "form-control form-control-sm memo"></textarea></td><td><input type="text" style="text-align:right;width:150px;" name="debit[]" id = "debit' + i + '" class="form-control form-control-sm debit"></td><td><input type="text" style="text-align:right;width:150px;" name="credit[]" id = "credit' + i + '" class="form-control form-control-sm credit"></td><td style="display:none;"><input style="background-color: #ccd4e1;height:30px;width:150px;" type="text" name="vehicle_user" id="hidden_vehicle_user' + i + '" class="form-control  vehicle_user" readonly></td><td style="display:none;"><input style="background-color: #ccd4e1;height:30px;width:150px;" type="text" name="vehicle_name" id="hidden_vehicle_name' +
    ...
    $("#service_voucher").on('click', '#report', function() {
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/inventory_local/debit_voucher_report.php?action=print&co_code=" + co_code + "&voucher_no=" + voucher_no + "&doc_year=" + doc_year + "&voucher_type=" + voucher_type;
    ...
    $("#debit_voucher_breadcrumb").on("click", function() {
        $.get('inventory_management/inventory_local/debit_voucher.php', function(data, status) {
            $("#content").html(data);
        });
    });
    $("#edit_debit_voucher_breadcrumb").on("click", function() {
        $.get('inventory_management/inventory_local/edit_debit_voucher.php', function(data, status) {
            $("#content").html(data);
        });
    });
</script>
