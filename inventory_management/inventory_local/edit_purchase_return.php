            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button disabled class="btn btn-sm" id="add_po_local_breadcrumb">Edit Purchase Return</button></li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <form method="post" id="order_form">
                                        ...
                                        <div style="padding: 15px 15px 0px 15px;" class="row">
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input title="Sale Code"  style="background-color:#ccd4e1;font-weight:bold;" type="text" tabindex="-1" name="sale_code" id="sale_code" class="form-control form-control-sm" placeholder="Sale Code" readonly>
                                                </div>
                                            </div>
                                            <!-- date -->
                                            <div class="col-lg-1 col-md-2 form-group">
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" tabindex="-1" name="year" id="year" class="form-control form-control-sm" style="background-color:#ccd4e1;font-weight:bold;" min="1900" max="2099" step="1" readonly>
                                                </div>
                                            </div>
                                            <!-- company -->
                                            <div class="col-lg-1 col-md-2 form-group">
                                            ...
                                            <div class="col-lg-3 col-md-6 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input  type="text" style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly>
                                                </div>
                                            </div>
                                            <!-- CO Ref -->
                                            <div class="col-lg-1 col-md-2 form-group">
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input  style="background-color: #ccd4e1;font-weight:bold;" tabindex="-1" type="text" name="v_no" id="v_no" class="form-control form-control-sm" placeholder="Voucher no#" readonly>
                                                </div>
                                            </div>
                                            <!-- Party co -->
                                            <div class="col-lg-1 col-md-2 form-group">
                                            ...
                                            <div class="col-lg-2 col-md-4">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <input style="background-color: #ccd4e1;font-weight:bold; width: 100%;" name="party" tabindex="-1" id="party" class="party form-control-sm" readonly />
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input  type="text" name="division" style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" value="L" id="division" value="99" class="form-control form-control-sm" placeholder="Select Division" readonly>
                                                </div>
                                            </div>
                                            <!-- division -->
                                            <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%; margin-bottom:5px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="height: 25px; background-color: #ccd4e1;;" tabindex="-1" id="gen_name" readonly class="form-control form-control-sm"></td>
                                                    <td style="text-align: center;">UM</td>
                                                    <td><input type="text" style="height: 25px; background-color: #ccd4e1;;" tabindex="-1" id="um_name" readonly class="form-control form-control-sm"></td>
                                                    <td style="text-align: center;">LOC BAL</td>
                                                    <td><input type="text" style="height: 25px; background-color: #ccd4e1;;" tabindex="-1" id="loc_bal" readonly class="form-control form-control-sm"></td>
                                                    <td style="text-align: center;"></td>
                                                    <td><input type="text" style="height: 25px; background-color: #ccd4e1;;" tabindex="-1" id="total_balance" readonly class="form-control form-control-sm"></td>
                                                </tr>
                                                <tr>
                                                    <th>ItemCode</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr">
                                                    ...
                                                    <td style="width: 8%;"><input style="padding:0 2px 0 0;width:83px;height:35px;background-color:#b7edea;" type="text" name="" id="acc_desc" class="acc_desc form-control-sm" readonly></td>
                                                    ...
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;background-color:#b7edea;font-size:12px" type="text" name="" id="loc_i" class="loc_i" readonly></textarea></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;font-size:12px" tabindex="-1" type="text" name="" id="grnref_i" class="grnref_i"></textarea></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;background-color:#ccd4e1;;font-size:12px" tabindex="-1" type="text" name="" id="batch_i" class="batch_i" readonly></textarea></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;background-color:#ccd4e1;;font-size:12px" tabindex="-1" type="text" name="" id="expirydt_i" class="expirydt_i" readonly></textarea></td>
                                                    <td style="width: 8%;"><input style="text-align:right; padding:0 2px 0 0;width:83px;height:35px" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" name="" id="quantity" class="quantity ccc"></td>
                                                    <td style="width: 10%;"><input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px" oninput="this.value=this.value.replace(/[^0-9.,]/g,'');" type="text" name="" id="rate" class="rate calc_kar"></td>
                                                    <td style="width: 10%;"><input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#ccd4e1;" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="amount" class="amount" readonly></td>
                                                    <!-- hidden fields -->
                                                    <!-- hidden fields -->
                                            ...
                                            <tr id="last_tr">
                                                ...
                                                <td><input type="text" style="height: 25px; background-color: #ccd4e1;" tabindex="-1" id="div_name" readonly class="form-control form-control-sm"></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 text-right">
                                            <a id="report" type="button" value="Submit" class="btn btn-info toastrDefaultSuccess">PRINT&nbsp;&nbsp;<i style="font-size:20px" class="fa fa-file"></i></a>
                                        </div>
...
<script>
    ...
    $('#example1').ready(function() {
        ...
        $('.add').click(function() {
            ...
            if (acc_desc == "") {
                ...
                $("#div_name_hidden").val('');
                $('#d_items tr:last').before('<tr id="tr' + i + '" class="tr"><td style="width: 8%;"><input style="padding:0 2px 0 0;width:83px;height:35px;background-color:#b7edea;" type="text"  name="acc_desc[]" id="acc_desc' + i + '" class="acc_desc form-control-sm" readonly></td><td style="width: 13%;"><textarea style="height:35px;background-color:#ccd4e1 " rows="1" type="text" name="detail[]" id = "detail' + i + '" class="form-control form-control-sm detail"readonly></textarea></td><td><select style="font-size:11px;width:75px !important;height:35px" name="type[]" id = "type' + i + '" class="form-control form-control-sm type"><option value="0" readonly="readonly" selected>Type</option><option value="N">N</option><option value="F">F</option><option value="S">S</option><option value="T">T</option></select></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#b7edea;font-size:12px"   type="text"  name="loc_i[]" id = "loc_i' + i + '" class="loc_i" readonly></textarea></td><td style="width: 10%;"><textarea style="width:100px;height:35px;font-size:12px"   tabindex="-1"  type="text"  name="grnref_i[]" id = "grnref_i' + i + '" class="grnref_i"></textarea></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px"   type="text" tabindex="-1" name="batch_i[]" id = "batch_i' + i + '" class="batch_i" readonly></textarea></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px"   type="text" tabindex="-1" name="expirydt_i[]" id = "expirydt_i' + i + '" class="expirydt_i" readonly></textarea></td><td style="width: 8%;"><input style="text-align:right; padding:0 2px 0 0;width:83px;height:35px" type="text"  name="quantity[]" id="quantity' + i + '" class="quantity calc_kar"></td><td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:100px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="rate[]" id = "rate' + i + '" class="rate calc_kar"></td><td style="width: 10%;"><input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#ccd4e1;"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text" tabindex="-1"  name="amount[]" id = "amount' + i + '" class="amount" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="gen_name[]" id = "gen_name_hidden' + i + '" class="gen_name" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="um_name[]" id = "um_name_hidden' + i + '" class="um_name" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="total_balance[]" id = "total_balance_hidden' + i + '" class="total_balance" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="div_name[]" id = "div_name_hidden' + i + '" class="div_name" readonly></td><td><button type = "button" id="' + i + '" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');
            ...
            if (button_id != "main_tr") {
                ...
                if (item_code == '') {
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        success: function(response) {
                            $('#div_name').val(response.div_name);
                            $('#gen_name').val(response.gen_name);
                            $('#um_name').val(response.unit_name);
                            $('#total_balance').val(response.BAL_STOCK);
                        },
                        error: function(error) {
                            console.log(error);
                            alert("Contact IT Department");
                ...
                $('#div_name').val(div_code_div);
                $('#gen_name').val(gen_name);
                $('#um_name').val(um_name);
                $('#total_balance').val(order_bal_qty);
            }
        });
        $('#example1').on('click', '.remove', function() {
            ...
            var final_total_calc = parseFloat(total_amount) + parseFloat(add_amount_calc) + parseFloat(less_freight_calc) + parseFloat(less_disc_calc);
            var final_total_calc_f = new Intl.NumberFormat(
                'en-US', {
                    style: 'currency',
                    currency: 'USD',
                    currencyDisplay: 'narrowSymbol'
                }).format(final_total_calc);
            var final_total_calc_f = final_total_calc_f.replace(/[$]/g, '');
            $('#final_total_calc').val(final_total_calc_f);
    ...
    $('#example1').ready(function() {
        ...
        var company_code = $('#company_code').val();
        i++;
        $('#order_form').on('focus', '#acc_desc' + i, function() {
            var target = event.target || event.srcElement;
            var id = target.id;
            var id = id.split("acc_desc");
            id = id[1];
    ...
    $('#example1').ready(function() {
        setTimeout(function() {
            ...
            var formatted12 = finalformat2.replace(/[$]/g, '');
            $('#add_amount_calc').val(formatted12);
            var less1_format = new Intl.NumberFormat(
                'en-US', {
                    style: 'currency',
                    currency: 'USD',
                    currencyDisplay: 'narrowSymbol'
                }).format(less1);
            var less1_format = less1_format.replace(/[$]/g, '');
            $('#less_freight_calc').val(less1_format);
            var less2_format = new Intl.NumberFormat(
                'en-US', {
                    style: 'currency',
                    currency: 'USD',
                    currencyDisplay: 'narrowSymbol'
                }).format(less1);
            var less2_format = less2_format.replace(/[$]/g, '');
            $('#less_disc_calc').val(less2_format);
        }, 100);
    });
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#name_p').val(response.DESCR);
                $('#party_ref').val(response.PARTY_REF);
                $('#narration').val(response.REMARKS);
                $('#company_name').val(response.co_name);
                $('#party_name').val(response.DESCR);
                $('#address_p').val(response.address);
                $('#company_ref').val(response.REFNUM);
                $('#party').val(response.PARTY_CODE);
                $('#post').val(response.POST);
                $('#add_amount_calc').val(response.CHARGE_AMT);
                $('#less_freight_calc').val(response.OTHER_CHRGS);
                $('#less_disc_calc').val(response.OTHER_DED);
                $('#final_total_calc').val(response.TOTAL_NET_AMT);
                var disc_code = response.DISC_CODE
                var frt_code = response.FRT_CODE
                var charge_code = response.CHARGE_CODE
                var charge_dpt = response.CHARGE_DPT
                var frt_dpt = response.FRT_DPT
                var disc_dpt = response.DISC_DPT
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        $('#add_others_code').val(charge_code);
                    },
                    error: function(error) {
                        console.log(error);
                        alert("Contact IT Department");
                ...
                setTimeout(function() {
                    ...
                    row = rowCounts - 3;
                    var add_others_code = $('#add_others_code').find(':selected').val();
                    var add_others_name = $('#add_others_code').find(':selected').attr("data-name");
                    $('#select2-add_others_code' + '-container').html(add_others_code);
                    $('#add_others_desc').val(add_others_name);
                }, 100);
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                ...
                setTimeout(function() {
                    ...
                    var add_freight_name = $('#add_freight_code').find(':selected').attr("data-name");
                    $('#select2-add_freight_code' + '-container').html(add_freight_code);
                    $('#add_freight_desc').val(add_freight_name);
                }, 100);
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                ...
                setTimeout(function() {
                    ...
                    var add_disc_name = $('#add_disc_code').find(':selected').attr("data-name");
                    $('#select2-add_disc_code' + '-container').html(add_disc_code);
                    $('#add_disc_desc').val(add_disc_name);
                }, 100);
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                ...
                setTimeout(function() {
                    ...
                    var dpt_1_desc = $('#dpt_1_code').find(':selected').attr("data-name");
                    $('#select2-dpt_1_code' + '-container').html(dpt_1_code);
                    $('#dpt_1_desc').val(dpt_1_desc);
                }, 100);
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                ...
                setTimeout(function() {
                    ...
                    var dpt_2_desc = $('#dpt_2_code').find(':selected').attr("data-name");
                    $('#select2-dpt_2_code' + '-container').html(dpt_2_code);
                    $('#dpt_2_desc').val(dpt_2_desc);
                }, 100);
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                ...
                setTimeout(function() {
                    ...
                    var dpt_3_desc = $('#dpt_3_code').find(':selected').attr("data-name");
                    $('#select2-dpt_3_code' + '-container').html(dpt_3_code);
                    $('#dpt_3_desc').val(dpt_3_desc);
                }, 100);
                $.ajax({
                    url: 'api/Inventory_management/inventory_locals/purchase_return_api.php',
                    type: 'POST',
                    ...
                    success: function(data) {
                        ...
                        if (data.length >= 1) {
                            for (var i = 1; i <= data.length; i++) {
                                $('#d_items tr:last').before('<tr id="tr' + i + '" class="tr"><td style="width: 8%;"><input style="padding:0 2px 0 0;width:83px;height:35px;background-color:#b7edea;" type="text"  name="acc_desc[]" id="acc_desc' + i + '" class="acc_desc form-control-sm" readonly></td><td style="width: 13%;"><textarea style="height:35px;background-color:#ccd4e1 " rows="1" type="text" name="detail[]" id = "detail' + i + '" class="form-control form-control-sm detail"readonly></textarea></td><td><select style="font-size:11px;width:75px !important;height:35px" name="type[]" id = "type' + i + '" class="form-control form-control-sm type"><option value="0" readonly="readonly" selected>Type</option><option value="N">N</option><option value="F">F</option><option value="S">S</option><option value="T">T</option></select></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#b7edea;font-size:12px"   type="text"  name="loc_i[]" id = "loc_i' + i + '" class="loc_i" readonly></textarea></td><td style="width: 10%;"><textarea style="width:100px;height:35px;font-size:12px"   tabindex="-1"  type="text"  name="grnref_i[]" id = "grnref_i' + i + '" class="grnref_i"></textarea></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px"   type="text" tabindex="-1" name="batch_i[]" id = "batch_i' + i + '" class="batch_i" readonly></textarea></td><td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px" tabindex="-1"  type="text"  name="expirydt_i[]" id = "expirydt_i' + i + '" class="expirydt_i" readonly></textarea></td><td style="width: 8%;"><input style="text-align:right; padding:0 2px 0 0;width:83px;height:35px" type="text"  name="quantity[]" id="quantity' + i + '" class="quantity calc_kar"></td><td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:100px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="rate[]" id = "rate' + i + '" class="rate calc_kar"></td><td style="width: 10%;"><input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#ccd4e1"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text" tabindex="-1"  name="amount[]" id = "amount' + i + '" class="amount" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="gen_name[]" id = "gen_name_hidden' + i + '" class="gen_name" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="um_name[]" id = "um_name_hidden' + i + '" class="um_name" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#c1c1c1"    type="text" tabindex="-1"  name="total_balance[]" id = "total_balance_hidden' + i + '" class="total_balance" readonly></td><td style="display: none; width: 10%;"><input  style="display: none; text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color:#ccd4e1;"    type="text" tabindex="-1"  name="div_name[]" id = "div_name_hidden' + i + '" class="div_name" readonly></td><td><button type = "button" id="' + i + '" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');
                                $('#type').prop("selectedIndex", 0).val();
    ...
    $("#order_form").on('click', '#report', function() {
        ...
        var order_key = $("#sale_code").val();
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/inventory_local/purchase_return_report.php?action=print&co_code=" + co_code + "&doc_no=" + doc_no + "&doc_year=" + doc_year + "&order_key=" + order_key;
    ...
    $('#order_form').on('change', '.rate', function() {
        ...
        $('#less_freight_calc').val('0.00');
        $('#less_disc_calc').val('0.00');
        var finalll = $('#total').val();
        $('#add_amount_calc').val(finalll);
    });
