...
//    console.log(DOC_NO);
    $.get('inventory_management/inventory_local/tr_bd_edit.php/?DOC_NO='+DOC_NO+'&CO_CODE='+CO_CODE+'&DOC_TYPE='+DOC_TYPE+'&DOC_DATE='+DOC_DATE+'&DOC_YEAR='+DOC_YEAR+'&PO_CATG='+PO_CATG, function(data,status){
        $("#content").html(data);
    });
