            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="add_debit_voucher_breadcrumb"> Add Debit Voucher</button></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    <div class="row" style="border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="col-lg-3 col-md-4 form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend w-100">
                                                    ...
                                                    <select class="form-control js-example-basic-single  form-control-sm" id="company_code" style="width: 100%;" name="company_code">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="monthwise_ser_no" id="monthwise_ser_no" class="form-control form-control-sm" placeholder="MonthWise Ser#">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 form-group">
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="" id="" class="form-control form-control-sm" placeholder="Month Wise Ser#" readonly tabindex="-1">
                                            ...
                                            <table id="example1" class="table table-bordered table-striped table-responsive" style="border:1px solid gray;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                                ...
                                                <tbody id="d_items">
                                                    <tr id="main_tr" class="tr" style="width:100%;">
                                                        <td><select style="width: 150px;font-size:12px" name="" id="acc_desc" class="form-control form-control-sm js-example-basic-single acc_desc"></select>
                                                        </td>
                                                        <td><textarea style="width: 150px;font-size:12px" rows="1" name="" id="detail" placeholder="Item Name" class="form-control form-control-sm detail" readonly tabindex="-1"></textarea></td>
                                                        <td><select style="width: 150px;font-size:12px;" name="" id="depart_desc" class="form-control form-control-sm js-example-basic-single depart_desc"></select>
                                                        </td>
                                                        <td><textarea style="width: 150px;font-size:12px" rows="1" name="" placeholder="Department Name" id="depart_detail" class="form-control form-control-sm depart_detail" readonly tabindex="-1"></textarea></td>
                                                        <td><select style="width: 150px;font-size:12px" name="" id="vehicle_code" class="form-control form-control-sm js-example-basic-single vehicle_code"></select>
                                                        </td>
                                                        <td><textarea style="width: 150px;font-size:12px" rows="1" name="" id="memo" placeholder="Memo" class="form-control form-control-sm memo"></textarea>
                                                        </td>
                                                        <td><input style="width: 150px;text-align:right; padding:0 13px 0 0" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text" name="" id="debit" class="form-control form-control-sm debit">
                                                        </td>
                                                        <td><input style="width: 150px;text-align:right; padding:0 13px 0 0" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text" name="" id="credit" class="form-control form-control-sm credit">
                                                        </td>
                                                        <td style="width: 150px;display:none;">
                                                            <input style="width: 150px;background-color: #ced4da;height:30px;" type="text" name="vehicle_user" id="hidden_vehicle_user" class="form-control  vehicle_user" readonly tabindex="-1">
                                                        </td>
                                                        <td style="width: 150px;display:none;">
                                                            <input style="width: 150px;background-color: #ced4da;height:30px;" type="text" name="vehicle_name" id="hidden_vehicle_name" class="form-control vehicle_name" readonlytabindex="-1">
                                                        </td>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-7 m-1"><input style="background-color:#ced4da;height:30px;" type="text" name="vehicle_user" placeholder="Vehicle User" id="vehicle_user" class="form-control  vehicle_user" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-4"></div>
                                                                    <div class="col-md-7 m-1"><input style="background-color:#ced4da;height:30px;" type="text" name="vehicle_name" placeholder="Vehicle Name" id="vehicle_name" class="form-control vehicle_name" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-md-4" style=""><label>Diff&nbsp; (
                                                                            Debit-Credit)</label></div>
                                                                    <div class="col-md-7 m-1"><input style="background-color:#ced4da;height:30px;text-align:right;" placeholder="Net Amount" type="text" name="net_amount" id="net_amount" class="form-control net_amount" readonly tabindex="-1">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<script>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (status == 0) {
                                        ...
                                        $.get('inventory_management/inventory_local/debit_voucher.php',
    ...
    $("#add_debit_voucher_breadcrumb").on("click", function() {
        $.get('inventory_management/inventory_local/add_debit_voucher.php', function(data, status) {
            $("#content").html(data);
        });
    });
</script>
