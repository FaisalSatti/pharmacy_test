        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              ...
              <li class="breadcrumb-item"><button class="btn btn-sm" id="po_locl_list_breadcrumb">GIN LOCAL</button></li>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
      </section>
...
//    console.log(DOC_NO);
    $.get('inventory_management/inventory_local/gin_edit.php/?DOC_NO='+DOC_NO+'&CO_CODE='+CO_CODE+'&DOC_TYPE='+DOC_TYPE+'&DOC_DATE='+DOC_DATE+'&DOC_YEAR='+DOC_YEAR+'&PO_CATG='+PO_CATG, function(data,status){
        $("#content").html(data);
    });
