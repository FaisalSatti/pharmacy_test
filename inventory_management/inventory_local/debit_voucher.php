      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><button class="btn btn-sm" id="il_breadcrumb"> Inventory
              Local</button></li>
          <li class="breadcrumb-item"><button class="btn btn-sm" id="debit_voucher_breadcrumb"> Debit
              Voucher</button></li>
        </ol>
      </div>
    </div>
...
<script>
  ...
  $("#example1").on('click', '.btn-select', function () {
    ...
    $.get('inventory_management/inventory_local/edit_debit_voucher.php?co_code=' + co_code + '&voucher_no=' + voucher_no + '&voucher_type=' + voucher_type + '&voucher_year=' + voucher_year, function (data, status) {
      $("#content").html(data);
    });
