            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb">Add Issues [Loan to Party]</button></li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body" style="padding:7px">
                            <div class="container">
                                <form method="post" id="order_form">
                                    ...
                                    <div class="row pt-2 pb-2" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29);">
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="year" id="year" class="form-control form-control-sm" min="1900" style="background-color: #ccd4e1;font-weight:bold;" max="2099" step="1" value="<?php echo date("Y"); ?>" readonly>
                                            </div>
                                        </div>
                                        <!-- company -->
                                        <div class="col-md-2 col-lg-1 form-group">
                                        ...
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" style="background-color: #ccd4e1;font-weight:bold;" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" tabindex="-1" readonly>
                                            </div>
                                        </div>
                                        <!-- CO Ref -->
                                        <div class="col-md-2 col-lg-1 form-group">
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="party" style="background-color: #b7edea;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" id="party" class="form-control form-control-sm" placeholder="Select Party" readonly>
                                            </div>
                                        </div>
                                        <!-- Party -->
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name_p" id="name_p" tabindex="-1" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Party Name" readonly>
                                            </div>
                                        </div>
                                        <!-- PO Cat -->
                                        <div class="col-md-2 col-lg-1 form-group">
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="party_ref" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" id="party_ref" class="form-control form-control-sm" placeholder="Dept Ref">
                                            </div>
                                        </div>
                                        <!-- division -->
                                        <div class="col-md-2 col-lg-1 form-group">
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="division" style="background-color: #b7edea;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" id="division" class="form-control form-control-sm" placeholder="Select Division" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-3 form-group">
                                        ...
                                        <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%; margin-bottom:5px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="height: 25px;background-color:#ccd4e1;" tabindex="-1" placeholder="Local Bal" readonly class="form-control form-control-sm"></td>
                                                </tr>
                                                <tr>
                                                    <th>ItemCode</th>
                                                    <th>Name</th>
                                                    ...
                                                    <th style="display: none;">location_hidden</th>
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr">
                                                    ...
                                                    <td style="width: 8%;"><input style="text-align:right; padding:0 2px 0 0;width:100px;height:35px;background-color: #b7edea" placeholder="Item Code" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" id="acc_desc" class="acc_desc" readonly></td>
                                                    <td style="width: 20%;"><textarea style="height:35px;background-color:#ccd4e1; width: 150px; " rows="1" name="" id="detail" placeholder="Item Name" class="detail" readonly></textarea></td>
                                                    ...
                                                    <td style="width: 8%;"><textarea style="width:100px;height:35px;background-color:#b7edea;font-size:12px" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="Location" type="text" name="" id="loc_i" class="loc_i" readonly></textarea></td>
                                                    ...
                                                    <td style="width: 12%;"><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px" type="number" placeholder="0" name="" id="quantity" class="quantity"></td>
                                                    <td style="width: 12%;"><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text" name="" id="rate" class="rate"></td>
                                                    <td style="width: 12%;"><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px;background-color:#ccd4e1" placeholder="0.00" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="amount" class="amount" readonly></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="Batch No." type="text" tabindex="-1" name="" id="batch_i" class="batch_i" readonly></textarea></td>
                                                    <td style="width: 10%;"><input style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="date" placeholder="Expiry Date" tabindex="-1" name="" id="expirydt_i" class="expirydt_i" readonly></td>
                                                    <td style="display: none; width: 10%;"><input style="display: none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="gen_name_hidden" class="gen_name_hidden" placeholder="Generic Name" readonly></td>
                                                    <td style="display: none; width: 10%;"><input style="display: none; width:100px;height:35px;font-size:12px; background-color:#ccd4e1" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="um_name_hidden" class="um_name_hidden" placeholder="UM Name" readonly></td>
                                            ...
                                            <tr id="last_tr">
                                                <td style="text-align: center;"></td>
                                                <td colspan="2"><input type="text" style="height:25px;background-color:#ccd4e1;" tabindex="-1" id="loc_name_" class="form-control form-control-sm" placeholder="Location Name" readonly></td>
                                                <!-- <td style="text-align:right;">Total:</td> -->
                                                <td colspan="1"><input type="text" style="height: 25px;text-align: right;background-color:#ccd4e1;" tabindex="-1" id="previous_balance" placeholder="prevoius balance" class="form-control form-control-sm" readonly></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 col-lg-5 mt-1"><input style="background-color: #ccd4e1; height: 25px;" type="text" tabindex="-1" name="" placeholder="Division Name" id="div_name_bottom" class="form-control form-control-sm" readonly></div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 col-lg-5 mt-1"><input style="background-color: #ccd4e1; height: 25px;" type="text" tabindex="-1" placeholder="Generic Name" name="" id="gen_name_bottom" class="form-control form-control-sm" readonly></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
    ...
    $('#example1').ready(function() {
        ...
        $('.add').click(function() {
            ...
            if (acc_desc == null) {
                ...
                $('#order_form').on('click', '#acc_desc' + i, function() {
                    var target = event.target || event.srcElement;
                    var id = target.id;
                    var id = id.split("acc_desc");
                    id = id[1];
                    ...
                    $('#ass_desc_table_add').on('click', '.even', function() {
                        ...
                        var gen_name = $(this).closest('tr').children('td:nth-child(9)').text();
                        var um_name = $(this).closest('tr').children('td:nth-child(8)').text();
                        $('#acc_desc' + id).val(item_code);
                        $('#detail' + id).val(item_name);
                        $('#div_code_bottom' + id).val(div_code);
                        $('#div_name_bottom' + id).val(div_name);
                        $('#um_name_bottom' + id).val(gen_name);
                        $('#gen_name_bottom' + id).val(um_name);
                ...
                $('#order_form').on('click', '#loc_i' + i, function() {
                    var target = event.target || event.srcElement;
                    var id = target.id;
                    ...
                    $('#location_add_table thead tr:eq(1) th').each(
                        function(i) {
                            var title = $(this).text();
                            $(this).html(
                    ...
                    $('#location_add_table').on('click', '.even',
                        function() {
                            var loc_code = $(this).closest('tr')
                                .children('td:nth-child(2)').text();
                            var loc_name = $(this).closest('tr')
                                .children('td:nth-child(3)').text();
            ...
            $('#example1').on('click', '.tr', function() {
                var button_id = $(this).attr("id");
                if (button_id != "main_tr" + button_id) {
