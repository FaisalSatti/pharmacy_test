            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="po_list_breadcrumb"> Issues Return [P to Loan]</button></li>
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb">Add Issues Return [P to Loan]</button></li>
                    </ol>
                </div>
            </div>
        </div>
                                        ...
                                        <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%; margin-bottom:5px;">
                                            ...
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr">
                                                    ...
                                                    <td style=""><textarea style="height:35px;background-color:#ccd4e1; width: 150px; " tabindex="-1" rows="1" placeholder="Item Name" name="" id="detail" class="detail" readonly></textarea></td>
                                                    ...
                                                    <td style="width: 8%;"><textarea style="width:100px;height:35px;background-color:#b7edea;font-size:12px" placeholder="Location" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" id="loc_i" class="loc_i" readonly></textarea></td>
                                                    ...
                                                    <td style=""><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px" type="number" placeholder="0" name="" id="quantity" class="quantity"></td>
                                                    <td style=""><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text" name="" id="rate" class="rate"></td>
                                                    <td style=""><input style="text-align:right; padding:0 2px 0 0;width:150px;height:35px;background-color:#ccd4e1" placeholder="0.00" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="amount" class="amount" readonly></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1" placeholder="Batch no." pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="batch_i" class="batch_i" readonly></textarea></td>
                                                    <td style="width: 10%;"><input style="width:100px;height:35px;font-size:12px; background-color:#ccd4e1" placeholder="Expiry Date" pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" tabindex="-1" name="" id="expirydt_i" class="expirydt_i" readonly></td>
                                            ...
                                            <tr id="last_tr">
                                                ...
                                                <td colspan="1"><input type="text" style="height: 25px;background-color:#ccd4e1;" tabindex="-1" id="previous_balance" placeholder="prevoius balance" class="form-control form-control-sm text-right" readonly></td>
            ...
            if (acc_desc == "") {
                ...
                $('#order_form').on('focus', '#acc_desc' + i, function() {
                    ...
                    $('#ass_desc_table_add').on('click', '.even', function() {
                        ...
                        $('#div_name_hidden' + id).val(div_name);
                        $('#gen_name' + id).val(gen_name);
                        $('#gen_name_hidden' + id).val(gen_name);
                        ...
                        $('#gen_name_bottom' + id).val(gen_name);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            for (var p = 0; p < response.length; p++) {
                                sno++;
                                table.row.add([sno, response[p].LOC_CODE, response[p].loc_name]);
                            }
                            table.draw();
                        },
                        error: function(error) {
                ...
                console.log(gen_name_hidden + um_name_hidden + div_name_hidden + total_balance_hidden);
