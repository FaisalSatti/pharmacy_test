          ...
          <div class="row mb-1">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_gin_local_breadcrumb">Add Good Issue Notes</button></li>
              </ol>
            </div>   
          </div>
        </div>
...
display:none;
                                        ...
                                        <div class="col-md-4 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="doc_no" style="background-color: #ccd4e1;font-weight:bold;" tabindex="-1" id="doc_no" class="form-control form-control-sm" placeholder="Document No" readonly>
                                            </div>
                                        </div>
                                         <!-- date -->
                                        <div class="col-md-2 col-lg-1 form-group">
                                        ...
                                        <div class="col-md-4 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="year" id="year" tabindex="-1" class="form-control form-control-sm" style="background-color: #ccd4e1;font-weight:bold;" value="<?php echo date("Y"); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-1 form-group">
                                            <label>Company:</label> 
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="company_code" style="background-color: #b7edea;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" id="company_code" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                        ...
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="company_name" style="background-color: #ccd4e1;font-weight:bold;" tabindex="-1" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                            </div>
                                        </div>
                                        <div class="col-md-2 col-lg-1 form-group">
                                            <label>PO NO:</label> 
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="po_no" style="background-color: #b7edea;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px;" id="po_no" class="form-control form-control-sm" placeholder="Select PO" readonly>
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  tabindex="-1"  type="text" name="purchase_mode" style="background-color: #ccd4e1;font-weight:bold;" id="purchase_mode" class="form-control form-control-sm" placeholder="purchase mode " readonly >
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  tabindex="-1"   type="text" name="div" style="background-color: #ccd4e1;font-weight:bold;" id="div" class="form-control form-control-sm" placeholder="Division Name" readonly >
                                        ...
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  tabindex="-1"  type="text" name="div_name" style="background-color: #ccd4e1;font-weight:bold;" id="div_name" class="form-control form-control-sm" placeholder="Division Name" readonly >
                                        ...
                                        <div class="col-md-4 col-lg-2 form-group">
                                            <div class="input-group">
                                                ...
                                                <input  tabindex="-1" style="background-color:#ccd4e1;font-weight:bold;"  readonly maxlength="30" type="text" name="v_no" id="v_no" class="form-control form-control-sm" placeholder="DEPT NO" >
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" tabindex="-1" name="name_p" id="name_p" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" tabindex="-1" placeholder="DEPT Name" readonly>
                                            </div>
                                        </div>
                                  ...
                                  <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%;">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr" class="tr">
                                            ...
                                            <td ><textarea style="height:35px;background-color:#ccd4e1;width:200px;" rows="1" tabindex="-1" placeholder="Item Name" name="" id = "item_name" class="item_name" readonly></textarea></td>
                                            <td ><input  style="text-align:center; padding:0 2px 0 0;height:35px;width:75px;background-color: #ccd4e1;"tabindex="-1" placeholder="Location" type="number"  name="" id="loc" class="loc" readonly></td>
                                            ...
                                            <td ><input  style="text-align:right; padding:0 2px 0 0;height:35px;width:150px;background-color: #ccd4e1;" placeholder="0.000" pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="" id = "amount" readonly tabindex="-1" class="amount"></td>
                                            <td ><input  style="text-align:rigsht; padding:0 2px 0 0;height:35px;background-color:#ccd4e1;width:130px;" placeholder="Batch No." tabindex="-1"   type="text" tabindex="-1"  name="" id = "batch_no" class="batch_no" readonly></td>
                                            <td ><textarea  style="height:35px;background-color:#ccd4e1;font-size:12px;width:140px;" tabindex="-1" placeholder="Expiry Date"  type="text"  name="" id = "expiry" class="expiry" readonly></textarea></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12"><input style="background-color: #ccd4e1;" tabindex="-1" type="text"  name="" placeholder="Lot Code" id="lot_code" class="form-control" readonly></div>
                                                                <div class="col-md-12 form-group"></div>
                                                                <div class="col-sm-12"><input style="background-color: #ccd4e1;" tabindex="-1" type="text"  name="" id="lot_code2" placeholder="Lot Code 2" class="form-control" readonly></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
...
$(document).ready(function(){
  ...
  $("#order_form").on('focus','.rate',function(){
    ...
    //   if(parseInt(total_balance) < parseInt(qtt)){
    //                     // alert("yes")
    //     var zero = 0;
...
$('#order_form').on('focus','#po_no',function(){
...
$('#po_table').on('click','.even',function(){
    ...
    $.ajax({
      url: 'api/setup/gin_api.php',
        type: 'POST',
        data: {action: 'order_key_data',order_key:order_key,CO_CODE:CO_CODE},
        dataType: "json",
        success: function(MSTDATA){
            console.log(MSTDATA);
            $('#purchase_mode').val(MSTDATA.PO_CATG);
            $('#div').val(MSTDATA.DIV_CODE);
            $('#div_name').val(MSTDATA.DIV_NAME);
            // console.log(MSTDATA.PO_CATG);
