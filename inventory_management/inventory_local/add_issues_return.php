          ...
          <div class="row mb-1">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="po_list_breadcrumb"> Issues Return</button></li>
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb">Add Issues Return</button></li>
              </ol>
            </div>   
          </div>
        </div>
                                       ...
                                       <div class="col-sm-2 form-group">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="party_ref" id="party_ref" class="form-control form-control-sm" placeholder="Dept Ref" >
                                            </div>
                                        </div>
                                  ...
                                  <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%; margin-bottom:5px;">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr">
                                            ...
                                            <td style="width: 15%;"><textarea  style="width:100%;height:35px;background-color:#ccd4e1;font-size:12px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "loc_i" class="loc_i" readonly></textarea></td>


                                            <td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px"  pattern="[a-zA-Z0-9 ,._-]{1,}" tabindex="-1"  type="text"   name="" id = "grnref_i" class="grnref_i" readonly></textarea></td>

                                            
                                            <td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "batch_i" class="batch_i" readonly></textarea></td>

                                            <td style="width: 10%;"><textarea  style="width:100px;height:35px;background-color:#ccd4e1;font-size:12px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "expirydt_i" class="expirydt_i" readonly></textarea></td>
...
<br>
                                  <div class="row">
                                            <div class="col-md-6 mt-3">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-3 mt-1 text-md-center"><label>Div</label></div>
                                                                <div class="col-sm-7 m-1"><input style="background-color: #c1c1c1;height: 25px;" type="text"  name="" id="lot_name" class="form-control form-control-sm lot_name" readonly></div>
                                                            </div>
                                                            <div class="row mt-1">
                                                                <div class="col-md-3 mt-1 text-md-center"><label>Gen</label></div>
                                                                <div class="col-sm-7 m-1"><input style="background-color: #c1c1c1;height: 25px;" type="text"  name="" id="lot_name" class="form-control form-control-sm lot_name" readonly></div>
                                                            </div>
                                                            <div class="row mt-1">
                                                                <div class="col-md-3 mt-1 text-md-center"><label>UM</label></div>
                                                                <div class="col-sm-7 m-1"><input style="background-color: #c1c1c1;height: 25px;" type="text"  name="" id="lot_name" class="form-control form-control-sm lot_name" readonly></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <table>
                                                    <tr>
                                                                <div class="col-md-12"><input style="background-color: #c1c1c1;height: 30px; width: 100%;" type="text"  name="cost_rate" id="cost_rate" class="form-control  cost_rate" readonly></div>
                                                    </tr>

                                                    <tr>
                                                        <!-- <td> -->
                                                            <div class="row mt-3" style="justify-content: center;">
                                                                <div class="col-sm-4"><input style="background-color: #c1c1c1;height: 30px;" type="text" name="cost_amount" id="cost_amount" class="form-control cost_amount" readonly></div>
                                                           
                                                                <div class="col-sm-4"><input type="text" style="height: 30px;background-color: #c1c1c1;"  name="less_discount" id="less_discount" class="form-control less_discount" readonly></div>
                                                            </div>
                                                        <!-- </td> -->
                                                    </tr>
                                                    <!-- dpt  -->
                                                    ...
                                                    <td>
                                                            <!-- <div class="row">
                                                                <div class="col-sm-3"><label>Net&nbsp;Amount</label></div>
                                                                <div class="col-sm-1"></div>
                                                                <div class="col-sm-8"><input style="background-color: #c1c1c1;" type="text"  name="net_amount" id="net_amount" class="form-control net_amount" readonly></div>
                                                            </div> -->
                                                        </td>
                                                    </tr>       
                                                </table>
...
$("#add_po_local_breadcrumb").on("click", function () {
    $.get('inventory_management/inventory_local/add_issues_return.php', function(data,status){
        $("#content").html(data);
    });
});
</script>
