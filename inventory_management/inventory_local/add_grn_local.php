            ...
            <div class="row mb-1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb">Add GRN Local</button></li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <form method="post" id="order_form">
                                    ...
                                    <div class="row pt-2" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29);">
                                        ...
                                        <div class="col-lg-5 col-md-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" style="background-color: #ccd4e1;font-weight:bold;" type="text" name="doc_no" id="doc_no" class="form-control form-control-sm" placeholder="Document No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <!-- order key -->
                                        ...
                                        <div class="col-lg-2 col-md-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" tabindex="-1" readonly name="year" style="background-color: #ccd4e1;font-weight:bold;" id="year" style="background-color: #c1c1c1;" class="form-control form-control-sm" value="<?php echo date("Y"); ?>">
                                            </div>
                                        </div>
                                        <!-- company -->
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="company_code" id="company_code" style="background-color: #b7edea;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                            </div>
                                        </div>
                                        <!-- company name -->
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea   type="text" style="background-color: #ccd4e1;font-weight:bold;" style="background-color: #c1c1c1;" name="company_name" id="company_name" class="form-control form-control-sm" tabindex="-1" placeholder="Company Name" readonly rows="1"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input title="Sale Code" style="background-color: #b7edea;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" type="text" name="po_name" id="po_name" class="form-control form-control-sm" placeholder="PO. Number" readonly>
                                            </div>
                                        </div>
                                        <!-- date -->
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" tabindex="-1" readonly name="po_date" id="po_date" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" value="">
                                            </div>
                                        </div>
                                        <!-- Party co -->
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" style="background-color: #ccd4e1;font-weight:bold;" name="select_party" id="select_party" class="form-control form-control-sm" placeholder="Select Party" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <!-- Party -->
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="party_name" style="background-color: #ccd4e1;font-weight:bold;" id="party_name" class="form-control form-control-sm" placeholder="Party Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <!-- Address -->
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-5 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"  style="background-color: #ccd4e1;font-weight:bold;" tabindex="-1" name="address_p" id="address_p" class="form-control form-control-sm" placeholder="Address" readonly></textarea>
                                            </div>
                                        </div>
                                        <!-- CR DAYS HIDDEN -->
                                        ...
                                        <div class="col-lg-5 col-md-4 form-group" style="display: none;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"  tabindex="-1"  name="crdays" id="crdays" class="form-control form-control-sm" placeholder="Address" readonly></textarea>
                                            </div>
                                        </div>
                                        <!-- party ref -->
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  tabindex="-1" style="background-color: #ccd4e1;font-weight:bold;" type="text" name="party_ref" id="party_ref" class="form-control form-control-sm" placeholder="Party Ref." readonly>
                                            </div>
                                        </div>
                                        <!-- Phone -->
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  style="background-color: #ccd4e1;font-weight:bold;" type="text" name="dc_ref" id="dc_ref" class="form-control form-control-sm" placeholder="DC REF." readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <!-- Address -->
                                        <!-- city -->
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" type="text" name="voucher" id="voucher" class="form-control form-control-sm" placeholder="Voucher">
                                            </div>
                                        </div>
                                        <!-- </div> -->
                                        <!-- </div> -->
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  maxlength="30" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" type="text" name="order_ref" id="order_ref" class="form-control form-control-sm" placeholder="Order Reference">
                                            </div>
                                        </div>
                                        <!-- division -->
                                        <!-- Narration -->
                                        ...
                                        <table id="example1" class="table table-bordered table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%; margin-bottom:5px;">
                                            ...
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr">
                                                    <td style="width:8%"><input style="width:83px;height:32px; background-color: #b7edea;" name="" id="acc_desc" placeholder="Item Code" class="acc_desc" type="text" readonly></td>
                                                    <td style="width: 1%;"><textarea style="height:32px;background-color:#ccd4e1; width:130px" rows="1" name="" placeholder="Item Name" tabindex="-1" id="detail" class="detail" readonly></textarea></td>
                                                    ...
                                                    <td style="width: 8%;">
                                                        <textarea style=" padding:0 2px 0 0;width: 110px;;height:32px; background-color: #ccd4e1;" placeholder="Product" tabindex="-1" type="text" name="" id="product" class="product"></textarea>
                                                    </td>
                                                    <td style="width: 12%;">
                                                        <textarea style=" padding:0 2px 0 0;width: 100%;;height:32px; background-color: #ccd4e1;width: 150px;" placeholder="Item Detail" tabindex="-1" type="text" name="" id="item_detail" class="item_detail"></textarea>
                                                    </td>
                                                    <td style="width: 2%;"><input style="padding:0 2px 0 0;width:90px;height:32px;text-align:right; " placeholder="0" type="text" name="" id="quantity" class="quantity calculation ccc" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"></td>
                                                    <td style="width: 2%;"><input style="text-align:right; padding:0 2px 0 0;width:90px;height:32px" pattern="[a-zA-Z0-9 ,._-]{1,}" placeholder="0.00" type="text" name="" id="rate" class="rate calculation" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"></td>
                                                    <td style="width: 2%;"><input style="text-align:right; background-color: #ccd4e1; padding:0 2px 0 0;width:90px;height:32px" placeholder="0.00" readonly pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name="" id="ok_qty" tabindex="-1" class="ok_qty" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"></td>
                                                    ...
                                                    <td style="width: 2%;"><select name="" id="loc" class="js-example-basic-single loc"></select></td>
                                                    <td style="width: 10%;"><textarea style="width:100px;height:32px;font-size:12px" placeholder="Batch No." type="text" name="batch_no" id="gen_i" class="gen_i"></textarea></td>
                                                    <td style="width: 10%;"><input style="width:100px;height:32px;font-size:12px" type="date" name="exp_date" id="um_i" class="um_i"></td>
                                                    <td style="width: 10%;display: none;"><input style="width:100px;height:32px;font-size:12px; display: none;" type="text" name="hidden_div" id="hidden_div" class="hidden_div"></td>
                                                    <td style="width: 10%;display: none;"><input style="width:100px;height:32px;font-size:12px; display: none;" type="text" name="hidden_gen" id="hidden_gen" class="hidden_gen"></td>
                                                    <td style="width: 10%;display: none;"><input style="width:100px;height:32px;font-size:12px; display: none;" type="text" name="hidden_um" id="hidden_um" class="hidden_um"></td>
                                                    <td style="width: 10%;display: none;"><input style="width:100px;height:32px;font-size:12px; display: none;" type="text" name="hidden_t_bal" id="hidden_t_bal" class="hidden_t_bal"></td>
                                            ...
                                            <tr id="last_tr">
                                                ...
                                                <td><input type="text" id="total" readonly tabindex="-1" class="form-control form-control-sm total_rej_qty" placeholder="Total Reject " style="width:100%;text-align:right; background-color: #ccd4e1;"></td>
                                                <td></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 m-1"><input style="background-color: #ccd4e1;height: 30px;" type="text" name="" tabindex="-1" id="div_code_div" class="form-control div_code_div" readonly placeholder="Division Name"></div>
                                                                <div class="col-md-12 m-1"><input style="background-color: #ccd4e1;height: 30px;" placeholder="Generi Name" tabindex="-1" type="text" name="" id="gen_name" class="form-control gen_name" readonly></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 m-1"><input style="background-color: #ccd4e1;height: 30px;" type="text" tabindex="-1" name="" id="um_name" placeholder="UM Name" class="form-control um_name" readonly></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-sm-11 text-right">
                                            <a id="print" type="button" value="" class="btn btn-info toastrDefaultSuccess"><i style="font-size:20px" class="fa fa-file"></i></a>
                                        </div> -->
...
<div class="modal fade" id="PartyFormModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Select PO. Number</h5>
                <button type="button" class="close" aria-label="Close" data-dismiss="modal">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#order_form").on('change', '.ccc', function() {
        });
        ...
        var po_no = $(this).closest('tr').children('td:nth-child(4)').text();
        {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#select_party').val(response.supp_div);
        ...
        $('#order_form').on('focus', '.acc_desc', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        sno++;
                        table.row.add([response[i].item_code, response[i].item_type, response[i].qty, response[i].rate, response[i].amt, response[i].disc_rate, response[i].disc_amt, response[i].net_amt, response[i].item_detail, response[i].order_bal_qty, response[i].product_code, response[i].div_name, response[i].gen_name, response[i].unit_name]);
                    }
                    table.draw();
                },
                error: function(error) {
    ...
    $(document).ready(function() {
        ...
        $('#order_form').on('click', '#print', function() {
            var company_code = $('#company_code').val();
            ...
            $.get('api/Inventory_management/inventory_locals/grn_report_view.php?company_code=' + company_code + '&company_name=' + company_name + '&from_code=' + from_code + '&account_name=' + account_name + '&to_code=' + to_code + '&account_name1=' + account_name1, function(data, status) {
                $("#content").html(data);
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        if (status == 0) {
                                            ...
                                            $.get('inventory_management/inventory_local/add_grn_local.php', function(data, status) {
                                                $('#content').html(data);
                                            });
                                        }
                                    },
