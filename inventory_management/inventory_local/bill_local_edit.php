          ...
          <div class="row mb-1">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="po_list_breadcrumb"> Bill Local List</button></li>
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_po_local_breadcrumb" disabled>Edit Bill Local</button></li>
              </ol>
            </div>   
          </div>
        </div>
                    ...
                    <div class="card-body" style="padding:7px">
                        <div class="container">
                          <form method = "post" id = "order_form">
                                ...
                                <div  class="col-lg-12">
                                    ...
                                    <div class="col-md-4 col-lg-2 col-sm-12 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="Year" id="Year" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" readonly tabindex="-1">
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-lg-1 col-sm-12 form-group">
                                    ...
                                    <div class="col-md-4 col-lg-2 col-sm-12 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="bill_key" id="bill_key" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" readonly tabindex="-1">
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-lg-1 col-sm-12 form-group">
                                        <label>Company:</label> 
                                    ...
                                    <div class="col-md-4 col-lg-2 col-sm-12 form-group">
                                        <div class="input-group">
                                            ...
                                            <input maxlength="30" type="text" name="company_code" style="background-color: #ccd4e1;font-weight:bold;" id="company_code" class="form-control form-control-sm" placeholder="Select Company" readonly tabindex="-1">
                                    ...
                                    <div class="col-md-4 col-lg-2 col-sm-12 form-group">
                                        <div class="input-group">
                                            ...
                                            <input maxlength="30" type="text" name="po" style="background-color: #ccd4e1;font-weight:bold;" id="po" class="form-control form-control-sm" placeholder="Select PO" readonly tabindex="-1">
                                    ...
                                    <div class="col-md-6 col-lg-3 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" style="background-color: #ccd4e1;font-weight:bold;" name="" id="" tabindex="-1" class="form-control form-control-sm" placeholder="" readonly tabindex="-1" >
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-lg-1 col-sm-12 form-group">
                                        <label>Voucher#:</label> 
                                    ...
                                    <div class="col-md-4 col-lg-3 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name_p" tabindex="-1" style="background-color: #ccd4e1;font-weight:bold;" id="name_p" class="form-control form-control-sm" placeholder="Party Name" readonly>
                                        </div>
                                    </div>
                                    <!-- Address -->
                                    <div class="col-md-2 col-lg-1 col-sm-12 form-group">
                                    ...
                                    <div class="col-md-4 col-lg-3 col-sm-12 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea rows="1" tabindex="-1" pattern="[a-zA-Z0-9 ,._-]{1,}" style="background-color: #ccd4e1;font-weight:bold;" maxlength="30" name="address_p" id="address_p" class="form-control form-control-sm" placeholder="Address" readonly></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-6 col-sm-12 form-group">
                            ...
                            <div class="card">
                                <br>
                                <table id="example1" class="table-bordered table table-responsive" style="border: 1px solid gray; border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5), 0 6px 20px 0 rgba(0, 0, 0, 0.29); width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>order#</th>
                                            <th>GRN#</th>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <div class="col-lg-3 col-md-6"><input  tabindex="-1" style="background-color: #ccd4e1;" type="text"  name="charge_name" id="charge_name" placeholder="Charge Name" class="form-control form-control-sm mb-sm-2 charge_name" readonly></div>                                          
...
//select company code
//select company code
$('#order_form').on('click','#po',function(){
...
$('#down_table').on('change','#less1',function(){
        ...
        var final2 = parseFloat(total) - parseFloat(less1);
        // console.log(final);
        var finalformat = new Intl.NumberFormat(
                        'en-US', {
                        style: 'currency',
...
$('#down_table').on('change','#less2',function(){
        ...
        var total = $('#total2').val();
        total=total.replaceAll(',','');  
        var finallast = parseFloat(total) - parseFloat(less2);
        var finalformat = new Intl.NumberFormat(
                        'en-US', {
                        style: 'currency',
                        currency: 'USD',
        ...
        //                 currencyDisplay: 'narrowSymbol'
        //             }).format(finallast);
        //             var formatted3 = finalformat.replace(/[$]/g, '');
        // $('#total2').val(formatted3);
...
$(document).ready(function(){
    ...
    $('#company_table').on('click','.odd',function(){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                // console.log(response);
                $('#charge_code').html('');
                $('#charge_code').append('<option value="" selected disabled>Select Item</option>');
                $.each(response, function(key, value){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                // console.log(response);
                $('#frt_code').html('');
                $('#frt_code').append('<option value="" selected disabled>Select Item</option>');
                $.each(response, function(key, value){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                // console.log(response);
                $('#disc_code').html('');
                $('#disc_code').append('<option value="" selected disabled>Select Item</option>');
                $.each(response, function(key, value){
    ...
    $("#down_table").on('change','#charge_code',function(){
         $('#select2-charge_code-container').val('');
         $('#dept_amt1').val('');
           ...
           url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
            ...
            success: function(response){
                ...
                // }else{
                    ...
                    $('#dept1').html('');
                    $('#dept1').append('<option value="" selected disabled>Select Control</option>');
                    $.each(response, function(key, value){
      ...
      $("#down_table").on('change','#dept1',function(){
        $('#select2-dept1-container').val('');
                    var dept_name1=$('#dept1').find(':selected').attr("data-name");
                    var dept_code1=$('#dept1').find(':selected').attr("data-code");
      ...
      $("#down_table").on('change','#dept2',function(){
        $('#select2-dept2-container').val('');
                    var dept_name2=$('#dept2').find(':selected').attr("data-name");
                    var dept_code2=$('#dept2').find(':selected').attr("data-code");
                    $('#select2-dept2-container').html(dept_code2);
                    $('#dept_amt2').val(dept_name2);
    
        });
      $("#down_table").on('change','#dept3',function(){
        $('#select2-dept3-container').val('');
                    var dept_name3=$('#dept3').find(':selected').attr("data-name");
                    var dept_code3=$('#dept3').find(':selected').attr("data-code");
           ...
           url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
            ...
            success: function(response){
                ...
                if(response == null){
                    ...
                    $('#dept2').html('');
                    $('#dept2').append('<option value="" selected disabled>Select Control</option>');
                    $.each(response, function(key, value){
           ...
           url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
            ...
            success: function(response){
                ...
                if(response == null){
                    ...
                    $('#dept3').html('');
                    $('#dept3').append('<option value="" selected disabled>Select Control</option>');
                    $.each(response, function(key, value){
    ...
    $.ajax({
       url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
        ...
        success: function(data){
            ...
            $('#bill_key').val(data.BILL_KEY);
            $('#post').val(data.POST);
            var charge_amt=data.CHARGE_AMT;
            var finalformatadd = new Intl.NumberFormat(
                'en-US', {
                style: 'currency',
                currency: 'USD',
                currencyDisplay: 'narrowSymbol'
                }).format(charge_amt);
            var formateditadd = finalformatadd.replace(/[$]/g, '');
            $('#add1').val(formateditadd);
            var other_chrg=data.OTHER_CHRGS;
            var finalformatles = new Intl.NumberFormat(
                'en-US', {
                style: 'currency',
                currency: 'USD',
                currencyDisplay: 'narrowSymbol'
                }).format(other_chrg);
            var formateditles = finalformatles.replace(/[$]/g, '');
            $('#less1').val(formateditles);
            var other_ded=data.OTHER_DED;
            var finalformatless = new Intl.NumberFormat(
                'en-US', {
                style: 'currency',
                currency: 'USD',
                currencyDisplay: 'narrowSymbol'
                }).format(other_ded);
            var formateditless = finalformatless.replace(/[$]/g, '');
            $('#less2').val(formateditless);
            var total22=data.TOTAL_NET_AMT;
            ...
            var formateditotal = finalformattotal.replace(/[$]/g, '');
            $('#total2').val(formateditotal);
            $.ajax({
                   url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
                    type: 'POST',
                    data: {action: 'charge_code2',CO_CODE:CO_CODE},
                    dataType: "json",
                    success: function(response){
                        $("#ajax-loader").hide();
                        // console.log(response);
                    ...
                    $('#charge_code').val(data.CHARGE_CODE);
                     $('#frt_code').val(data.FRT_CODE);
                    $('#disc_code').val(data.DISC_CODE);
                    $('#charge_name').val(data.charge_name);
                    $('#frt_name').val(data.frt_name);
                    $('#disc_name').val(data.disc_name);
                    var disc_code=data.DISC_CODE
                    var frt_code=data.FRT_CODE
                    var charge_code=data.CHARGE_CODE
                    $.ajax({
                                   url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
                                    type: 'POST',
                                    data: {action: 'dept1',charge_code:charge_code},
                                    ...
                                    console.log(response);
                                            ...
                                            $('#dept1').val(data.CHARGE_DPT);
                                            $('#dept_amt1').val(data.DEPT1NAME)
                        ...
                        $.ajax({
                                   url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
                                    ...
                                    console.log(response);
                                            ...
                                            console.log()
                                            $('#dept2').val(data.FRT_DPT);
                                            $('#dept_amt2').val(data.DEPT2NAME)
                        ...
                        $.ajax({
                           url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
                            ...
                            console.log(response);
                                    ...
                                    $('#dept3').val(data.DISC_DPT);
                                    $('#dept_amt3').val(data.DEPT1NAME)
                        ...
                        var BILL_KEY=data.BILL_KEY;
                    
                        $.ajax({
                           url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
                                type: 'POST',
                                data: {action: 'calculations2',company_code:company_code,DOC_DATE:DOC_DATE,DOC_YEAR:DOC_YEAR,DOC_TYPE:DOC_TYPE,DOC_NO:DOC_NO,BILL_KEY:BILL_KEY},
                                dataType: "json",
                                async:false,
                                success: function(data){
                    ...
                    setTimeout(function (){
                                  var charge_detail=$('#charge_code').find(':selected').attr("data-name");
                                  var charge_code=$('#charge_code').find(':selected').attr("data-code");
                                  // console.log($('#select2-charge_code-container'));
                                  $('#select2-charge_code-container').html(charge_code);
                                  $('#charge_name').val(charge_detail);
                                var frt_code=$('#frt_code').find(':selected').attr("data-code");
                                var FRT_NAME=$('#frt_code').find(':selected').attr("data-name");
                                $('#select2-frt_code-container').html(frt_code);
                                $('#frt_name').val(FRT_NAME);
                    ...
                    error: function(error){
                        ...
                        alert("Contact IT Department");
                            ...
                            //     });
                                ...
                                //             });
                                //             $('#dept3').val(data.DISC_DPT);
                                //             // var dept_CODE=$('#dept_code').find(':selected').val();
            ...
            // $('#dept_amt1').val(data.DEPT1NAME);
            // $('#dept_amt2').val(data.DEPT2NAME);
            // $('#dept_amt3').val(data.DEPT3NAME);
            // // $('#dept2').val(data.FRT_DPT);
            // // $('#dept3').val(data.DISC_DPT);
            // $('#add1').val(data.CHARGE_AMT);
            // $('#less1').val(data.OTHER_CHRGS);
            // $('#less2').val(data.OTHER_DED);
            // $('#total2').val(data.TOTAL_NET_AMT);
            // var party_code=data.PARTY_CODE;
...
$('#less2').val(formatted12);
            ...
            //    url: 'api/Inventory_management/inventory_locals/bill_local_api.php',
            //     type: 'POST',
            //     data:{action:'party_name',party_code:party_code},
            //     dataType: "json",
            //     success: function(response){
            //         // console.log(response);
            ...
            //         // var CHARGE_CODE=$('#charge_code').find(':selected').val();
            //         // var CHARGE_NAME=$('#charge_code').find(':selected').attr("data-name");
            //         // $('#select2-charge_code-container').html(CHARGE_CODE);
            //         // $('#charge_name').val(CHARGE_NAME);
            //         },
            //         error: function(error){
...
$("#order_form").on('click','#report',function(){
    ...
    var order_key = $("#bill_key").val();
    var co_name = $("#company_name").val();
        // ?action=payment_invoice_generate&tr_no="+response.data[0].TRNO
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/inventory_local/bill_report.php?action=print&co_code="+co_code+"&doc_no="+doc_no+"&doc_year="+doc_year+"&co_name="+co_name+"&order_key="+order_key;
        window.open(invoice_url, '_blank');
      });
// $("#PRINTDO").click(function () {
//             let report_url = "area_report/area.php?action=print";
