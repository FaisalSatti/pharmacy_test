...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Purchase Activity By Item</h1>
            </div>
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="pa_item_breadcrumb"> Purchase Activity By Item</button></li>
                </ol>
            </div>   
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    <div class="row"  style="margin-top:-14px;border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <div class="input-group">
                                                ...
                                                <input style="background-color:#ccd4e1;font-weight:bold;" maxlength="30" type="text" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <div class="input-group">
                                                ...
                                                <input style="background-color:#ccd4e1;font-weight:bold;" maxlength="30" type="text" name="item_name" id="item_name" class="form-control form-control-sm" placeholder="Item Name" readonly >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <div class="input-group">
                                                ...
                                                <input style="background-color:#ccd4e1;font-weight:bold;" maxlength="30" type="text" name="party_name" id="party_name" class="form-control form-control-sm" placeholder="Party Name" readonly >
                                            </div>
                                        </div>
                                        ...
                                        <div class="container mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <button type="button" id="item_submit" class="btn btn-primary w-100 mb-2">Run Report</button>
                                                </div>
                                                
                                            </div>
                                        </div>

                                        <!-- <button type="button" id="item_submit" class="btn btn-primary w-100">Online item_submit</button> -->
                                    </div>
                                </form>
                            </div>
                        </div>
...
$(document).ready(function(){
    $('#purchasebyitem').css('pointer-events','');
    $('#purchasebyitem').find($(".far")).removeClass('fa-spin fa-refresh').addClass('fa-books');
...
$('#example1').ready(function(){
    ...
    $("#item_form").on('change','#item_code',function(){
    ...
    $("#item_form").on('change','#party_code',function(){
...
$("#item_submit").on("click", function (e) {
    if ($("#item_form").valid()) {
        ...
        let invoice_url = "invoicereports/inventory_mis_report/purchase_activity_item_report.php?company_code="+company_code+"&item_code="+item_code+"&item_name="+item_name+"&party_code="+party_code+"&party_name="+party_name+"&from_date="+from_date+"&to_date="+to_date;
...
$("#pa_item_breadcrumb").on("click", function () {
