...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>GRN Local Report</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item active"><button class="btn btn-sm" id="setups_breadcrumb">GRN Local Report</button></li>
  ...
  <div style="line-height:1.5rem" class="card container p-2">
    <div style="height:40px" class="card-header">
      <div class="card-title">
        <h2>GRN Local Report (Preview)</h2>
      </div>
    </div>
    <div class="card-body">
      <div id="change">
