...
if(isset($_POST['action']) && $_POST['action'] == 'insert'){
    ...
    $master_q = "insert into acttran_mst(co_code,doc_year,voucher_type,voucher_no,voucher_date,bank_cash_code,naration,ref_no,sn_no,payee,chq_no,chq_date,post)value ('$company_code','$year','BP','$voucher_no','$voucher_date','$bank','$narration','$reference_no','$bank_ser_no','$monthwise_ser_no','$cheque_no','$cheque_date','N')";
    ...
    if($master_r){
        ...
        for($i=0;$i< count($_POST['acc_desc']); $i++){
            ...
            $pymt_type = isset($_POST['type'][$i])?$_POST['type'][$i]:'';
