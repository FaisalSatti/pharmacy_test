          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="voucher_list_breadcrumb" disabled>Cash Payment Edit</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="container">
                          <form method = "post" id = "voucher_form">
                            ...
                            <div id="posted_error" class="alert alert-danger alert-dismissible" style="display: none;">
                              ...
                              <span class="vd_alert-icon"><i class="fa fa-check-circle vd_green"></i></span><strong> Note ! </strong>
                            ...
                            <div class="row"  style="margin-top:-14px;border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                              <input maxlength="30" type="hidden" name="post" id="post" class="form-control form-control-sm" placeholder="Voucher No">
                                 ...
                                 <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" style="background-color:#ccd4e1;font-weight:bold;" name="voucher_no" id="voucher_no" class="form-control form-control-sm" placeholder="Voucher No" readonly tabindex="-1">
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="year" style="background-color:#ccd4e1;font-weight:bold;" id="year" class="form-control form-control-sm" min="1900" max="2099" step="1" value="<?php echo date("Y"); ?>" readonly tabindex="-1" />
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  <label for="inputCompanyName">Co&nbsp;Name:</label><span style="color:red;">*</span>
                                  </div>
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input  type="text" style="background-color:#ccd4e1;font-weight:bold;" name="title" id="title" class="form-control form-control-sm" placeholder="Title Name" readonly tabindex="-1">
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  <label for="">CashSer#:</label>
                                  </div>
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <input  type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" name="monthwise_ser_no2" id="monthwise_ser_no2" class="form-control form-control-sm" placeholder="MonthWise Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <input  type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" name="monthwise_ser_no3" id="monthwise_ser_no3" class="form-control form-control-sm" placeholder="MonthWise Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                              ...
                              <div class="card-body">
                                <form id="d" name="geek">
                                <table id="example1" class="table table-bordered table-striped table-responsive-lg table-responsive" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
                                       <thead>
                                          <tr>
                                              <th>Account Code</th>
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr">
                                            ...
                                            <td>
                                              <textarea style="font-size:12px;background-color:#ccd4e1;"  rows="1" name="" id = "detail" class="form-control form-control-sm detail" tabindex="-1"></textarea>
                                            </td>
                                            <td ><select style="font-size:12px;width: 90px !important;" name="" id = "type" class="form-control form-control-sm type"><option val="" disabled="readonly" selected>Type</option><option val="NML">NML</option><option val="ADV">ADV</option></select></td>
        ...
        // department code dropdown
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    // console.log(response);
                    $('#vehicle_code').html('');
                    $('#vehicle_code').append('<option value="0" readonly tabindex="-1"="readonly tabindex="-1"">Select Veh#</option>');
                    $.each(response, function(key, value){
                        $('#vehicle_code').append('<option value='+value["vehicle_code"]+'>'+value["vehicle_code"]+'</option>');
                    });
                },
...
$("#voucher_form").on('click','#report',function(){
    ...
    var company_name = $("#company_name").val();
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/cashp_report.php?action=print&voucher_no="+voucher_no+"&company_code="+company_code+"&doc_year="+doc_year+"&company_name="+company_name;
