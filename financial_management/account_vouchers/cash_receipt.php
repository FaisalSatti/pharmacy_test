          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_cash_receipt_breadcrumb">Add Cash Receipt</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
                              ...
                              <div class="row"  style="margin-top:-14px;border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="year" style="background-color: #c1c1c1;background-color:#ccd4e1;font-weight:bold;" id="year" tabindex="-1" class="form-control form-control-sm" min="1900" max="2099" step="1" value="<?php echo date("Y"); ?>" readonly />
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control js-example-basic-single  form-control-sm" id="company_code" name="company_code" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px; width: 100px !important;">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input  style="background-color:#ccd4e1;font-weight:bold;"type="text" style="background-color: #c1c1c1;" name="company_name" tabindex="-1" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" type="text" name="bank_ser_no" id="bank_ser_no" class="form-control form-control-sm" placeholder="Cash/Bank Ser#" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" name="monthwise_ser_no" id="monthwise_ser_no" class="form-control form-control-sm" placeholder="MonthWise Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <input  type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" name="monthwise_ser_no2" id="monthwise_ser_no2" class="form-control form-control-sm" placeholder="MonthWise Ser# 2" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <input  style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" type="text" name="monthwise_ser_no3" id="monthwise_ser_no3" class="form-control form-control-sm" placeholder="MonthWise Ser# 3" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
...
<style>
  ...
  @media screen and (min-width: 765px) and (max-width:997px) {
  .select2-container{
  width:65% !important;
  font-size:12px !important
  } 
...
$("#add_cash_receipt_breadcrumb").on("click", function () {
    $.get('financial_management/account_vouchers/cash_receipt.php', function(data,status){
        $("#content").html(data);
    });
});
