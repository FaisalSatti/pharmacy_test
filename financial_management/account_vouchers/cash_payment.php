          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="add_cash_payment_breadcrumb">Add Cash Payment</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="reference_no" id="reference_no" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="Reference No" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="year" id="year" tabindex="-1" style="background-color:#ccd4e1;font-weight:bold;" class="form-control form-control-sm" min="1900" max="2099" step="1" value="<?php echo date("Y"); ?>" readonly />
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input  type="text" name="bank_ser_no" id="bank_ser_no" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="Cash/Bank Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                  ...
                                  <div class="col-lg-2 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        ...
                                        <input  type="text" name="monthwise_ser_no" id="monthwise_ser_no" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="MonthWise Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <input  type="text" name="monthwise_ser_no2" id="monthwise_ser_no2" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="MonthWise Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-12 form-group">
                                    <div class="input-group">
                                        <input  type="text" name="monthwise_ser_no3" id="monthwise_ser_no3" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #61bdb6;border-radius:4px" class="form-control form-control-sm" placeholder="MonthWise Ser#" >
                                    </div>
                                </div>
                                <div class="col-lg-1 col-md-2 col-sm-12 form-group">
                                ...
                                <table id="example1" class="table table-bordered table-striped table-responsive-lg" style="box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr">
                                            ...
                                            <td ><textarea style="font-size:12px;background-color:#ccd4e1;"  rows="1"  name="" tabindex="-1" id = "detail" class="form-control form-control-sm detail" readonly></textarea></td>
                                            ...
                                            <td ><input style="font-size:12px" style="text-align:right; padding:0 13px 0 0"  pattern="[a-zA-Z0-9 ,._-]{1,}" value="" type="text"  name="" id = "amount" class="form-control form-control-sm amount text-right"></td>
...
$("#add_cash_payment_breadcrumb").on("click", function () {
    $.get('financial_management/account_vouchers/cash_payment.php', function(data,status){
        $("#content").html(data);
    });
});
