    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="stock_ledger_loc_breadcrumb">DATE-WISE UNPOSTING</button></li>
                </ol>
            </div>   
            </div>
        </div><!-- /.container-fluid -->
...
$("#ledger_form").on('click','#ledger',function(){
    ...
    var from_date=$('#from_date').val();
    var to_date=$('#to_date').val();
    $.get('financial_management/account_vouchers/untotal.php?company_code='+company_code+'&from_date='+from_date+'&to_date='+to_date, function(data,status){
        $("#content").html(data);
    });
...
$("#stock_ledger_loc_breadcrumb").on("click", function () {
    $.get('financial_management/account_vouchers/datewise_unpost.php', function(data,status){
        $("#content").html(data);
    });
});
</script>