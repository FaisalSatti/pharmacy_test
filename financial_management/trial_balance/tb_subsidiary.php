...
<div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 >Trial Balance - Subsidiary Account</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="subsidiary_tb_breadcrumb">TB Subsidiary</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
              <div class="col-12">
                  <div class="card" style="border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                    <div class="card-body">
                        <div class="container">
                          <form method = "post" id = "subsidiary_form">
                              ...
                              <div class="row"  style="margin-top:-14px;border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                ...
                                <div class="col-lg-6 col-md-6 form-group">
                                    <div class="input-group">
                                        ...
                                        <input style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="Account_name1" id="Account_name1" class="form-control form-control-sm" placeholder="Account Name" readonly >
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-2 form-group">
                            ...
                            <button type="button" id="subsidiary_tb" class="btn btn-primary w-100 m-2">Trial Balance</button>
                          </form>
                        </div>
                    </div>
                  </div>
...
$('#example1').ready(function(){
      ...
      $("#subsidiary_form").on('change','#company_code',function(){
          $("#ajax-loader").show();
      ...
      //on chAnge company code
      $("#subsidiary_form").on('change','#From_code',function(){
      ...
      //on chAnge company code
      $("#subsidiary_form").on('change','#To_code',function(){
...
$("#subsidiary_tb").on("click", function (e) {
    if ($("#subsidiary_form").valid()) {
        var company_code=$('#company_code').val();
        var From_code=$('#From_code').val();
        var To_code=$('#To_code').val();
        var from_date=$('#from_date').val();
        var to_date=$('#to_date').val();
        let invoice_url = "invoicereports/Financial_mis_reports/tb_subsidiary_report.php?company_code="+company_code+"&from_code="+From_code+"&to_code="+To_code+"&from_date="+from_date+"&to_date="+to_date;
...
$("#subsidiary_tb_breadcrumb").on("click", function () {
