...
<div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 >Trial Balance - Control Account</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="control_tb_breadcrumb">TB Control</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="container">
                          <form method = "post" id = "control_form">
                            ...
                            <button type="button" id="control_tb" class="btn btn-primary w-100 m-2">Trial Balance</button>
                          </form>
                        </div>
                    </div>
                  </div>
...
$('#example1').ready(function(){
      ...
      $("#control_form").on('change','#company_code',function(){
          $("#ajax-loader").show();
          ...
          $('#company_name').val(company_name);
             ...
             $.ajax({
                url: 'api/financial_management/MIS/tb_control_api.php',
                type: 'POST',
      ...
      //on chAnge company code
      $("#control_form").on('change','#From_code',function(){
      ...
      //on chAnge company code
      $("#control_form").on('change','#To_code',function(){
...
$("#control_tb").on("click", function (e) {
    if ($("#control_form").valid()) {
        var company_code=$('#company_code').val();
        var From_code=$('#From_code').val();
        var To_code=$('#To_code').val();
        var from_date=$('#from_date').val();
        var to_date=$('#to_date').val();
        let invoice_url = "invoicereports/Financial_mis_reports/tb_control_report.php?company_code="+company_code+"&from_code="+From_code+"&to_code="+To_code+"&from_date="+from_date+"&to_date="+to_date;
