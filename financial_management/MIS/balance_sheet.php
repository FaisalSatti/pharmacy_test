          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="online_ledger_breadcrumb">BALANCE SHEET</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="container">
                          <form method = "post" id = "ledger_form">
                            ...
                            <button type="button" id="ledger" class="btn btn-primary w-100 m-2">Profit - Loss</button>
                          </form>
                        </div>
                    </div>
                  </div>
...
$('#example1').ready(function(){
      ...
      //on chAnge company code
      $("#ledger_form").on('change','#From_code',function(){
...
$("#ledger_form").on('click','#ledger',function(){
    if ($("#ledger_form").valid()) {
        ...
        let invoice_url = "invoicereports/balance_sheet_report.php?action=print&company_code="+company_code+"&from_code="+From_code+"&to_code="+To_code+"&from_date="+from_date+"&to_date="+to_date;
