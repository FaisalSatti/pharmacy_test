          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="online_ledger_breadcrumb">Online Ledger</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="container">
                          <form method = "post" id = "ledger_form">
                            ...
                            <button type="button" id="ledger" class="btn btn-primary w-100 m-2">Online Ledger</button>
                          </form>
                        </div>
                    </div>
                  </div>
...
$("#ledger").on("click", function (e) {
    if ($("#ledger_form").valid()) {
        ...
        $.get('financial_management/MIS/online_ledger_view.php?company_code='+company_code+'&from_code='+From_code+'&to_code='+To_code+'&from_date='+from_date+'&to_date='+to_date, function(data,status){
            $("#content").html(data);
            });
