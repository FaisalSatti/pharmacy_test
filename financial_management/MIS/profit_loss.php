          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="online_ledger_breadcrumb">Profit - Loss</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
...
$("#ledger_form").on('click','#ledger',function(){
    var company_code=$('#company_code').val();
        ...
        let invoice_url = "invoicereports/profit_and_loss.php?action=print&company_code="+company_code+"&from_code="+From_code+"&to_code="+To_code+"&from_date="+from_date+"&to_date="+to_date;
