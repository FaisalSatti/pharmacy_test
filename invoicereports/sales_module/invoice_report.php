...
if (isset($_GET['action']) && $_GET['action'] == 'print') {
    if (isset($_GET['order_key']) && !empty($_GET['order_key'])) {
        ...
        $sql = "SELECT 
        A.CO_CODE,A.DOC_YEAR,A.DOC_TYPE,A.DOC_NO,A.DOC_DATE,A.DO_KEY,A.ORDER_PARTY_REF,A.REFNUM,A.REFNUM2,A.ORDER_REFNUM,A.
        DUE_DATE,A.PO_NO,A.PO_DATE,A.
        PARTY_CODE,A.PARTY_NAME,A.ADDRESS,A.CONTACT_NAME,A.PHONE_NOS,A.GST,A.NTN,A.CITY_NAME,A.CRDAYS,A.
        DIV_NAME,A.SMAN_NAME,A.SHIP_MODE,A.SHIP_NO,A.
        STAX_RATE,A.STAX_AMT,A.OTHER_CHRGS,A.OTHER_DED,A.TOTAL_GROSS_AMT,A.TOTAL_NET_AMT,A.REMARKS,A.
        ADDTAX_AMT,A.CHARGE_AMT,A.ADDTAX_RATE,A.loc_code,A.
        ENTRY_NO,A.ITEM_CODE,A.ITEM_NAME_SALE,A.TYPE_NAME,A.ITEM_NAME_SALE2,A.UM_NAME,A.
        QTY,A.RATE,A.AMT,A.DISC_RATE,A.DISC_AMT,A.FRT_RATE,A.FRT_AMT,A.
        EXCL_RATE,A.EXCL_AMT,A.STAX_RATE_DTL,A.STAX_AMT_DTL,A.ADD_RATE,A.ADD_AMT,A.NET_AMT,A.
        BATCH_NO,A.EXPIRY_DATE,A.LEDGER_BAL,A.itax_rate,A.itax_amt,A.REFNUM2,A.order_refnum,B.co_name
        ...
        if($count > 0){
            ...
            foreach ($return_data as  $value) {
                ...
                $data_tr .=
                    '<tr style="border:1px solid black">
                        <td style="border:2px solid black;font-size:12px;width:7%;">'.$i.'</td>
                        <td  style="border:2px solid black;font-size:12px;width:30%;">'.$value['item_name'].'</td>
                        <td style="border:2px solid black;font-size:12px;width:9%;">'.number_format($value['qty'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:9%;">'.$value['batch_no'].'</td>
                        <td style="border:2px solid black;font-size:12px;width:12%;">'.number_format($value['EXCL_RATE'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:10%;">'.number_format($value['STAX_RATE_DTL'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:13%;">'.number_format($value['ADD_RATE'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:10%;">'.number_format($value['Inc'],2).'</td>
                    </tr>
                    <tr style="border:1px solid black">
                        <td  style="border:2px solid black;font-size:12px;width:7%;"></td>
                        <td style="border:2px solid black;text-align:left;font-size:12px;width:30%;">'.$value['item_code'].'&emsp;'.$value['TYPE_NAME'].'&emsp;&emsp;&emsp;&emsp;'.$value['um_name'].'</td>
                        <td  style="border:2px solid black;font-size:12px;width:9%;">'.$value['loc_code'].'</td>
                        <td style="border:2px solid black;width:10%;font-size:12px;">'.$expiry_date.'</td>
                        <td  style="border:2px solid black;text-align:left;width:12%;font-size:12px;">'.number_format($value['excl_amt'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:9%;">'.number_format($value['STAX_AMT_DTL'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:13%;">'.number_format($value['ADD_AMT'],2).'</td>
                        <td style="border:2px solid black;font-size:12px;width:10%;">'.number_format($value['net_amt'],2).'</td>
                    </tr>';
            ...
            <div class="main-heading">
                ...
                <table border = "2" class="secondlast" style="width:30%;border-collapse:collapse;margin-top:-80px;margin-left:160px;font-family:arial;" >
                    ...
                    <tr>
                        <td style="font-size:10px;"><span><b>'.$ntn.'</b></span></td>
                    </tr>
                    <tr>
            ...
            <div class="main-heading">
                <table border = "2" class="secondlast" style="border-collapse:collapse;margin-top:-115px;margin-left:360px; " >
                    <tr>
                        <td style="width:170px;font-size:20px;font-family:arial;"><b>INVOICE</b></td>                                   
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width:170px;font-size:11px;"><span>DC# <b>'.$po_no.'</b></span></td>                                   
                    </tr>
                    <tr>
            ...
            <div class="main-heading">
                <table border = "2" class="secondlast" style="border-collapse:collapse;margin-top:-120px;margin-left:550px; " >
                <tr>
                    <td style="width:170px;font-size:11px;"></td>                                   
                 </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width:170px;font-size:12px;"><span>Division <b>'.$div_name.'</b></span></td>                                   
                    </tr>
                    <tr>
                        <td style="width:170px;height:8px;font-size:12px;"></td>                                   
                    </tr>
                    <tr>
                        <td style="width:200px;font-size:12px;"><span>Order Date<b>'.$due_date.'</b></span></td>                                   
                    </tr>
                    <tr>
                        <td style="width:170px;height:8px;"></td>                                   
                    </tr>
                    <tr>
                        <td style="width:200px;font-size:12px;"><span>Order Ref#<b>'.$order_refnum.'</b></span></td>                                   
                    </tr>
                    <tr>
                        <td style="width:170px;font-size:12px;"></td>                                   
                    </tr>
            ...
            <div class="" style="border:1px solid black;width:100%;">
                <table class="">
                    <tr>
                        ...
                        <td style="background-color:gray;height:50px;padding-left:20px;font-size:12px;width:350px;">DELIVER TO</td>
                    </tr>
                    <tr>
            ...
            <div class="invoice_detail"  style="padding-top:30px;height: 350px;">
                <table class="table_head" style="border:1px solid black;display:inline-block;width:100%;height:1200px;">
                    <tr style="padding-top:55px">
                        ...
                        <td colspan="3" style="border:2px solid black;width:200px">Item Description</td>
                ...
                <table class="secondlast" style="border:1px solid black;display:inline-block;width:100%;" >
                    <tr style="">
                        <td rowspan="6" style="padding-bottom:110px"><img width="100%" height="25%" src="../../uploads/um_part2.jpg"></td>
                            ...
                            <td style="width:120px;" ><p style="border:2px solid black;font-size:11px"></p></td>
                    </tr>
                    <tr>
                        <td style="width:168px;font-size:16px;padding-left:40px"><b>Add: Itax Amt</b></td>
                        <td  style="width:55px;padding-bottom:0px;"><p style="border:2px solid black;width:55px;padding-bottom:20px;font-size:16px;">'.number_format($ITAX_RATE,2).'&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;</p></td>
                        <td style="width:120px;padding-bottom:0px" ><p style="border:2px solid black;font-size:16px;">'.number_format($ITAX_AMT,2).'</p></td>
                    </tr>
                    <tr>
                        <td style="width:168px;font-size:16px;padding-left:40px"><b>Add: Others</b></td>
                            <td style="width:55px;padding-bottom:0px" ></td>
                        <td style="width:120px;padding-bottom:0px" ><p style="border:2px solid black;font-size:16px;">'.number_format($charge_amt,2).'</p></td>
                    </tr>
                    <tr>
                        <td style="width:168px;font-size:16px;padding-left:40px"><b>Less: Freight</b></td>
                            <td style="width:55px;padding-bottom:0px" ></td>
                        <td style="width:120px;padding-bottom:0px"><p style="border:2px solid black;font-size:16px;">'.number_format($other_chrgs,2).'</p></td>
                    </tr>
                    <tr>
                        <td style="width:168px;font-size:16px;padding-left:40px"><b>Less: Further Disc</b></td>
                            <td style="width:55px;padding-bottom:0px" ></td>
                        <td style="width:120px;padding-bottom:0px" ><p style="border:2px solid black;font-size:16px;">'.number_format($other_ded,2).'</p></td>
                    </tr>
                    <tr>
                        <td style="font-size:16px;padding-left:40px;padding-bottom:40px"><b>Net Amount</b></td>
                        <td  style="width:55px;padding-bottom:0px;"></td>
                        <td style="width:120px;padding-bottom:30px" ><p style="border:2px solid black;font-size:16px;">'.number_format($total_net_amt,2).'</p></td>
                    </tr> 
