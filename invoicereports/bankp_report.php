 ...
 ORDER BY CO_CODE,VOUCHER_TYPE,VOUCHER_NO,ENTRY_NO";
        ...
        if ($count > 0) {
                ...
                '<div class="row" style="line-height:16px;">
                    <div class="main-heading">
                        <table class="secondlast" style="width:100%;border-collapse:collapse;margin-top:20px;">
                            <tr>
                                <td style="width:250px;font-size:20px;font-family:arial;text-align:center;"><b>'.$company_name.'</b></td>                                   
                            </tr>
                            <tr>
                            <td style="border-bottom:3px solid black;padding-top:15px;"></td>                                   
                            </tr>
                            <tr>
                                <td style="width:250px;font-size:20px;text-align:center;font-weight:bold;padding-top:8px;">BANK RECEIPT</td>                                   
                            </tr>
                            <tr>
                    ...
                    <div class="main-heading">
                        ...
                        <tr>
                            <tr colspan="4">
                                ...
                                <td style="width:30px;"></td>                                   
                                <td style="width:60px;font-size:17px;font-family:arial;font-weight:bold;">chq DATE</td>                                   
                                <td style="width:210px;font-size:17px;font-family:arial;border:1px solid black;">&nbsp;'. $CHQ_DATE    .'</td>
                                <td style="width:30px;"></td>                                   
            ...
            <tr>
                ...
                <td style = "font-size:11px; border:2px solid grey;">'.$TOTAL .'</td>   
            </tr>
            <tr>
