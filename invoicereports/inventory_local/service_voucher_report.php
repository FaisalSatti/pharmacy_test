...
if (isset($_GET['action']) && $_GET['action'] == 'print') {
    if (isset($_GET['voucher_no']) && !empty($_GET['voucher_no'])) {
        ...
        A.CREDIT,A.REMARKS,B.co_name FROM ACCOUNT_VIEW_UM_JV A JOIN company B ON A.co_code=B.co_code WHERE A.VOUCHER_NO='$voucher_no' AND A.VOUCHER_TYPE = 'RV' AND A.CO_CODE = '$co_code' AND A.DOC_YEAR = '$doc_year' ORDER BY A.CO_CODE, 
                ...
                '<div class="row" style="line-height:16px;">
                    <div class="main-heading">
                        <table class="secondlast" style="width:100%;border-collapse:collapse;margin-top:20px;">
                            <tr>
                                <td style="width:250px;font-size:19px;font-family:arial;text-align:center;"><b>' . $co_name . '</b></td>                                   
                            </tr>
                            <tr>
                            <td style="border-bottom:3px solid black;padding-top:15px;"></td>                                   
                            </tr>
                            <tr>
                                <td style="width:250px;font-size:21px;text-align:center;font-weight:bold;padding-top:8px;">Bills Payable</td>                                   
                            </tr>
                            <tr>
                    ...
                    <div class="main-heading">
                        <table class="secondlast" style="width:100%;border-collapse:collapse;margin-top:20px;">
                            <tr colspan="4">
                                <td style="width:90px;font-size:17px;font-family:arial;font-weight:bold;">Bill Nbr</td>                                   
                                ...
                                <td style="width:110px;font-size:17px;font-family:arial;border:1px solid black;">&nbsp;' . $VOUCHER_DATE . '</td>
                                <td style="width:30px;"></td>                                   
                                    <td style="width:100px;font-size:17px;font-family:arial;font-weight:bold;">Voucher#</td>                                   
                                    <td style="width:130px;font-size:17px;font-family:arial;border:1px solid black;">&nbsp;' . $REF_NO . '</td>
                                    <td style="width:30px;"></td>                                   
