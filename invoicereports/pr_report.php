...
if (isset($_GET['action']) && $_GET['action'] == 'print') {
    if (isset($_GET['do_key']) && !empty($_GET['do_key'])) {
        ...
        $sql = "SELECT CO_CODE,DOC_YEAR,DOC_TYPE,DOC_NO,DOC_DATE,DO_KEY,REFNUM,REFNUM2,REMARKS,
        DEPT_CODE,DEPT_NAME,WH_CODE,FROM_LOC,
        ...
        if ($count > 0) {
            ...
            while ($show = mysqli_fetch_assoc($result)) {
                ...
                $DEPTCD = $return_data[0]['dept_name'];
            ...
            foreach ($return_data as  $value) {
                ...
                $data_tr .= '<tr style="border:1px solid black">
                                <td style="border:2px solid black;width:14%;font-size:14px;">' . $i . '</td>
                                <td style="border:2px solid black;width:14%;font-size:14px;">' . $value['item_code'] . '</td>
                                <td style="border:2px solid black;width:32%;font-size:14px;">' . $value['ITEM_NAME'] . '</td>
                                <td style="border:2px solid black;width:12%;font-size:14px;">' . $value['um_name']. '</td>
                                <td style="border:2px solid black;width:12%;font-size:14px;">' . number_format($value['qty'],2) . '</td>
                                <td style="border:2px solid black;width:14%;font-size:14px;">' . $value['batch_no'] . '</td>
                                <td style="border:2px solid black;width:17%;font-size:14px;">' . $value['expiry_date'] . '</td>        
                            </tr>';
            ...
            $stylesheet = file_get_contents('pr_invoice.css');
            ...
            $mpdf->WriteHTML(
                '<div class="row" style="line-height:16px;">
                    ...
                    <div class="main-heading">
                        <table border = "2" class="secondlast" style="width:100%; border-collapse:collapse;margin-top:-130px;margin-left:700px; " >
                            <tr>
                                <td style="width:250px;font-size:26px;font-weight:bold;">PRODUCTION REPORT</td>                                   
                            </tr>
                            <tr>
                                <td style="width:250px;font-size:15px;"><span>PR No :<b>'. $REFNUM2  .' </b></span></td>                                   
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width:250px;font-size:15px;"><span>DEPT REF <b>'. $REFNUM   .'</b></span></td>                                   
                            </tr>
                    ...
                    <div class="" style="border:1px solid black;margin-top:20px">
                        <table class="">
                            <tr>
                            <td style = "font-size:11px;width:20%"> from Department</td>
                                <td style="background-color:gray;height:30px;width:600px"><b>'. $DEPTCD   .'</b></td>
                    ...
                    <div class="invoice_detail" style="padding-top:20px;">
                        <table class="table_head" style="border:1px solid black;display:inline-block;height:1200px;">
                            <tr style="padding-top:55px">
                                <td style="border:2px solid black;width:12%"><b>S-No</b></td>
                                <td colspan="1" style="border:2px solid black;width:17%;"><b>Code</b></td>
                                <td colspan="4" style="border:2px solid black;width:40%;"><b>Item Description</b></td>
                                <td colspan="2" style="border:2px solid black;width:12%;"><b>UM</b></td>
                                <td colspan="2" style="border:2px solid black;width:13%;"><b>Qty</b></td>
                                <td colspan="2" style="border:2px solid black;width:15%;"><b>batch no</b></td>
                                <td colspan="2" style="border:2px solid black;width:19%"><b>expiry</b></td>
                            </tr>
                        </table>
