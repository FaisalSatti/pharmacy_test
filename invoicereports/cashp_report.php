        ...
        if ($count > 0) {
            ...
            foreach ($return_data as  $value) {
                ...
                $data_tr .= '<table style="border:1px solid black;width:100%;">
                                ...
                                <td style="width:15%;font-size:12px;">'.number_format($value['DEBIT'],2).'</td>
                            </tr>
                            </table>';
                ...
                '<div class="row" style="line-height:16px;">
                    <div class="main-heading">
                        <table class="secondlast" style="width:100%;border-collapse:collapse;margin-top:20px;">
                            ...
                            <tr>
                                <td style="width:250px;font-size:20px;text-align:center;font-weight:bold;padding-top:8px;">CASH PAYMENT</td>                                   
                            </tr>
                            <tr>
