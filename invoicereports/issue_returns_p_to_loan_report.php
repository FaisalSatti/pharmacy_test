...
if (isset($_GET['action']) && $_GET['action'] == 'print') {
    if (isset($_GET['order_key']) && !empty($_GET['order_key'])) {
        ...
        $doc_type = "IRLN";
        $sql = "SELECT CO_CODE,DOC_YEAR,DOC_TYPE,DOC_NO,DOC_DATE,DO_KEY,REFNUM2,REMARKS,
            party_code,party_name,address,city_name,phone_nos,
            ENTRY_NO,ITEM_CODE,ITEM_NAME_SALE ITEM_NAME,UM_NAME,QTY,BATCH_NO,EXPIRY_DATE,
            loc_code,loc_name,ISLN_REF
            FROM IRLN_UM_VIEW
        ...
        if ($count > 0) {
            ...
            foreach ($return_data as  $value) {
                $data_tr .= '<tr style="padding-top:55px">
                    ...
                    <td colspan="1" style="border:1px solid black;width:12%">' . $value['item_code'] . '</td>
                    <td colspan="1" style="border:1px solid black;width:29%;"> ' . $value['ITEM_NAME'] . ' </td>
                    <td colspan="1" style="border:1px solid black;width:12%">' . $value['doc_no'] . '</td>
                    <td colspan="1" style="border:1px solid black;width:12%; text-align:right">' . $value['qty'] . '</td>
                    <td colspan="1" style="border:1px solid black;width:20%">' . $value['loc_name'] . '</td>
            ...
            <div class="main-heading">
                <table border = "2" class="secondlast" style="width:110%; border-collapse:collapse;margin-top:-140px;margin-left:400px;font-family:arial;" >
                    <tr>
                        <td style="width:250px;font-size:20px;font-weight:bold;">Good Receipt / Loan Return</td>
                    </tr>
                    <tr>
                        <td style="width:250px;font-size:12px;"><span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                    </tr>
                    <tr>
                        <td style="width:250px;font-size:12px;"><span>GRN LOAN#. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>' . $do_key . '</b> </span></td>
                    </tr>
                    <tr>
                        <td style="width:250px;font-size:12px;"><span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                    </tr>.
            ...
            <div class="" style="border:2px solid black;">
                <table class="" style="padding:10px 0px; font-family:arial;">
                    <tr>
                        <td style="width:50%;padding-right:20px;text-transform:uppercase;font-size:11px;padding:5px">PARTY NAME: &nbsp;&nbsp;<b style="font-size:15px;">' . $party_name . '</b></td>
                        <td style="width:50%;padding-left:20px;text-transform:uppercase;font-size:11px;padding:5px">&nbsp;&nbsp;&nbsp; CODE : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:15px;">' . $party_code . '</b></td>
                    </tr>
                    <tr>
                    <td style="width:50%;padding-right:20px;text-transform:uppercase;font-size:11px;padding:5px">Address:  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:15px;">' . $address . '</b></td>
                    <td style="width:50%;padding-left:20px;text-transform:uppercase">' . '</td>
                    </tr>
                    <tr>
                    <td style="width:50%;padding-left:0px;text-transform:uppercase;padding:5px;">City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:15px;">' . $city_name . '</b></td>
                    <td style="width:50%;padding-right:280px;text-transform:uppercase;">PHONE#:&nbsp;<b style="font-size:15px;">' . $phone_nos . '</b></td>
                    </tr>
                </table>
            </div>
            <br><br>
            <div class="invoice_detail" style="padding:5px;height: 350px;border:2px solid black">
                <table class="table_head" style="border:2px solid black;display:inline-block;width:100%;height:1200px;font-family:arial;">
                    <tr style="padding-top:55px">
                        ...
                        <td colspan="1" style="border:1px solid black;width:12%"><b>ISLN_REF</b></td>
                        <td colspan="1" style="border:1px solid black;width:12%"><b>Qty</b></td>
                        <td colspan="1" style="border:1px solid black;width:20%"><b>Loc Name</b></td>
            ...
            <div style = "margin-top:30px;">
                <span>&emsp;&emsp;</span>
                <span style = "font-weight: bold;border-top:0px solid black;"> &emsp;&emsp;&emsp; &nbsp; &emsp;&emsp;&emsp;&emsp;&emsp;</span>
                <br>
                <br>
