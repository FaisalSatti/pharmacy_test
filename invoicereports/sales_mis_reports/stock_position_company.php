...
// $barcode = new Helpers();
        ...
        $query = "SELECT div_code,div_name,gen_code,gen_name,product_code,product_name,
        item_code,item_name,pur_mode,um_name,
        sum(IFNULL(open_stock,0)) + sum(IFNULL(adj_qty,0))  open_qty
        from item_um_co_view_batch
        where co_code = '$company_code' AND pur_mode = IFNULL('$purchase_mode',pur_mode)
        $merge_d  $merge_e $merge_i  $merge_pro
        group by
        div_code,div_name,gen_code,gen_name,product_code,product_name,
        item_code,item_name,pur_mode,um_name
        order by div_name,gen_code,gen_name,product_name,item_name";
        // PRINT_R($query);DIE();
      ...
      if ($count > 0) {
        ...
        foreach ($return_data as $value) {
          ...
          if($div_code_pre != $div_code_new){
            // print_r($div_code_pre);
            // print_r("a");
            // print_r($div_code_new);
            // print_r("b");
            ...
            $data_tr .='
                ...
                <table style="border: 4px solid black; padding:10px;white-space: nowrap;">
                  <tr style="border: 2px solid black ;">
                      ...
                      <th style = " font-size:16px;text-align:center;border: 2px solid black ;width:15%">Mode</th>
          ...
          $data_tr .='
                        ...
                        <tr>
                            ...
                            <td style = " font-size:16px;text-align:center;width:15%"></td>
        ...
        <div class="row" style="line-height:16px;font-family:arial;">
          ...
          <div class="main-heading">
            ...
            <div class = " col-lg-6 col-md-6 col-sm-12" style="border-bottom: 4px solid black;margin-top:10px; padding-bottom:5px">
              <span class = "" style="font-size:18px; font-weight:bold">Stock Report - By Company</span>  
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
