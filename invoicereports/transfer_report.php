...
if (isset($_GET['action']) && $_GET['action'] == 'print') {
    if (isset($_GET['do_key']) && !empty($_GET['do_key'])) {
        ...
        WH_CODE,FROM_LOC,WH_CODE2,TO_LOC,
        ENTRY_NO,ITEM_CODE,ITEM_NAME_SALE ITEM_NAME,UM_NAME,QTY,BATCH_NO,EXPIRY_DATE,REMARKS
        FROM TR_UM_VIEW
                ...
                '<div class="row" style="line-height:16px;">
                    ...
                    <div class="main-heading">
                        <table border = "2" class="secondlast" style="width:100%; border-collapse:collapse;margin-top:-130px;margin-left:700px; " >
                            <tr>
                                <td style="width:250px;font-size:26px;font-weight:bold;">TRANSFER REPORT</td>                                   
                            </tr>
                            <tr>
