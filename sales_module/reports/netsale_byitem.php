          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="stock_company_breadcrumb"> NET SALE BY ITEM</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
...
$("#type_datewise_posting_form").on('click','#type_datewise_post',function(){
  if ($("#type_datewise_posting_form").valid()) { 
    ...
    let invoice_url = "invoicereports/netsale_byitem_report.php?action=print&item_code="+item_code+"&company_code="+company_code+"&division_name="+division_name+"&company_name="+company_name+"&division_code="+division_code+"&catg="+catg+"&mode="+mode+"&from_date="+from_date+"&to_date="+to_date;
    window.open(invoice_url, '_blank');
  }
});
