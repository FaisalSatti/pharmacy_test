          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="sp_item_breadcrumb"> Stock Position Item</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
...
$('#example1').ready(function(){
    ...
    $("#stock_form").on('change','#location_code',function(){
...
$("#stock_pos").on("click", function (e) {
    if ($("#stock_form").valid()) {
        ...
        let invoice_url = "invoicereports/SALES_mis_reports/stock_position_item.php?company_code="+company_code+"&from_code="+From_code+"&to_code="+To_code+"&from_date="+from_date+"&to_date="+to_date+"&item_code="+item_code+"&purchase_mode="+purchase_mode+"&product_code="+product_code+"&division_code="+division_code+"&division_name="+division_name+"&location_code="+location_code;
...
$("#sp_item_breadcrumb").on("click", function () {
