            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><button class="btn btn-sm" id="stock_company_breadcrumb"> Stock Ledger Company</button></li>
                    </ol>
                </div>   
            </div>
        </div><!-- /.container-fluid -->
...
$("#ledger").on("click", function (e) {
    if ($("#ledger_form").valid()) {
        ...
        let invoice_url = "invoicereports/sales_mis_reports/stock_ledger_company_report.php?company_code="+company_code+"&item_code="+item_code+"&from_date="+from_date+"&to_date="+to_date+"";
