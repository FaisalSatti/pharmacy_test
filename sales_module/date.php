...
$("#ledger_form").on('click','#ledger',function(){
    ...
    var from_date=$('#from_date').val();
    var to_date=$('#to_date').val();
    $.get('sales_module/post_total.php?company_code='+company_code+'&from_date='+from_date+'&to_date='+to_date, function(data,status){
        $("#content").html(data);
    });
...
$("#stock_ledger_loc_breadcrumb").on("click", function () {
    $.get('sales_module/date.php', function(data,status){
        $("#content").html(data);
    });
});
</script>