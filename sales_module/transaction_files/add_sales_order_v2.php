                                  ...
                                  <table id="example1" class="table table-bordered table-striped table-responsive">
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr">
                                            ...
                                            <td style="width:9%" ><select style="font-size:11px;width:60px !important;height:35px" name="" id = "type" class="type"><option value="0" readonly="readonly" selected>Type</option><option value="N">N</option><option value="F">F</option><option value="S">S</option><option value="T">T</option></select></td>
                                            ...
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text"  name="" id = "rate" class="rate"></td>
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px;background-color:#b7edea"  pattern="[a-zA-Z0-9 ,._-]{1,}"  type="text" tabindex="-1"  name="" id = "amount" class="amount" readonly></td>
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "disc_m" class="disc_m" readonly></td>
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px;background-color:#b7edea"  pattern="[a-zA-Z0-9 ,._-]{1,}" tabindex="-1"  type="text"   name="" id = "disc" class="disc" readonly></td>
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "frt_m" class="frt_m" readonly></td>
                                            <td style="width: 13%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px;background-color:#b7edea"  pattern="[a-zA-Z0-9 ,._-]{1,}" tabindex="-1" type="text"  name="" id = "frt" class="frt" readonly></td>
                                            <td style="width: 10%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px"  pattern="[a-zA-Z0-9 ,._-]{1,}" type="text"  name="" id = "excl_m" class="excl_m" readonly></td>
                                            <td style="width: 13%;"><input  style="text-align:right; padding:0 2px 0 0;width:85px;height:35px;background-color:#b7edea"  pattern="[a-zA-Z0-9 ,._-]{1,}" tabindex="-1" type="text"   name="" id = "excl" class="excl" readonly></td>
...
$(document).ready(function(){
    $("#order_form").on('focus','.rate',function(){
        ...
        var previous_disc= $('#disc'+p_rate_id).val();
        sessionStorage.setItem("previous_disc", previous_disc);
        var previous_frt= $('#frt'+p_rate_id).val();
    ...
    $("#order_form").on('focus','.quantity',function(){
        ...
        sessionStorage.setItem("previous_amount", previous_amount);
        var previous_disc= $('#disc'+p_quantity_id).val();
        sessionStorage.setItem("previous_disc", previous_disc);
        var previous_frt= $('#frt'+p_quantity_id).val();
        sessionStorage.setItem("previous_frt", previous_frt);
    });
    ...
    if(company_code != ''){
        ...
        $.ajax({
            ...
            for (var i = 0; i < response.length; i++) {
                sno++;
                table.row.add([sno,response[i].party_name,response[i].party_division,response[i].division_name,response[i].zone_name,response[i].city_name]);
