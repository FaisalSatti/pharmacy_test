                        ...
                        <div class="container">
                          <form method = "post" id = "order_form">
                            ...
                            <div class="row" style="border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                    ...
                                    <!-- <div class="row"> -->
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" type="number"  style="background-color:#ccd4e1;font-weight:bold;" name="year" id="year" class="form-control form-control-sm" placeholder="Year" value="<?php echo date('Y'); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Company:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" style="background-color:#b7edea !important;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" name="company_code" id="company_code" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                        ...
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1"  style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" type="text" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Order#:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input title="Sale Code"  style="background-color:#b7edea !important;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" type="text" name="order_key" id="order_key" class="form-control form-control-sm" placeholder="Order No" readonly >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Date:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" type="date" name="po_date" id="po_date"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" maxlength="30" type="text" name="division"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" id="division" class="form-control form-control-sm" placeholder="Select Division" readonly>
                                        ...
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" type="text" name="division_name"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" id="division_name" class="form-control form-control-sm" placeholder="Title Name" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>PO Cat:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" maxlength="1" type="text" name="purchase_mode"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" id="purchase_mode" class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" type="text" name="order_ref" id="order_ref" class="form-control form-control-sm" placeholder="Order Ref" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="party_ref" id="party_ref" class="form-control form-control-sm" placeholder="Party Ref" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="due_date" id="due_date"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>CRDAYS:</label> 
                                        ...
                                        <div class="col-lg-5 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" name="cr_days" id="cr_days" class="form-control form-control-sm" placeholder="CR DAYS" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="party" id="party"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Select Party" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 form-group">
                                            <!-- <label for="">Party :<span style="color:red">*</span></label> -->
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" id="name"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Party Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Address:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"  name="address"   style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" id="address" class="form-control form-control-sm" placeholder="Address" readonly tabindex="-1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>City:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"    style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;" maxlength="30" name="city_p" id="city_p" class="form-control form-control-sm" placeholder="City" readonly tabindex="-1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Zone:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="zone_p" id="zone_p" class="form-control form-control-sm" placeholder="Zone No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Phone#:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30"  style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;"  type="text" name="phone" id="phone" class="form-control form-control-sm" placeholder="Phone No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Balance:</label> 
                                        ...
                                        <div class="col-lg-5 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}"  style="background-color:#ccd4e1;font-weight:bold;"  style="background-color:#ccd4e1;font-weight:bold;"  maxlength="30" type="text" name="balance_p" id="balance_p" class="form-control form-control-sm" placeholder="Balance" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" style="background-color:#ccd4e1;font-weight:bold;"  name="salesman" id="salesman" class="form-control form-control-sm" placeholder="Select Salesman" readonly tabindex="-1">
                                        ...
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"  style="background-color:#ccd4e1;font-weight:bold;" name="salesman_name" id="salesman_name" class="form-control form-control-sm" placeholder="Salesman Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>DC Ref#:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" name="dc_ref" id="dc_ref" class="form-control form-control-sm" placeholder="DC REF">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control js-example-basic-single  form-control-sm" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" id="catg_div" name="catg_div " style="background-color:#b7edea !important;">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="v_no" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" id="v_no" class="form-control form-control-sm" placeholder="Voucher No" >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select style="width:73% !important;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px"  title="purchase mode" name="ship_mode" class="form-control form-control-sm" id="ship_mode" style="background-color:#b7edea !important;" >
                              ...
                              <div class="card-body">
                                  <table id="example1" class="table table-bordered table-striped table-responsive table-responsive-lg">
                                      <thead>
                                          <tr>
                                              <th>Item Code</th>
                                              <th>Name</th>
                                      ...
                                      <tbody id="d_items">
                                        <tr id="main_tr">
                                            ...
                                            <td style="width: 12%;"><textarea style="height:35px !important;background-color:#ccd4e1;" style rows="1"   name="" id = "detail" class="detail" readonly style="background-color:#ccd4e1;" tabindex="-1"></textarea></td>
                                            <td style="width: 8%;"><input  style="width:85px;text-align:right; padding:0 1px 0 0;background-color:#ccd4e1;" type="text"  name="" id="order_qtys" class="order_qtys" readonly style="background-color:#ccd4e1;" tabindex="-1"></td>
                                            <td style="width: 8%;"><input  style="width:85px;text-align:right; padding:0 1px 0 0;background-color:#ccd4e1;" type="text"  name="" id="dc_qtys" class="dc_qtys" readonly style="background-color:#ccd4e1;" tabindex="-1"></td>
                                            <td style="width: 8%;"><input  style="width:85px;text-align:right; padding:0 1px 0 0;background-color:#ccd4e1;" type="text"  name="" id="bal_qts" class="bal_qts" readonly style="background-color:#ccd4e1;" tabindex="-1" ></td>
                                            ...
                                            <td style="width: 10%;"><textarea style="height:35px !important;font-size:12px;background-color:#ccd4e1;" rows="1"   name="" id = "loc_name" class="loc_name" readonly style="background-color:#ccd4e1;" tabindex="-1"></textarea></td>
                                            <td style="width: 8%;"><input  style="text-align:right; padding:0 1px 0 0;width:85px;" type="text"  name="" id="quantity" class="quantity"></td>
                                            <td style="width: 8%;"><input  style="text-align:right; padding:0 1px 0 0;width:85px;background-color:#ccd4e1;" type="text"  name="" id="opening_qty" class="opening_qty" readonly style="background-color:#ccd4e1;" tabindex="-1" ></td>
                                            <td style="width: 10%;"><textarea style="height:35px;font-size:12px;background-color:#ccd4e1;" rows="1"   name="" id = "batch_no" class="batch_no" readonly style="background-color:#ccd4e1;" tabindex="-1" ></textarea></td>
                                            <td style="width: 7%;"><input style="width:90px;background-color:#ccd4e1;" type="date" tabindex="-1"  name="" id = "expiry_dt" class="expiry_dt" readonly style="background-color:#ccd4e1;" tabindex="-1"></td>
                                            <td style="width: 10%;"><textarea style="background-color:#ccd4e1;height:35px !important;font-size:12px" rows="1"   name="" id = "gd_no" class="gd_no" readonly style="background-color:#ccd4e1;" tabindex="-1" ></textarea></td>
                                            <td style="width: 7%;"><input  type="date" tabindex="-1"  name="" id = "gd_dt" class="gd_dt" readonly style="background-color:#ccd4e1;" tabindex="-1"> </td>
                                            <td style="width: 10%;"><input style="width:85px;font-size:12px;background-color:#ccd4e1;"  type="text" tabindex="-1"  name="" id = "item_hscode" class="item_hscode" readonly style="background-color:#ccd4e1;" tabindex="-1" ></td>
                                            <td style="width: 10%;"><input style="width:85px;font-size:12px;background-color:#ccd4e1;" type="text" tabindex="-1"  name="" id = "tax_rate" class="tax_rate text-right" readonly style="background-color:#ccd4e1;" tabindex="-1" ></td>
        ...
        if(company_code !=''){
            ...
            $.ajax({
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    var bal_qty=parseFloat(response[i].qty)-parseFloat(response[i].receipt_qty);
                    table.row.add([response[i].doc_no,response[i].party_name,refnum,response[i].doc_date,response[i].order_key,response[i].amt,response[i].qty,response[i].receipt_qty,bal_qty,response[i].div_code,response[i].doc_year]);
...
$('#example1').ready(function(){
  ...
  $('#example1').on('focus','.loc',function(){
