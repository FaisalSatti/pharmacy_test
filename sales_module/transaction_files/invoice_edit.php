                    ...
                    <div class="card-body">
                        <div class="container">
                          <form method = "post" id = "order_form">
                            ...
                            <input type="hidden" name="order_key_no" id="order_key_no" class="order_key_no">
                            <input type="hidden" name="dc_doc_year" id="dc_doc_year" class="dc_doc_year">
                            <!-- <div class="row">
                                <div class="col-sm-8"> -->
                            ...
                            <!-- </div> -->
                              <!-- <div class="row"> -->
                                <!-- <div style="border  :4px solid #937272;border-left:3px solid #937272; padding-top:8px" class="col-lg-3" data-aos="fade-up" data-aos-duration="3000"> -->
                                    <div class="row pt-1" style="padding-bottom:0px !important;border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="doc_no" id="doc_no" class="form-control form-control-sm" placeholder="Document No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Invoice#:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="inv_key" id="inv_key" class="form-control form-control-sm" placeholder="Document No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Date:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input tabindex="-1" type="number" name="year" id="year" class="form-control form-control-sm" placeholder="Year" value="<?php echo date('Y'); ?>" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Company:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input title="Sale Code"  type="text" name="order_key" id="order_key" class="form-control form-control-sm" placeholder="DC No" readonly tabindex="-1" >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>DC Date:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="po_date" id="po_date" class="form-control form-control-sm" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="division" style="background-color:#ccd4e1;font-weight:bold;" id="division" class="form-control form-control-sm" placeholder="Select Division" readonly tabindex="-1">
                                        ...
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1" type="text" name="division_name" id="division_name" class="form-control form-control-sm" placeholder="Division Name" readonly tabindex="-1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>PO Cat:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="1" type="text" name="purchase_mode" id="purchase_mode" class="form-control form-control-sm" placeholder="PO Cat" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="order_ref" id="order_ref" class="form-control form-control-sm" placeholder="Order Ref" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="party_ref" id="party_ref" class="form-control form-control-sm" placeholder="Party Ref" readonly tabindex="-1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row pt-1" style="padding-bottom:0px !important;border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="party" id="party" style="background-color:#ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Select Party" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 form-group">
                                            <!-- <label for="">CO Ref :</label> -->
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"  name="name" id="name" class="form-control form-control-sm" placeholder="Party Name" readonly tabindex="-1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>S/Man:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="salesman_code" id="salesman_code" class="form-control form-control-sm" placeholder="SMan Code" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 form-group">
                                            <!-- <label for="">CO Ref :</label> -->
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="salesman_name_p" id="salesman_name_p" class="form-control form-control-sm" placeholder="SMan Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Address:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"  name="address" id="address" class="form-control form-control-sm" placeholder="Address" readonly tabindex="-1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>City:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea rows="1"  name="city_p" id="city_p" class="form-control form-control-sm" placeholder="City" readonly tabindex="-1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Zone:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="zone_p" id="zone_p" class="form-control form-control-sm" placeholder="Zone No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Phone#:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="phone" id="phone" class="form-control form-control-sm" placeholder="Phone No" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Division:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="division_p" id="division_p" class="form-control form-control-sm" placeholder="Division Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Balance:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="balance_p" id="balance_p" class="form-control form-control-sm" placeholder="Balance" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input maxlength="30" type="text" name="salesman" style="background-color:#ccd4e1;font-weight:bold;" id="salesman" class="form-control form-control-sm" placeholder="Select Salesman" readonly tabindex="-1">
                                        ...
                                        <div class="col-lg-3 col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="salesman_name" id="salesman_name" class="form-control form-control-sm" placeholder="Salesman Name" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Ref#</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" type="text" name="ref_no" id="ref_no" class="form-control form-control-sm" placeholder="Ref#" >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control js-example-basic-single form-control-sm" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;background-color:#b7edea;" id="catg_div" name="catg_div">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;" name="ship_no" id="ship_no" class="form-control form-control-sm" placeholder="Ship #" >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Ship Md:</label> 
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select style="width:73% !important" title="purchase mode" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;background-color: white;" name="ship_mode" class="form-control form-control-sm" id="ship_mode" >
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input  style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" type="text" name="ex" id="ex" class="form-control form-control-sm" placeholder="Ex" >
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                        ...
                                        <div class="col-lg-2 col-md-4 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="due_date" id="due_date" class="form-control form-control-sm" readonly tabindex="-1">
                                            </div>
                                        </div>
                                        <div class="col-lg-1 col-md-2 form-group">
                                            <label>Remarks:</label> 
                                    ...
                                    <table id="example1" class="table table-bordered table-striped table-responsive">
                                        ...
                                        <tbody id="d_items">
                                            <tr id="main_tr">
                                                ...
                                                <td style="width: 30px;"><input  style="text-align:right; padding:0 1px 0 0;width:53px;background-color: ccd4e1;" type="number"  name="" id="quantity" class="quantity" readonly tabindex="-1"></td>
                                                ...
                                                <td style="width: 70px;"><input  style="text-align:right; padding:0 1px 0 0;width:40px"  pattern="[a-zA-Z0-9 ,._-]{1,}" value="0" type="text"  name="" id = "disc" class="disc" readonly tabindex="-1"></td>
                                                ...
                                                <td style="width: 70px;"><input  style="text-align:right; padding:0 1px 0 0;width:40px"  pattern="[a-zA-Z0-9 ,._-]{1,}" value="0" type="text"  name="" id = "frt" class="frt" readonly tabindex="-1"></td>
                                                ...
                                                <td style="width: 70px;"><input  style="text-align:right; padding:0 1px 0 0;width:60px"  pattern="[a-zA-Z0-9 ,._-]{1,}" value="0" type="text"  name="" id = "excl" class="excl" readonly tabindex="-1"></td>
                                                ...
                                                <td style="width: 50px;"><input  style="text-align:right; padding:0 1px 0 0;width:40px"  pattern="[a-zA-Z0-9 ,._-]{1,}" value="0" type="text"  name="" id = "stax_amt" class="stax_amt" readonly tabindex="-1"></td>
                                                ...
                                                <td style="width: 50px;"><input  style="text-align:right; padding:0 1px 0 0;width:40px"  pattern="[a-zA-Z0-9 ,._-]{1,}" value="0" type="text"  name="" id = "add_amt" class="add_amt" readonly tabindex="-1" ></td>
                                                ...
                                                <td style="width: 12%;"><textarea style="height:35px" rows="1"   name="" id = "detail" class="detail" readonly tabindex="-1"></textarea></td>
                                                ...
                                                <td style="display:none"><input data-disc="" data-frt="" data-excl="" data-disc-final="" data-frt-final="" data-excl-final=""  type="text"  name="extra" class="extra" id = "extra" class="form-control form-control-sm extra" readonly tabindex="-1"></td>
                                            </tr>
                                        </tbody>
                                            <tr id="last_tr">
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="border:2px solid #937272">
                                        <div class="row" style="padding-top:10px">
                                            ...
                                            <div class="col-md-5 form-group">
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="i_tax_per" id="i_tax_per" class="form-control form-control-sm text-right" placeholder="Income Tax" >
                                            </div>
                                            <div class="col-md-5 form-group">
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="i_tax_amt" id="i_tax_amt" class="form-control form-control-sm text-right" placeholder="ITax Amt" readonly tabindex="-1">
                                            </div>
                                            <div class="col-md-2 form-group">
                                            ...
                                            <div class="col-md-5 form-group">
                                                <input  type="text" name="add_others_desc" id="add_others_desc" class="form-control form-control-sm" placeholder="Account Desc" readonly tabindex="-1">
                                            </div>
                                            ...
                                            <div class="col-md-5 form-group">
                                                <input  type="text" name="add_freight_desc" id="add_freight_desc" class="form-control form-control-sm" placeholder="Freight Desc" readonly tabindex="-1">
                                            </div>
                                            <div class="col-sm-2 form-group">
                                            ...
                                            <div class="col-md-5 form-group">
                                                <input  type="text" name="add_disc_desc" id="add_disc_desc" class="form-control form-control-sm" placeholder="Less Desc" readonly tabindex="-1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="border:2px solid #937272">
                                        <div class="row" style="padding-top:10px">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <textarea rows="1"  name="dpt_1_desc" id="dpt_1_desc" class="form-control form-control-sm" placeholder="Dept Name" readonly tabindex="-1"></textarea>
                                            </div>
                                            <div class="col-md-4 form-group">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <textarea rows="1"  name="dpt_2_desc" id="dpt_2_desc" class="form-control form-control-sm" placeholder="Dept Name" readonly tabindex="-1"></textarea>
                                            </div>
                                            <div class="col-md-4 form-group">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <textarea rows="1"  name="dpt_3_desc" id="dpt_3_desc" class="form-control form-control-sm" placeholder="Dept Name" readonly tabindex="-1"></textarea>
                                            </div>
                                            <div class="col-md-4 form-group">
                                            ...
                                            <div class="col-md-4 form-group">   
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="final_total_calc" id="final_total_calc" class="form-control form-control-sm text-right" placeholder="Total Amt" readonly tabindex="-1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 text-right">
                                            <button id="invoice" type="button" value="STax_Report" class="btn btn-info toastrDefaultSuccess">STax Invoice&nbsp;&nbsp;&nbsp;&nbsp;<i style="font-size:20px" class="fa fa-file"></i></button>
                                        </div>
                                        <div class="col-sm-2 text-right">
                                            <button id="stax_report" type="button" value="STax_Report" class="btn btn-info toastrDefaultSuccess">STax Report&nbsp;&nbsp;&nbsp;&nbsp;<i style="font-size:20px" class="fa fa-file"></i></button>
                                        </div>
                                        <div class="col-sm-2 text-right">
                                            <button id="report" type="button" value="Report" class="btn btn-info toastrDefaultSuccess">Invoice Report&nbsp;&nbsp;&nbsp;&nbsp;<i style="font-size:20px" class="fa fa-file"></i></button>
                                        </div>
...
#order_table tr td:nth-child(13){
display: none;
}
...
$(document).ready(function(){
    ...
    var inv_key="<?php echo $_GET['inv_key'] ?>";
    console.log(po_no);
    $('#inv_key').val(inv_key);
    $('#order_key').val(po_no);
    $('#doc_no').val(doc_no);
    ...
    url: 'api/sales_module/transaction_files/invoice_api.php',
      ...
      success: function(response)
      {
        ...
        $.ajax({
            url: 'api/sales_module/transaction_files/invoice_api.php',
            type: 'POST',
            data: {action: 'item_code',company_code:co_code,dc_key:po_no},
            dataType: "json",
            success: function(data){
                $("#ajax-loader").hide();
                // console.log(data);
            ...
            success: function(data){
                ...
                if(data.length >= 1){
                    for(var i=1;i<=data.length;i++){
                        ...
                        $('#d_items tr:last').before('<tr id="tr'+i+'"><td><select style="height:35px;background-color:#ccd4e1;" name="acc_desc[]" id = "acc_desc'+i+'" class=" js-example-basic-single acc_desc" ></td><td><input  style="height:35px;text-align:right; padding:0 1px 0 0;width:53px !important;font-size:12px !important" type="text" name="quantity[]" id = "quantity'+i+'" class="quantity" readonly tabindex="-1"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:78px !important;font-size:12px !important;height:35px" type="text" name="rate[]" id = "rate'+i+'"  class=" rate"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:100px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="amount[]" id = "amount'+i+'" class=" amount" readonly tabindex="-1"></td><td><input  style="height:35px;text-align:right; padding:0 1px 0 0;width:40px !important;font-size:12px !important" type="text" name="disc[]" id = "disc'+i+'" class=" disc" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="disc_e[]" id = "disc_e'+i+'" class=" disc_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:40px !important;height:35px;font-size:12px !important" type="text" name="frt[]" id = "frt'+i+'" class=" frt" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="frt_e[]" id = "frt_e'+i+'" class=" frt_e" readonly tabindex="-1"></td><td><input style="height:35px;text-align:right; padding:0 1px 0 0;width:60px !important;font-size:12px" type="text" name="excl[]" id = "excl'+i+'" class=" excl" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:100px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="excl_e[]" id = "excl_e'+i+'" class=" excl_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:40px !important;font-size:12px !important;height:35px" type="text" name="stax_amt[]" id = "stax_amt'+i+'" class=" stax_amt" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;height:35px;background-color:#ccd4e1;font-size:12px !important;" type="text" name="stax_amt_e[]" id = "stax_amt_e'+i+'" class=" stax_amt_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:40px !important;font-size:12px;height:35px" type="text;height:35px" name="add_amt[]" id = "add_amt'+i+'" class=" add_amt" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="add_amt_e[]" id = "add_amt_e'+i+'" class=" add_amt_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:110px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="net_amt[]" id = "net_amt'+i+'" class=" net_amt" readonly tabindex="-1"></td><td><textarea rows="1" style="width:179px !important;font-size:12px !important;height:35px" name="detail[]" id = "detail'+i+'" class=" detail" readonly tabindex="-1"></textarea></td><td><input style="text-align:right; padding:0 1px 0 0;width:80px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="dc_qty[]" id = "dc_qty'+i+'" class=" dc_qty" readonly tabindex="-1"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:80px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="inv_qty[]" id = "inv_qty'+i+'" class=" inv_qty" readonly tabindex="-1"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:80px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="bal_qty[]" id = "bal_qty'+i+'" class=" bal_qty" readonly tabindex="-1"></td><td><input style="background-color:#ccd4e1;font-size:12px !important;height:35px" name="loc[]" id = "loc'+i+'" class="form-control loc" readonly tabindex="-1"></td><td><textarea style="width:180px !important;background-color:#ccd4e1;font-size:12px !important;height:35px;" rows="1" type="text" name="batch_no[]" id = "batch_no'+i+'"  class=" batch_no" readonly tabindex="-1"></textarea></td><td><input style="width:91px !important;background-color:#ccd4e1;font-size:12px !important;height:34px" type="date" name="expiry_dt[]" id = "expiry_dt'+i+'" class=" expiry_dt" readonly tabindex="-1"></td><td><button type = "button" id="'+i+'" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');          
                        ...
                        $.ajax({
                            ...
                            success: function(data1){
                                ...
                                $.ajax({
                                    url: 'api/sales_module/transaction_files/invoice_api.php',
                                    type: 'POST',
                                    data: {action: 'item_detail_edit',item_code:account_code,doc_no:doc_no,inv_key:inv_key},
                                    dataType: "json",
                                    success: function(datad){
                                      ...
                                      var qty_e=data[m].qty;
                                        ...
                                        $('#rate'+n).val(parseFloat(inv_rate));
                                        $('#amount'+n).val(datad.amt);
                                        $('#disc'+n).val(datad.disc_rate);
                                        $('#disc_e'+n).val(datad.disc_amt);
                                        $('#frt'+n).val(datad.frt_rate);
                                        $('#frt_e'+n).val(datad.frt_amt);
                                        $('#excl'+n).val(datad.excl_rate);
                                        $('#excl_e'+n).val(datad.excl_amt);
                                        $('#stax_amt'+n).val(datad.stax_rate);
                                        $('#stax_amt_e'+n).val(datad.stax_amt);
                                        $('#add_amt'+n).val(datad.add_rate);
                                        $('#add_amt_e'+n).val(datad.add_amt);
                                        $('#net_amt'+n).val(datad.net_amt);
...
$('#example1').ready(function(){
  ...
  $("#order_form").on('change','.acc_desc',function(){
      ...
      var dc_doc_no=$('#dc_doc_no').val();
      var dc_key=$('#order_key').val();
      var order_key_no=$('#order_key_no').val();
    //   $.ajax({
    ...
    //   }); 
      $.ajax({
        url: 'api/sales_module/transaction_files/invoice_api.php',
        type: 'POST',
        data: {action: 'quantity_detail',item_code:account_code,company_code:company_code,dc_key:dc_key,dc_doc_no:dc_doc_no,order_key_no:order_key_no},
        dataType: "json",
        success: function(data){
        $("#ajax-loader").hide();
            console.log(data);
            ...
            // var total_qty=parseFloat(parseFloat(order_qty)-dc_qty);
            $('#dc_qty').val(dc_qty);
            $('#inv_qty').val(data.receipt_qty??0);
            $('#bal_qty').val(dc_qty-(data.receipt_qty??0));
            $('#loc').val(data.loc_code);
            $('#batch_no').val(data.batch_no);
            $('#expiry_dt').val(data.expiry_date);

            $('#quantity'+id).val(data.qty);
            $('#rate'+id).val(data.rate);
            $('#amount'+id).val(data.amt);
            var net_tot=new Intl.NumberFormat(
            'en-US', { style: 'currency', 
                currency: 'USD',
            currencyDisplay: 'narrowSymbol'}).format(data.amt);
            net_tot=net_tot.replace(/[$]/g,'');
            $('#net_amt'+id).val(net_tot);
            var q_total=parseFloat($('#q_total').text());
            if(isNaN(q_total) || q_total==''){
                q_total=0;
            }
            // console.log(q_total);
            $('#q_total').text(q_total+parseFloat(data.qty));

            
            var n_total=$('#n_total').text();
            if(isNaN(n_total) || n_total==''){
                n_total=0;
            }else{
                n_total = n_total.replaceAll(',','');
            }
            var net_total=parseFloat(n_total)+parseFloat(data.amt);
            // console.log(net_total);
            var total_n=new Intl.NumberFormat(
            'en-US', { style: 'currency', 
                currency: 'USD',
            currencyDisplay: 'narrowSymbol'}).format(net_total);
            total_n=total_n.replace(/[$]/g,'');
            // console.log(total_n);
            $('#n_total').text(total_n);
  ...
  $('.add').click(function(){
    ...
    var i=rowCounts-2;
      ...
      if(acc_desc == null){
          ...
          $("#batch_no").val('');
          $("#expiry_dt").val('');
           $('#d_items tr:last').before('<tr id="tr'+i+'"><td><select style="height:35px;background-color:#ccd4e1;" name="acc_desc[]" id = "acc_desc'+i+'" class=" js-example-basic-single acc_desc" ></td><td><input  style="height:35px;text-align:right; padding:0 1px 0 0;width:53px !important;font-size:12px !important" type="text" name="quantity[]" id = "quantity'+i+'" class="quantity" readonly tabindex="-1"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:78px !important;font-size:12px !important;height:35px" type="text" name="rate[]" id = "rate'+i+'"  class=" rate"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:100px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="amount[]" id = "amount'+i+'" class=" amount" readonly tabindex="-1"></td><td><input  style="height:35px;text-align:right; padding:0 1px 0 0;width:40px !important;font-size:12px !important" type="text" name="disc[]" id = "disc'+i+'" class=" disc" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="disc_e[]" id = "disc_e'+i+'" class=" disc_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:40px !important;height:35px;font-size:12px !important" type="text" name="frt[]" id = "frt'+i+'" class=" frt" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="frt_e[]" id = "frt_e'+i+'" class=" frt_e" readonly tabindex="-1"></td><td><input style="height:35px;text-align:right; padding:0 1px 0 0;width:60px !important;font-size:12px" type="text" name="excl[]" id = "excl'+i+'" class=" excl" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:100px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="excl_e[]" id = "excl_e'+i+'" class=" excl_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:40px !important;font-size:12px !important;height:35px" type="text" name="stax_amt[]" id = "stax_amt'+i+'" class=" stax_amt" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;height:35px;background-color:#ccd4e1;font-size:12px !important;" type="text" name="stax_amt_e[]" id = "stax_amt_e'+i+'" class=" stax_amt_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:40px !important;font-size:12px;height:35px" type="text;height:35px" name="add_amt[]" id = "add_amt'+i+'" class=" add_amt" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:70px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="add_amt_e[]" id = "add_amt_e'+i+'" class=" add_amt_e" readonly tabindex="-1"></td><td><input style="text-align:right; padding:0 1px 0 0;width:110px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="net_amt[]" id = "net_amt'+i+'" class=" net_amt" readonly tabindex="-1"></td><td><textarea rows="1" style="width:179px !important;font-size:12px !important;height:35px" name="detail[]" id = "detail'+i+'" class=" detail" readonly tabindex="-1"></textarea></td><td><input style="text-align:right; padding:0 1px 0 0;width:80px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="dc_qty[]" id = "dc_qty'+i+'" class=" dc_qty"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:80px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="inv_qty[]" id = "inv_qty'+i+'" class=" inv_qty"></td><td><input  style="text-align:right; padding:0 1px 0 0;width:80px !important;background-color:#ccd4e1;font-size:12px !important;height:35px" type="text" name="bal_qty[]" id = "bal_qty'+i+'" class=" bal_qty"></td><td><input style="background-color:#ccd4e1;font-size:12px !important;height:35px" name="loc[]" id = "loc'+i+'" class="form-control loc" ></td><td><textarea style="width:180px !important;background-color:#ccd4e1;font-size:12px !important;height:35px;" rows="1" type="text" name="batch_no[]" id = "batch_no'+i+'"  class=" batch_no"></textarea></td><td><input style="width:91px !important;background-color:#ccd4e1;font-size:12px !important;height:34px" type="date" name="expiry_dt[]" id = "expiry_dt'+i+'" class=" expiry_dt" readonly tabindex="-1"></td><td><button type = "button" id="'+i+'" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');          
          //   $('#d_items tr:last').before('<tr id="tr'+i+'"><td><select name="acc_desc[]" id = "acc_desc'+i+'" class="form-control js-example-basic-single acc_desc" ></td><td><input name="detail[]" id = "detail'+i+'" class="form-control form-control-sm detail" readonly tabindex="-1"></td><td ><select style="font-size:12px;" name="type[]" id = "type'+i+'" class="form-control form-control-sm type"><option val="" readonly tabindex="-1"="readonly tabindex="-1"" selected></option><option val="N">N</option><option val="F">F</option><option val="S">S</option><option val="T">T</option></select></td><td><input type="number" name="quantity[]" id = "quantity'+i+'" class="form-control form-control-sm quantity"></td><td><input type="text" name="rate[]" id = "rate'+i+'"  class="form-control form-control-sm rate"></td><td><input type="text" name="amount[]" id = "amount'+i+'" onchange="total()" class="form-control form-control-sm total" readonly tabindex="-1"></td><td><button type = "button" id="'+i+'" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');          
          // Item code dropdown
          $.ajax({
              url: 'api/sales_module/transaction_files/invoice_api.php',
              type: 'POST',
...
$("#order_form").on('click','#stax_report',function(){
    ...
    var order_key = $("#order_key").val();
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/sales_module/stax_invoice_report.php?action=print&co_code="+co_code+"&doc_no="+doc_no+"&doc_year="+doc_year+"&order_key="+order_key;
        window.open(invoice_url, '_blank');
});
$("#order_form").on('click','#invoice',function(){
    var co_code = $("#company_code").val();
    var doc_no = $("#doc_no").val();
    var doc_year =$('#year').val();
    var order_key = $("#order_key").val();
        // ?action=payment_invoice_generate&tr_no="+response.data[0].TRNO
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/stax_invoice.php?action=print&co_code="+co_code+"&doc_no="+doc_no+"&doc_year="+doc_year+"&order_key="+order_key;
        window.open(invoice_url, '_blank');
});
$("#order_form").on('click','#report',function(){
    ...
    var order_key = $("#order_key").val();
        // ?action=payment_invoice_generate&tr_no="+response.data[0].TRNO
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/sales_module/invoice_report.php?action=print&co_code="+co_code+"&doc_no="+doc_no+"&doc_year="+doc_year+"&order_key="+order_key;
        window.open(invoice_url, '_blank');
});
