        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><button class="btn btn-sm" id="transaction_files_main_breadcrumb">Transaction List</button></li>
                    <li class="breadcrumb-item"><button class="btn btn-sm" id="cv_breadcrumb">Credit Note List</button></li>
                    <li class="breadcrumb-item"><button class="btn btn-sm" id="edit_credit_note_breadcrumb" disabled> Edit Credit Note</button></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="container">
                            <form method="post" id="service_voucher">
                                ...
                                <div class="row"
                                    style="border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                    <div class="col-md-1 form-group">
                                        <label for="">VOU Type </label>
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text"
                                                name="voucher_type" id="voucher_type"
                                                class="form-control form-control-sm" style="background-color:#ccd4e1;font-weight:bold;" placeholder="Voucher No"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-1 form-group">
                                        <label for="">VOU Num :</label>
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                    ...
                                    <div class="col-md-2 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="voucher_date" id="voucher_date"
                                                class="form-control form-control-sm" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px">
                                        </div>
                                    </div>
                                    <div class="col-md-1 form-group">
                                    ...
                                    <div class="col-md-2 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="year" id="year"
                                                class="form-control form-control-sm" style="background-color:#ccd4e1;font-weight:bold;" min="1900" max="2099" step="1"
                                                value="<?php echo date("Y"); ?>" readonly tabindex="-1">
                                        </div>
                                    </div>
                                    <div class="col-md-1 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form-control-sm" style="background-color:#ccd4e1;font-weight:bold;" id="company_code" name="company_code" readonly tabindex="-1">
                                        </div>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" style="background-color:#ccd4e1;font-weight:bold;" maxlength="30" type="text"
                                    ...
                                    <div class="col-md-3 form-group">
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text"
                                                ...
                                                class="form-control form-control-sm" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" placeholder="Reference No">
                                        </div>
                                    </div>
                                    <div class="col-md-1 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="monthwise_ser_no" id="monthwise_ser_no" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px" class="form-control form-control-sm" placeholder="MonthWise Ser#">
                                        </div>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <div class="input-group">
                                            ...
                                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" style="background-color:#ccd4e1;font-weight:bold;" name="" id="" class="form-control form-control-sm" placeholder="" readonly tabindex="-1">
                                    ...
                                    <div class="col-md-11  form-group">
                                        <div class="input-group">
                                            ...
                                            <textarea rows="1" name="narration" id="narration" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px"
                                ...
                                <div class="card-body">
                                    <form id="d" name="geek">
                                        <table id="example1"
                                            ...
                                            style="border:1px solid gray;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                            <thead>
                                                <tr>
                                                    <th>Account Code</th>
                                            ...
                                            <tbody id="d_items">
                                                <tr id="main_tr" class="tr" style="width:100%;">
                                                    <td><select style="font-size:12px" name="" id="acc_desc"
                                                            class="form-control form-control-sm js-example-basic-single acc_desc"></select>
                                                    </td>
                                                    <td><textarea style="font-size:12px" rows="1" name=""
                                                            id="detail" class="form-control form-control-sm detail"
                                                            readonly tabindex="-1"></textarea></td>
                                                    <td><select style="font-size:12px;" name="" id="depart_desc"
                                                            class="form-control form-control-sm js-example-basic-single depart_desc"></select>
                                                    </td>
                                                    <td><textarea style="font-size:12px" rows="1" name=""
                                                            id="depart_detail"
                                                            class="form-control form-control-sm depart_detail"
                                                            readonly tabindex="-1"></textarea></td>
                                                    <td><select style="font-size:12px" name="" id="vehicle_code"
                                                            class="form-control form-control-sm js-example-basic-single vehicle_code"></select>
                                                    </td>
                                                    <td><textarea style="font-size:12px" rows="1" name="" id="memo"
                                                            class="form-control form-control-sm memo"></textarea>
                                                    </td>
                                                    <td><input style="text-align:right; padding:0 13px 0 0"
                                                            pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name=""
                                                            id="debit" class="form-control form-control-sm debit">
                                                    </td>
                                                    <td><input style="text-align:right; padding:0 13px 0 0"
                                                            pattern="[a-zA-Z0-9 ,._-]{1,}" type="text" name=""
                                                            id="credit" class="form-control form-control-sm credit">
                                                    </td>
                                                    <td style="display:none;">
                                                        <input style="background-color: #ccd4e1;height:30px;" type="text" name="vehicle_user" id="hidden_vehicle_user" class="form-control  vehicle_user" readonly tabindex="-1">
                                                    </td>
                                                    <td style="display:none;">
                                                        <input style="background-color: #ccd4e1;height:30px;" type="text" name="vehicle_name" id="hidden_vehicle_name" class="form-control vehicle_name" readonly tabindex="-1">
                                                    </td>
                                                    <td><button type="button" class="btn btn-sm btn-primary add"><i
                                            ...
                                            <div class="col-md-6">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-7 m-1"><input
                                                                        style="background-color: #ccd4e1;height:30px;"
                                                                        type="text" name="vehicle_user" id="vehicle_user"
                                                                        class="form-control  vehicle_user" readonly tabindex="-1">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-7 m-1"><input
                                                                        ...
                                                                        id="vehicle_name"
                                                                        class="form-control vehicle_name" readonly tabindex="-1">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-4"><label>Diff&nbsp; (Debit-Credit)</label></div>
                                                                <div class="col-md-7 m-1">
                                                                    <input style="background-color:#ccd4e1;height:30px;text-align:right;" type="text" name="net_amount" id="net_amount" class="form-control net_amount" readonly tabindex="-1">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
...
$(document).ready(function () {
    ...
    $('#example1').ready(function () {
        $('#service_voucher').on('change','.vehicle_code',function(){
                ...
                $.ajax({
                    url: 'api/sales_module/transaction_files/credit_note_api.php',
                    type: 'POST',
                    data: {
                        action: 'vehicle_name',
            ...
            if (debit == '0' && credit == '0') {
                ...
                if (debit != '0' && credit != '0') {
                    ...
                    $('#d_items tr:last').before('<tr id="tr' + 
                        ...
                        i + '" class="form-control form-control-sm detail" style="background-color:#ccd4e1;font-weight:bold;" readonly tabindex="-1"></textarea></td><td><select name="depart_desc[]" id = "depart_desc' +
                        i + '" class="form-control js-example-basic-single depart_desc" ></td><td><textarea rows="1" name="depart_detail[]" style="background-color:#ccd4e1;font-weight:bold;" id = "depart_detail' +
                        ...
                        i + '" class = "form-control form-control-sm memo"></textarea></td><td><input type="text" style="text-align:right;" name="debit[]" id = "debit' + 
                        i + '" class="form-control form-control-sm debit"></td><td><input type="text" style="text-align:right;" name="credit[]" id = "credit' +
                        i + '" class="form-control form-control-sm credit"></td><td style="display:none;"><input style="background-color: #ced4da;height:30px;" type="text" name="vehicle_user" id="hidden_vehicle_user' + 
                        i + '" class="form-control  vehicle_user" readonly></td><td style="display:none;"><input style="background-color: #ced4da;height:30px;" type="text" name="vehicle_name" id="hidden_vehicle_name' + 
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.ajax({
                    url: 'api/sales_module/transaction_files/credit_note_api.php',
                                type: 'POST',
                                data: {action: 'edit_table',co_code:co_code,voucher_no:voucher_no,voucher_year:voucher_year,voucher_type:voucher_type},
                                dataType: "json",
                                async:false,
                                success: function(data){
                                ...
                                $("#example1").css("display", "");
                                    ...
                                    for(var i=1;i<=data.length;i++){
                                        $('#d_items tr:last').before('<tr id="tr' +i + '" class="tr"><td><select name="acc_desc[]" id = "acc_desc' +i + '" class="form-control js-example-basic-single acc_desc" ></td><td><textarea rows="1" name="detail[]" style="background-color:#ccd4e1;" id = "detail' +i + '" class="form-control form-control-sm detail" readonly tabindex="-1"></textarea></td><td><select name="depart_desc[]" id = "depart_desc' +i + '" class="form-control js-example-basic-single depart_desc" ></td><td><textarea rows="1" name="depart_detail[]" style="background-color:#ccd4e1;" id = "depart_detail' + i + '" class="form-control form-control-sm depart_detail" readonly tabindex="-1"></textarea></td><td><select name="vehicle_code[]" id="vehicle_code' + i + '" class="form-control js-example-basic-single vehicle_code"></td><td><textarea rows="1" name = "memo[]" id = "memo' + i + '" class = "form-control form-control-sm memo"></textarea></td><td><input type="text" style="text-align:right;" name="debit[]" id = "debit' +i + '" class="form-control form-control-sm debit"></td><td><input type="text" style="text-align:right;" name="credit[]" id = "credit' +i + '" class="form-control form-control-sm credit"></td><td style="display:none;"><input style="background-color: #ced4da;height:30px;" type="text" name="vehicle_user" id="hidden_vehicle_user' +  i + '" class="form-control  vehicle_user" readonly></td><td style="display:none;"><input style="background-color: #ced4da;height:30px;" type="text" name="vehicle_name" id="hidden_vehicle_name' + 
                                        i + '" class="form-control vehicle_name" readonly></td><td><button type = "button" id="' +i + '" class="btn btn-sm btn-danger remove"><b>X<b></button></td></tr>');
                                        $.ajax({
                                            url: 'api/sales_module/transaction_files/credit_note_api.php',
                                            type: 'POST',
                                            data: {
                                        ...
                                        $('#debit'+e).val(data[k].debit);
                                        $('#credit'+e).val(data[k].credit);
                                        ...
                                        var total_d = parseFloat(data[k].debit) + parseFloat(total_d);
                                                    ...
                                                    var total_d_format=new Intl.NumberFormat(
                                                        'en-US', { style: 'currency', 
                                                            currency: 'USD',
                                                            currencyDisplay: 'narrowSymbol'}).format(total_d);
                                                    ...
                                                    var total_c_format=new Intl.NumberFormat(
                                                        'en-US', { style: 'currency', 
                                                            currency: 'USD',
                                                            currencyDisplay: 'narrowSymbol'}).format(total_c);
    ...
    $("#service_voucher").on('click','#report',function(){
        ...
        $("#ajax-loader").hide();
        let invoice_url = "invoicereports/sales_module/credit_voucher_report.php?action=print&co_code="+co_code+"&voucher_no="+voucher_no+"&doc_year="+doc_year+"&voucher_type="+voucher_type;
    ...
    $("#transaction_files_main_breadcrumb").on("click", function () {
      $.get('sales_module/transaction_files/transaction_files.php', function(data,status){
          $("#content").html(data);
      });
    });
    $("#cv_breadcrumb").on("click", function () {
      $.get('sales_module/transaction_files/credit_note_list.php', function(data,status){
          $("#content").html(data);
      });
    });
    $("#edit_credit_note_breadcrumb").on("click", function () {
        $.get('sales_module/transaction_files/credit_note_edit.php', function (data, status) {
            $("#content").html(data);
        });
    });
</script>
