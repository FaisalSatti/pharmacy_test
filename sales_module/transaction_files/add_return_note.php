        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><button class="btn btn-sm" id="add_rn_breadcrumb">Add Return Note</button></li>
                </ol>
            </div>   
        </div>
    </section>
                                ...
                                <div class="row" style="border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                    ...
                                    <div class="col-lg-2 col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input maxlength="30" type="text" name="company_code" id="company_code" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;background-color:#b7edea;" class="form-control form-control-sm" placeholder="Select Company" readonly>
                                    ...
                                    <div class="col-lg-6 col-md-6 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input tabindex="-1" pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" style="background-color: #ccd4e1;font-weight:bold;" type="text"  name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                                        </div>
                                    </div>
                                    <div class="col-lg-1 col-md-2 form-group">
                                        <label>PO Cat:</label> 
                                    ...
                                    <div class="col-lg-2 col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input maxlength="30" type="text" name="division" id="division" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;background-color:#b7edea;" class="form-control form-control-sm" placeholder="Select Division" readonly>
                                ...
                                <div class="row"  style="border:1px solid gray;padding:20px;border-radius:5px;box-shadow: 0 10px 20px 0 rgba(0, 0, 0, 0.2), 0 20px 20px 0 rgba(0, 0, 0, 0.19);">
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input maxlength="30" type="text" name="party" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;background-color:#b7edea;" id="party" class="form-control form-control-sm" placeholder="Select Party" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea rows="1" pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" style="background-color: #ccd4e1;font-weight:bold;" name="address_p" id="address_p" class="form-control form-control-sm" placeholder="Address" readonly></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-2 form-group">
                                                <label>City:</label> 
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea rows="1" pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" style="background-color: #ccd4e1;font-weight:bold;" name="city_p" id="city_p" class="form-control form-control-sm" placeholder="City" readonly></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-2 form-group">
                                                <label>Phone#:</label> 
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" style="background-color: #ccd4e1;font-weight:bold;" name="phone_p" id="phone_p" class="form-control form-control-sm" placeholder="Phone No" readonly>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-2 form-group">
                                                <label>Division:</label> 
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea rows="1" type="text" name="division_p" id="division_p" style="background-color: #ccd4e1;font-weight:bold;" class="form-control form-control-sm" placeholder="Division Name" readonly></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-2 form-group">
                                            ...
                                            <div class="col-lg-2 col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input maxlength="30" type="text" name="salesman" id="salesman" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid #b7edea;border-radius:4px;background-color:#b7edea;" class="form-control form-control-sm" placeholder="Select Salesman" readonly>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Select DC</h5>
...
<style>
    #example1 tr td:nth-child(24),#example1 tr td:nth-child(25),#example1 tr td:nth-child(26){
        display: none;
    }
        ...
        if(co_code !='' && account_code !=null && party_code !=''){
            ...
            $.ajax({
                ...
                // console.log(response[i].doc_year);
                    ...
                    $('#dc_table tr td:nth-child(20)').css('display','none');
...
$(document).ready(function(){
    $('#voucher_date').focus();
    // var rText = $("#voucher_date").val();
    // var tab = $("#voucher_date").attr('tabindex');
    // if(rText !=''){
    //     $('#company_code').focus();
    // }
//   const input = document.getElementById('voucher_date');
//   input.focus();
//   input.select();
    //get value of company in fields
    ...
    $('#division_table').on('click','.odd',function(){
      ...
      if(company_code != '' && purchase_mode !='' && division_code !=''){
...
$(document).ready(function(){
    ...
    $("#order_form").on('focus','.quantity',function(){
        ...
        var previous_disc_amount= $('#disc_e'+p_quantity_id).val();
        sessionStorage.setItem("previous_disc_amount", previous_disc_amount);

        var previous_net= $('#net_amt'+p_quantity_id).val();
        sessionStorage.setItem("previous_net", previous_net);
        console.log(previous_net);
    });
    $("#order_form").on('change','.quantity',function(){
        ...
        if(parseInt(quantity) > parseInt(dc_qty)){
            $('#msg').html("quantity is greater than available quantity");
        ...
        var frt_m_e=$('#frt'+quantity_id).val();
        ...
        $('#frt'+quantity_id).val(frt_m_e_fnf);
        var qty=$('#quantity'+quantity_id).val();
        ...
        $('#frt'+quantity_id).css('text-align','right');
        $('#frt'+quantity_id).css('padding','0 1px 0 0');
        // console.log(excl_m_fnf);
        $('#excl'+quantity_id).val(excl_m_fnf);
        $('#excl'+quantity_id).css('text-align','right');
        $('#excl'+quantity_id).css('padding','0 1px 0 0');
        ...
        $('#excl_e'+quantity_id).val(excl_fnf);
        $('#net_amt'+quantity_id).val(excl_fnf);
                var previous_nets=sessionStorage.getItem('previous_net');
                // console.log(previous_nets);
                if(previous_nets == ""){
                    previous_net=0;
