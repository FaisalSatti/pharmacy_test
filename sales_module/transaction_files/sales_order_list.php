          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="transaction_file_list_breadcrumb">Sales Order List</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
...
$("#transaction_file_list_breadcrumb").on("click", function () {
