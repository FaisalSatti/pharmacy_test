...
<div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Delivery Challan List</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><button class="btn btn-sm" id="dashboard_breadcrumb"><i class="fas fa-tachometer-alt"></i></button></li>
                <li class="breadcrumb-item active"><button class="btn btn-sm" id="transaction_files_main_breadcrumb">Transaction File</button></li>
                <li class="breadcrumb-item"><button class="btn btn-sm" id="dc_list_breadcrumb">Delivery Challan List</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
...
$("#example1").on('click','.btn-select',function(){
    ...
    $.get('sales_module/transaction_files/delivery_challan_edit.php?co_code='+co_code+'&doc_no='+doc_no+'&po_catg='+po_catg+'&doc_year='+doc_year+'&party_code='+party_code+'&div_code='+div_code+'&salesman_code='+salesman_code+'&po_no='+po_no+'&do_key='+do_key, function(data,status){
        $("#content").html(data);
    });
});
