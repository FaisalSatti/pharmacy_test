...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Type / Date Wise Posting</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><button class="btn btn-sm" id="dashboard_breadcrumb"><i class="fas fa-tachometer-alt"></i></button></li>
                <li class="breadcrumb-item active"><button class="btn btn-sm" id="process_1"> Process</button></li>
                <li class="breadcrumb-item active"><button class="btn btn-sm" id="report_breadcrumb"> Post</button></li>
                <li class="breadcrumb-item"><button class="btn btn-sm" id="stock_ledger_loc_breadcrumb">Type / Date-Wise Posting</button></li>
                </ol>
            </div>   
            </div>
        </div><!-- /.container-fluid -->
...
$("#ledger_form").on('click','#ledger',function(){
    ...
    var from_date=$('#from_date').val();
    var to_date=$('#to_date').val();
    $.get('sales_module/post_total.php?company_code='+company_code+'&from_date='+from_date+'&to_date='+to_date+'&type='+type, function(data,status){
        $("#content").html(data);
    });
...
$("#stock_ledger_loc_breadcrumb").on("click", function () {
    $.get('sales_module/type_dt.php', function(data,status){
        $("#content").html(data);
    });
});
</script>