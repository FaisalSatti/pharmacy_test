                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-3 no-padding 702a1a">
                                                <button class="btn" id="create_user"> <i class="fa fa-user"></i>
                                                    Create user</button>
                                            </div>
                                            <div class="col-sm-3 no-padding 702a1c">
                                                <button class="btn" id="user_list"> <i class="fas fa-list"></i>
                                                    User List</button>
                                            </div>
                                            <div class="col-sm-3 no-padding 702a1b">
                                                <button class="btn" id="user_permissions"> <i class="fa fa-building"></i>
                                                    Permissions</button>
                                            </div>
                                        </div>
                                    </div>
...
$(document).on('focus', '.select2-selection.select2-selection--single', function (e) {
  $(this).closest(".select2-container").siblings('select:enabled').select2('open');
        ...
        $('#user_permissions').click(function () {
            $(this).css('pointer-events', 'none');
