          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active"><button class="btn btn-sm" id="list">Sale Order List </button></li>
                                    ...
                                    <div class="row" style="border-radius:4px;border  :2px solid #1e293b; padding-top:8px;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="GST" id="GST" class="form-control form-control-sm" placeholder="GST NO" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-1 form-group">
                                            <label>Division:</label> 
...
//select company code
$('#order_form').on('keyup','#company_code',function(){
