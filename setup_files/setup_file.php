...
<div class="content-wrapper">
                        ...
                        <div class="row 702a1">
                            <div class="col-sm-12">
                                <div class="card  card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 101 show1">
                                                <button class="btn" id="company"> <i class="fa fa-building"></i>
                                                    Company</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1 102 show1">
                                                <button class="btn" id="zone"> <i class="fas fa-dolly"></i>
                                                    Zone</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1b 103 show1">
                                                <button class="btn" id="city"> <i class="fa fa-list-alt"></i>
                                                    City</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1b 104 show1">
                                                <button class="btn" id="area"> <i class="fa fa-list-alt"></i>
                                                    Area</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 105 show1">
                                                <button class="btn" id="salesMan"> <i class="fas fa-dolly"></i> Sales
                                                    Man</button>
                                            </div>
                                           
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 106 show1">
                                                <button class="btn" id="Division"> <i class="fas fa-cash-register"></i>
                                                    Division</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 107 show1">
                                                <button class="btn" id="chart_account"> <i
                                                        class="fas fa-cash-register"></i> Chart Of Accounts</button>
                                            </div>
                                           
                                           
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 108 show1">
                                                <button class="btn" id="party"> <i class="fa fa-users"></i>
                                                    Customers</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 109 show1">
                                                <button class="btn" id="supplier"> <i class="fa fa-users"></i>
                                                    Supplier</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 112 show1">
                                                <button class="btn" id="product"> <i
                                                        class="fas fa-dolly"></i>Product</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 113 show1">
                                                <button class="btn" id="gen"> <i class="fas fa-dolly"></i>Generic
                                                    Names</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 111 show1">
                                                <button class="btn" id="unit"> <i class="fa fa-shopping-cart"></i>
                                                    Unit</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 110 show1">
                                                <button class="btn" id="item"> <i class="fa fa-shopping-cart"></i>
                                                    Items</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 114 show1">
                                                <button class="btn" id="department"> <i
                                                        class="fas fa-dolly"></i>Department</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 115 show1">
                                                <button class="btn" id="location"> <i
                                                        class="fas fa-dolly"></i>Location</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 116 show1">
                                                <button class="btn" id="vehicle"> <i class="fas fa-dolly"></i>
                                                    Vehicle</button>
                                            </div>
                                            
                                           
                                           
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 117 show1">
                                                <button class="btn" id="item_location"> <i class="fas fa-dolly"></i>Item
                                                    Location</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1c 118 show1">
                                                <button class="btn" id="item_batch"> <i class="fas fa-dolly"></i>Item
                                                    Batchno</button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row 702a1">
                            <div class="col-sm-12">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                        <div style = "display:none;" class="col-sm-3 no-padding 702a1a 119 show1">
                                                <button class="btn" id="city_report"> <i class="fa fa-building"></i>
                                                    City Report</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 120 show1">
                                                <button class="btn" id="areasa"> <i class="fa fa-building"></i> Area
                                                    Report</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 121 show1">
                                                <button class="btn" id="chart_of_accounts"> <i class="fa fa-building"></i>Chart Of Accounts </button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 122 show1">
                                                <button class="btn" id="partycode"><i class="fa fa-building"></i>Party
                                                    Code - By Code</button>
                                            </div>
                                         
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 123 show1">
                                                <button class="btn" id="agent_report"> <i class="fa fa-building"></i>
                                                    Agent Report</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 124 show1">
                                                <button class="btn" id="party_list"> <i class="fa fa-building"></i>
                                                    Party List - By Division</button>
                                            </div>
                                            <div style = "display:none;" class="col-sm-3 no-padding 702a1a 125 show1">
                                                <button class="btn" id="item_list_button"> <i
                                                        class="fa fa-building"></i> Item List</button>
                                            </div>
    ...
    <div class="modal fade" id="InsertFormModel" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">View Party List</h5>
    ...
    <div class="modal fade" id="item_list_modal" tabindex="-1"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Search Item List</h5>
                    <button type="button" class="close" aria-label="Close"
                        data-dismiss="modal">
                        <span aria-hidden="true">×</span>
                    </button>
