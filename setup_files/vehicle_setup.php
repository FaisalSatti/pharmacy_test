                ...
                <form method = "post" id = "vehicle_form">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" type="text" name="vehicleCode" id="vehicleCode" class="form-control form-control-sm" placeholder="Vehicle Code" > 
                        </div>
                    </div>
                    <div class="col-sm-4 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="vehicleName" id="vehicleName" class="form-control form-control-sm" placeholder="Description" >
                        </div>
                    </div>
                    <div class="col-sm-4 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="userName" id="userName" class="form-control form-control-sm" placeholder="User Name" >
                        </div>
                    </div>
                    </div>
                    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="vehicleCode_e" id="vehicleCode_e" class="form-control form-control-sm" placeholder="Vehicle Code" > 
                        </div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label for="inputvehicleName">Description:</label><span style="color:red;">*</span>
                        <div class="input-group">
                            ...
                            <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="vehicleName_e" id="vehicleName_e" class="form-control form-control-sm" placeholder="Description" >
                        </div>
                    </div>
                    <div class="col-sm-4 form-group">
                        <label for="inputuserName">User Name:</label><span style="color:red;">*</span>
                        <div class="input-group">
                            ...
                            <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="userName_e" id="userName_e" class="form-control form-control-sm" placeholder="User Name" >
                        </div>
                    </div>
                    </div>
                    <div class="row">
