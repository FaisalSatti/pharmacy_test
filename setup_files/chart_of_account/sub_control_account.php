          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><button class="btn btn-sm" id="sub_control_account_breadcrumb">Sub Control Account</button></li>
              </ol>
            </div>   
          </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Sub Control Account</h5>
            ...
            <div class="modal-body">
              <form method = "post" id = "control_account_form">
                  <div class="row">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" tabindex="-1" style="background-color:#ccd4e1;font-weight:bold;" name="company_name" id="company_name" class="form-control form-control-sm" placeholder="Company Name" readonly >
                        </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control form-control-sm  js-example-basic-single" id="control_code" name="control_code">
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="">Account Name :</label><span style="color:red;">*</span>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-pen"></i></span>
                            </div>
                            <input type="text" style="background-color:#ccd4e1;font-weight:bold;" name="account_name" tabindex="-1" id="account_name" class="form-control form-control-sm" placeholder="Account Name" readonly>
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" pattern="[0-9]+" minlength = "4" maxlength = "4" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="sub_control_code" id="sub_control_code" class="form-control form-control-sm" placeholder="Control Code">
                      </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input  type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="sub_control_name" id="sub_control_name" class="form-control form-control-sm" placeholder="Account Name" >
                        </div>
                    </div>
                  </div>
                  <div class="row">
                ...
                <button type="submit" class="btn btn-primary toastrDefaultSuccess" style="float: right;">Submit</button>
              </form>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="company_code_e" id="company_code_e" style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="company_name_e" style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" id="company_name_e" class="form-control form-control-sm" placeholder="Company Name" readonly >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="control_code_e" id="control_code_e" style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="account_name_e" style="background-color:#ccd4e1;font-weight:bold;" tabindex="-1" id="account_name_e" class="form-control form-control-sm" placeholder="Company Name" readonly >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" pattern="[0-9]+" style="background-color:#ccd4e1;font-weight:bold;"  tabindex="-1" minlength = "4" maxlength = "4" name="sub_control_code_e" id="sub_control_code_e" class="form-control form-control-sm" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label for="inputCompanyName">Sub Account Name :</label><span style="color:red;">*</span>
                            <div class="input-group">
                                ...
                                <input type="text" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" name="sub_control_name_e" id="sub_control_name_e" class="form-control form-control-sm">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input style="text-align:right;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" pattern="[a-zA-Z0-9 ,._-]{1,}"  maxlength="30" type="text" name="debit_e" id="debit_e" class="form-control form-control-sm" placeholder="Opening Debit" > 
                            </div>
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="credit">Opening Credit :</label>
                            <div class="input-group">
                                ...
                                <input style="text-align:right;box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" pattern="[a-zA-Z0-9 ,._-]{1,}" maxlength="30" type="text" name="credit_e" id="credit_e" class="form-control form-control-sm" placeholder="Opening Credit" > 
                            </div>
                        </div>
                        <div class="col-sm-3 form-group">
                          <input type="hidden" name="level2" id="level2" class="form-control">
                        </div>
                    </div>
    ...
    $.ajax({
        ...
        for (var i = 0; i < data.length; i++) {
          console.log(data);
            ...
            var credit=credit.replace(/[$]/g,'');
            btn_edit = '<button class="btn btn-sm btn-select 702a1b_2" data-company="'+data[i].co_name+'" data-code="'+data[i].co_code+'" data-id="'+data[i].control_code+'" data-level1="'+data[i].sub_level1+'" data-level_name="'+data[i].descr+'" data-level2="'+data[i].sub_level2+'"  ><i class="far fa-edit text-info fa-fw"></i></button>';
            // btn_dlt = '<button class="btn btn-sm btn-delete" data-id="'+data[i].ID+'"><i class="far fa-trash-alt text-danger fa-fw"></i></button>';
            btn = btn_edit; 
            table.row.add([sno,data[i].co_code,data[i].co_name,data[i].control_code,data[i].sub_level1,data[i].descr,debit,credit,btn]);
        }
        table.draw();
        },
        error: function(e){
...
$(document).ready(function() {
    ...
    $("#control_account_form").on('change','#control_code',function(){
          var account_name=$('#control_code').find(':selected').attr("data-name");
          var control_code=$('#control_code').find(':selected').attr("data-code");
          $('#select2-control_code-container').html(control_code);
          $('#account_name').val(account_name);
    });
    
    $("#sub_control_code").change(function(){
        var company_code = $("#company_code").val();
        var control_code=$("#control_code").val();
        if(company_code != null || control_code != null){
            $("#msg3").html('');
            var sub_control_code = $("#sub_control_code").val();
            $.ajax({
              url: 'api/setup/chart_of_account/sub_control_account_api.php',
              type: 'POST',
              data: {action:'check_sub_control_code',sub_control_code:sub_control_code, company_code:company_code, control_code:control_code},
              success: function (response) {
                console.log(response);
                if(response.status == "0"){
                  $("#sub_control_code").css("background-color", "pink");
                  $("#msg3").text(response.message);
                  $("#sub_control_code").attr('placeholder',sub_control_code);
                  $("#sub_control_code").val("");
                  $('#sub_control_code').focus();
                }else{
                  $("#sub_control_code").css("background-color", "");
                  $("#msg3").text("");
                }
              },
              error: function(e) 
...
$('#add_button').click(function(){
  ...
  setTimeout(function (){
  $('#select2-company_code-container').focus();
}, 500);
...
//edit
  $("#example1").on('click','.btn-select',function(){
    ...
    // console.log(company_name);
              ...
              $('#sub_control_name_e').val(response.descr);
              var debit=new Intl.NumberFormat(
              'en-US', { style: 'currency', 
                currency: 'USD',
...
$("#sub_control_account_breadcrumb").on("click", function () {
    $.get('setup_files/chart_of_account/sub_control_account.php', function(data,status){
        $("#content").html(data);
    });
});
