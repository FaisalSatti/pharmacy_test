                ...
                <form method = "post" id = "area_form">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" type="number" name="areaCode" id="areaCode" class="form-control form-control-sm" placeholder="Area Code" > 
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" style="background-color:#ccd4e1;font-weight:bold;" type="number" name="areaCode_e" tabindex="-1" id="areaCode_e" class="form-control form-control-sm" placeholder="Area Code" readonly> 
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="inputdescription">Description:</label><span style="color:red;">*</span>
