                ...
                <form method = "post" id = "unit_form">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;border:1px solid black;border-radius:4px" maxlength="30" type="number" name="unitCode" id="unitCode" class="form-control form-control-sm" placeholder="Unit Code" > 
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input pattern="[a-zA-Z0-9 ,._-]{1,}" min="0" maxlength="30" type="number" style="background-color:#ccd4e1;font-weight:bold;" name="unitCode_e" tabindex="-1" id="unitCode_e" class="form-control form-control-sm" placeholder="Unit Code" readonly> 
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="inputdescription">Description:</label><span style="color:red;">*</span>
